...
// COST: 3
  c1: makeHeroCard("Black Widow", "Dangerous Rescue", 3, u, 2, Color.COVERT, "Avengers", "GDT", ev => {
    superPowerEv(ev, Color.COVERT, () => KOHandOrDiscardEv(ev, undefined, () => rescueEv(ev)));
  }),
// Draw a card.
// {POWER Tech} Rescue a Bystander.
// COST: 2
  c2: makeHeroCard("Black Widow", "Mission Accomplished", 2, u, u, Color.TECH, "Avengers", "GD", [ ev => drawEv(ev, 1), ev => {
    superPowerEv(ev, Color.TECH, () => rescueEv(ev));
  } ]),
// ATTACK: 0+
// You get +1 Attack for each Bystander in your Victory pile.
// COST: 4
  uc: makeHeroCard("Black Widow", "Covert Operation", 4, u, 0, Color.COVERT, "Avengers", "G4AT", ev => addAttackEvent(ev, playerState.victory.count(isBystander))),
// ATTACK: 4
// Defeat a Villain or Mastermind that has a Bystander.
// COST: 7
  ra: makeHeroCard("Black Widow", "Silent Sniper", 7, u, 4, Color.COVERT, "Avengers", "G4", ev => selectCardEv(ev, "Defeat an enemey", fightableCards().limit(hasBystander), sel => defeatEv(ev, sel))),
},
{
...
// COST: 3
  c1: makeHeroCard("Captain America", "Avengers Assemble!", 3, 0, u, Color.INSTINCT, "Avengers", "RT", ev => addRecruitEvent(ev, numColors())),
// ATTACK: 0+
// You get +1 Attack for each color of Hero you have.
// COST: 4
  c2: makeHeroCard("Captain America", "Perfect Teamwork", 4, u, 0, Color.STRENGTH, "Avengers", "4AT", ev => addAttackEvent(ev, numColors())),
// ATTACK: 4
// If you would gain a Wound, you may reveal this card and draw a card instead.
// COST: 6
  uc: makeHeroCard("Captain America", "Diving Block", 6, u, 4, Color.TECH, "Avengers", "4T", [], { trigger:
...
// COST: 7
  ra: makeHeroCard("Captain America", "A Day Unlike Any Other", 7, u, 3, Color.COVERT, "Avengers", "AT", ev => superPowerLikelyEv(ev, "Avengers", n => addAttackEvent(ev, 3 * n))),
},
{
  name: "Cyclops",
  team: "X-Men",
...
// COST: 2
  c1: makeHeroCard("Cyclops", "Determination", 2, 3, u, Color.STRENGTH, "X-Men", "DT", [], { playCost: 1, playCostType: "DISCARD" }),
// ATTACK: 3
// To play this card, you must discard a card from your hand.
// COST: 3
  c2: makeHeroCard("Cyclops", "Optic Blast", 3, u, 3, Color.RANGED, "X-Men", "T", [], { playCost: 1, playCostType: "DISCARD" }),
// ATTACK: 4
// If a card effect makes you discard this card, you may return this card to your hand.
// COST: 6
  uc: makeHeroCard("Cyclops", "Unending Energy", 6, u, 4, Color.RANGED, "X-Men", "4T", [], { trigger: {
    event: "DISCARD",
...
// COST: 8
  ra: makeHeroCard("Cyclops", "X-Men United", 8, u, 6, Color.RANGED, "X-Men", "DAT", ev => superPowerLikelyEv(ev, "X-Men", n => addAttackEvent(ev, 2 * n))),
},
{
  name: "Deadpool",
  team: "(Unaffiliated)",
...
// COST: 5
  c2: makeHeroCard("Deadpool", "Oddball", 5, u, 2, Color.COVERT, u, "GDAT", ev => addAttackEvent(ev, turnState.cardsPlayed.count(isCostOdd))),
// ATTACK: 2
// If this is the first Hero you played this turn, you may discard the rest of your hand and draw four cards.
// COST: 3
  uc: makeHeroCard("Deadpool", "Hey, Can I Get a Do-Over?", 3, u, 2, Color.INSTINCT, u, "GDT", ev => { if (turnState.cardsPlayed.length === 0) chooseMayEv(
...
// COST: 7
  ra: makeHeroCard("Deadpool", "Random Acts of Unkindness", 7, u, 6, Color.INSTINCT, u, "GT", [
...
// FLAVOR: Emma's days as a Villain are behind here...aren't they?
  c2: makeHeroCard("Emma Frost", "Shadowed Thoughts", 4, u, 2, Color.COVERT, "X-Men", "FD4AT", ev => {
    superPowerLikelyEv(ev, Color.COVERT, () => chooseMayEv(ev,
...
// COST: 5
  uc: makeHeroCard("Emma Frost", "Psychic Link", 5, u, 3, Color.INSTINCT, "X-Men", "T", ev => eachPlayer(p => {
...
// FLAVOR: A secondary mutation allows Emma Frost to transform into pure diamond.
  ra: makeHeroCard("Emma Frost", "Diamond Form", 7, 0, 5, Color.STRENGTH, "X-Men", "FRT", ev => addTurnTrigger("DEFEAT", undefined, () => addRecruitEvent(ev, 3))),
},
{
  name: "Gambit",
  team: "X-Men",
...
// COST: 4
  c1: makeHeroCard("Gambit", "Card Shark", 4, u, 2, Color.RANGED, "X-Men", "D4T", ev => drawIfEv(ev, isTeam("X-Men"))),
// Draw two cards. Then put a card from your hand on top of your deck.
// COST: 2
  c2: makeHeroCard("Gambit", "Stack the Deck", 2, u, u, Color.COVERT, "X-Men", "DT", [ ev => drawEv(ev, 2), ev => pickTopDeckEv(ev) ]),
// RECRUIT: 2
// Reveal the top card of your deck. Discard it or put it back.
// {POWER Instinct} Do the same thing to each other player's deck.
// COST: 3
  uc: makeHeroCard("Gambit", "Hypnotic Charm", 3, 2, u, Color.INSTINCT, "X-Men", "DT", ev => eachPlayer(p => {
    superPowerCondEv(ev, Color.INSTINCT, n => { if (p === playerState || n) revealPlayerDeckEv(ev, 1, cards => {
...
// COST: 7
  ra: makeHeroCard("Gambit", "High Stakes Jackpot", 7, u, 4, Color.INSTINCT, "X-Men", "4AT",
...
// FLAVOR: "You line 'em up, and I'll knock 'em down..."
  c2: makeHeroCard("Hawkeye", "Team Player", 4, u, 2, Color.TECH, "Avengers", "FD4A", ev => {
    superPowerLikelyEv(ev, "Avengers", () => addAttackEvent(ev, 1));
  }),
// ATTACK: 3
// {POWER Tech} Choose one: each other player draws a card or each other player discards a card.
// COST: 5
  uc: makeHeroCard("Hawkeye", "Covering Fire", 5, u, 3, Color.TECH, "Avengers", "T", ev => {
    superPowerEv(ev, Color.TECH, () => chooseOneEv(ev, "Each other player",
...
// COST: 7
  ra: makeHeroCard("Hawkeye", "Impossible Trick Shot", 7, u, 5, Color.TECH, "Avengers", "T", ev => addTurnTrigger("DEFEAT", undefined, () => rescueEv(ev, 3))),
},
{
  name: "Hulk",
  team: "Avengers",
...
// FLAVOR: Don't make Hulk even mildly inconvenienced. You wouldn't like him when he's mildly inconvenienced...
  c1: makeHeroCard("Hulk", "Growing Anger", 3, u, 2, Color.STRENGTH, "Avengers", "FDA", ev => {
    superPowerLikelyEv(ev, Color.STRENGTH, () => addAttackEvent(ev, 1));
  }),
// ATTACK: 2+
// You may KO a Wound from your hand or discard pile. If you do, you get +2 Attack.
// COST: 4
  c2: makeHeroCard("Hulk", "Unstoppable Hulk", 4, u, 2, Color.INSTINCT, "Avengers", "D4AT", ev => KOHandOrDiscardEv(ev, isWound, () => addAttackEvent(ev, 2))),
// ATTACK: 4
// Each player gains a Wound.
// COST: 5
// FLAVOR: Hulk's rages tear everything apart: Enemies. Friends. Pants.
  uc: makeHeroCard("Hulk", "Crazed Rampage", 5, u, 4, Color.STRENGTH, "Avengers", "F4", ev => eachPlayer(p => gainWoundEv(ev, p))),
// ATTACK: 5+
// {POWER Strength} You get +5 Attack.
// COST: 8
// FLAVOR: "PUNY HUMANS! HULK IS THE STRONGEST ONE THERE IS!"
  ra: makeHeroCard("Hulk", "Hulk Smash!", 8, u, 5, Color.STRENGTH, "Avengers", "FA", ev => {
    superPowerLikelyEv(ev, Color.STRENGTH, () => addAttackEvent(ev, 5));
  }),
},
{
  name: "Iron Man",
...
// COST: 3
  c1: makeHeroCard("Iron Man", "Endless Invention", 3, u, u, Color.TECH, "Avengers", "", [ ev => drawEv(ev, 1), ev => {
    superPowerEv(ev, Color.TECH, () => drawEv(ev, 1));
  } ]),
// ATTACK: 2+
// {POWER Ranged} You get +1 Attack.
// COST: 3
// FLAVOR: Repulsor ray technology has many peaceful applications. This is not one of them.
  c2: makeHeroCard("Iron Man", "Repulsor Rays", 3, u, 2, Color.RANGED, "Avengers", "FDA", ev => {
    superPowerLikelyEv(ev, Color.RANGED, () => addAttackEvent(ev, 1));
  }),
// ATTACK: 3+
// {POWER Tech} You get +1 Attack for each other [Tech] Hero you played this turn.
// COST: 5
  uc: makeHeroCard("Iron Man", "Arc Reactor", 5, u, 3, Color.TECH, "Avengers", "AT", ev => superPowerLikelyEv(ev, Color.TECH, n => addAttackEvent(ev, n))),
// Draw two cards.
// {POWER Tech} Draw two more cards.
// COST: 7
  ra: makeHeroCard("Iron Man", "Quantum Breakthrough", 7, u, u, Color.TECH, "Avengers", "", [ ev => drawEv(ev, 2), ev => {
    superPowerEv(ev, Color.TECH, () => drawEv(ev, 2));
  } ]),
},
{
  name: "Nick Fury",
...
// COST: 4
  c1: makeHeroCard("Nick Fury", "Battlefield Promotion", 4, u, u, Color.COVERT, "S.H.I.E.L.D.", "G4T", ev => KOHandOrDiscardEv(ev, "S.H.I.E.L.D.", () => gameState.officer.withTop(c => gainToHandEv(ev, c)))),
// ATTACK: 2+
// {POWER Tech} You get +1 Attack.
// COST: 3
// FLAVOR: Fury always budgets one extra prototype for his personal collection.
  c2: makeHeroCard("Nick Fury", "High-Tech Weaponry", 3, u, 2, Color.TECH, "S.H.I.E.L.D.", "GFDA", ev => {
    superPowerLikelyEv(ev, Color.TECH, () => addAttackEvent(ev, 1));
  }),
// ATTACK: 1+
// You get +1 Attack for each other S.H.I.E.L.D. Hero you played this turn.
// COST: 6
  uc: makeHeroCard("Nick Fury", "Legendary Commander", 6, u, 1, Color.STRENGTH, "S.H.I.E.L.D.", "GAT", ev => addAttackEvent(ev, superPowerCount("S.H.I.E.L.D."))),
// Defeat any Villain or Mastermind whose Attack is less than the number of S.H.I.E.L.D. Heroes in the KO pile.
// COST: 8
  ra: makeHeroCard("Nick Fury", "Pure Fury", 8, u, u, Color.TECH, "S.H.I.E.L.D.", "GT", ev => selectCardEv(ev, "Defeat a Villain", fightableCards().limit(v => v.defense < gameState.ko.count("S.H.I.E.L.D.")), sel => defeatEv(ev, sel))),
},
{
  name: "Rogue",
  team: "X-Men",
...
// FLAVOR: When Rogue steals super strength, enemies get super scared.
  c1: makeHeroCard("Rogue", "Borrowed Brawn", 4, u, 1, Color.STRENGTH, "X-Men", "F4A", ev => {
    superPowerLikelyEv(ev, Color.STRENGTH, () => addAttackEvent(ev, 3));
  }),
// RECRUIT: 2+
// {POWER Covert} You may KO a card from your hand or discard pile. If you do, you get +1 Recruit.
// COST: 3
  c2: makeHeroCard("Rogue", "Energy Drain", 3, 2, u, Color.COVERT, "X-Men", "DRT", ev => {
...
// COST: 5
  uc: makeHeroCard("Rogue", "Copy Powers", 5, u, u, Color.COVERT, "X-Men", "T", [], { copyPasteCard: true }),
// ATTACK: 4
// Each player discards the top card of their deck. Play a copy of each of those cards.
// COST: 8
  ra: makeHeroCard("Rogue", "Steal Abilities", 8, u, 4, Color.STRENGTH, "X-Men", "4T", ev => {
    let revealed: Card[] = [];
...
// COST: 2
  c1: makeHeroCard("Spider-Man", "Astonishing Strength", 2, 1, u, Color.STRENGTH, "Spider Friends", "DT", ev => drawIfEv(ev, c => c.cost <= 2)),
// ATTACK: 1
// Reveal the top card of your deck. If that card costs 2 or less, draw it.
// COST: 2
  c2: makeHeroCard("Spider-Man", "Great Responsibility", 2, u, 1, Color.INSTINCT, "Spider Friends", "DT", ev => drawIfEv(ev, c => c.cost <= 2)),
// Rescue a Bystander.
// Reveal the top card of your deck. If that card costs 2 or less, draw it.
// COST: 2
  uc: makeHeroCard("Spider-Man", "Web-Shooters", 2, u, u, Color.TECH, "Spider Friends", "DT", [ rescueEv, ev => drawIfEv(ev, c => c.cost <= 2) ]),
// Reveal the top three cards of your deck. Put any that cost 2 or less into your hand. Put the rest back in any order.
// COST: 2
  ra: makeHeroCard("Spider-Man", "The Amazing Spider-Man", 2, u, u, Color.COVERT, "Spider Friends", "DT", ev => {
...
// FLAVOR: Two little raindrops. Then two billion.
  c1: makeHeroCard("Storm", "Gathering Stormclouds", 3, 2, u, Color.RANGED, "X-Men", "FD", ev => {
    superPowerEv(ev, Color.RANGED, () => drawEv(ev));
  }),
// ATTACK: 2
// Any Villain you fight on the Rooftops this turn gets -2 Attack.
// COST: 4
  c2: makeHeroCard("Storm", "Lightning Bolt", 4, u, 2, Color.RANGED, "X-Men", "D4T", () => {
...
// COST: 6
  uc: makeHeroCard("Storm", "Spinning Cyclone", 6, u, 4, Color.COVERT, "X-Men", "4T", ev => {
...
// COST: 7
  ra: makeHeroCard("Storm", "Tidal Wave", 7, u, 5, Color.RANGED, "X-Men", "DT", ev => {
    addTurnMod("defense", c => isVillain(c) && atLocation(c, "BRIDGE"), -2);
    superPowerEv(ev, Color.RANGED, () => addTurnMod("defense", isMastermind, -2));
  }),
},
{
  name: "Thor",
...
// FLAVOR: "Whosoever holds the hammer, if he be worthy, shall possess the power of Thor."
  c1: makeHeroCard("Thor", "Odinson", 3, 2, u, Color.STRENGTH, "Avengers", "FDR", ev => {
    superPowerLikelyEv(ev, Color.STRENGTH, () => addRecruitEvent(ev, 2));
  }),
// RECRUIT: 2
// ATTACK: 0+
// If you made 8 or more Recruit this turn, you get +3 Attack.
// COST: 4
  c2: makeHeroCard("Thor", "Surge of Power", 4, 2, 0, Color.RANGED, "Avengers", "D4AT", ev => { if (turnState.totalRecruit >= 8) addAttackEvent(ev, 3); }),
// ATTACK: 3+
// {POWER Ranged} You get +3 Attack.
// COST: 6
// FLAVOR: Lightning never strikes twice. Thor never needs to.
  uc: makeHeroCard("Thor", "Call Lightning", 6, u, 3, Color.RANGED, "Avengers", "FA", ev => {
    superPowerLikelyEv(ev, Color.RANGED, () => addAttackEvent(ev, 3));
  }),
// RECRUIT: 5
// ATTACK: 0+
...
// FLAVOR: They call him the God of Thunder. His enemies better start praying.
  ra: makeHeroCard("Thor", "God of Thunder", 8, 5, 0, Color.RANGED, "Avengers", "FA", () => turnState.attackWithRecruit = true),
},
{
  name: "Wolverine",
  team: "X-Men",
...
// COST: 3
  c1: makeHeroCard("Wolverine", "Healing Factor", 3, u, 2, Color.INSTINCT, "X-Men", "DT", ev => KOHandOrDiscardEv(ev, isWound, () => drawEv(ev))),
// ATTACK: 1
// {POWER Instinct} Draw a card.
// COST: 2
// FLAVOR: The only thing scarier than Wolverine tracking you is Wolverine finding you.
  c2: makeHeroCard("Wolverine", "Keen Senses", 2, u, 1, Color.INSTINCT, "X-Men", "FD", ev => {
    superPowerEv(ev, Color.INSTINCT, () => drawEv(ev));
  }),
// ATTACK: 2
// {POWER Instinct} Draw two cards.
// COST: 5
// FLAVOR: Some villains get torn apart by guilt. Others get torn apart by Wolverine.
  uc: makeHeroCard("Wolverine", "Frenzied Slashing", 5, u, 2, Color.INSTINCT, "X-Men", "FD", ev => {
    superPowerEv(ev, Color.INSTINCT, () => drawEv(ev, 2));
  }),
// ATTACK: 0+
// Draw three cards.
// {POWER Instinct} You get +1 Attack for each extra card you've drawn this turn.
// COST: 8
  ra: makeHeroCard("Wolverine", "Berserker Rage", 8, u, 0, Color.INSTINCT, "X-Men", "AT", [ ev => drawEv(ev, 3), ev => superPowerLikelyEv(ev, Color.INSTINCT, () => addAttackEvent(ev, cardsDrawn())) ]),
},
]);
...
// COST: 4
  c1: makeHeroCard("Angel", "Diving Catch", 4, 2, u, Color.STRENGTH, "X-Men", "D4T", [], { trigger: {
    event: "DISCARD",
    match: (ev, source) => ev.what === source && ev.parent.getSource() instanceof Card,
...
// COST: 5
  uc: makeHeroCard("Angel", "Drop Off a Friend", 5, u, 2, Color.INSTINCT, "X-Men", "DAT", ev => selectCardOptEv(ev, "Discard to gain Attack", playerState.hand.deck, c => { discardEv(ev, c); addAttackEvent(ev, c.cost); })),
// ATTACK: 4
// Discard any number of cards. Draw that many cards.
// COST: 7
  ra: makeHeroCard("Angel", "Strength of Spirit", 7, u, 4, Color.STRENGTH, "X-Men", "4", ev => {
    let count = 0;
...
// COST: 3
  c1: makeHeroCard("Bishop", "Absorb Energies", 3, 0, 2, Color.COVERT, "X-Men", "DRT", ev => {
...
// COST: 2
// GUN: 1
  c2: makeHeroCard("Bishop", "Whatever the Cost", 2, u, u, Color.RANGED, "X-Men", "GDT", [ ev => drawEv(ev, 1), ev => {
    superPowerEv(ev, Color.COVERT, () => KOHandOrDiscardEv(ev));
  } ]),
// ATTACK: 3+
// {POWER Ranged Ranged} You get +3 Attack.
// COST: 5
// FLAVOR: Bishop absorbs energy, channeling it back into devastating blasts.
  uc: makeHeroCard("Bishop", "Concussive Blast", 5, u, 3, Color.RANGED, "X-Men", "FA", ev => {
    superPowerLikelyEv(ev, [Color.RANGED, Color.RANGED], () => addAttackEvent(ev, 3));
  }),
// ATTACK: 4+
...
// COST: 7
// GUN: 1
  ra: makeHeroCard("Bishop", "Firepower From the Future", 7, u, 4, Color.TECH, "X-Men", "G4AT", ev => {
...
// COST: 4
  c1: makeHeroCard("Blade", "Night Hunter", 4, 0, 2, Color.STRENGTH, "Marvel Knights", "GD4RT", ev => addTurnTrigger("DEFEAT", ev => isLocation(ev.where, "SEWERS", "ROOFTOPS"), ev => addRecruitEvent(ev, 2))),
// ATTACK: 2
// You may move a Villain to an adjacent city space. If another Villain is already there, swap them.
// COST: 3
  c2: makeHeroCard("Blade", "Stalk the Prey", 3, u, 2, Color.COVERT, "Marvel Knights", "GDT", ev => {
    selectCardOptEv(ev, "Choose a Villain to move", cityVillains(), v => {
...
// COST: 6
  uc: makeHeroCard("Blade", "Nowhere to Hide", 6, u, 3, Color.TECH, "Marvel Knights", "GT", ev => addTurnTrigger("DEFEAT", ev => isLocation(ev.where, "SEWERS", "ROOFTOPS"), ev => drawEv(ev, 2))),
// ATTACK: 0+
// You get +1 Attack for each Villain in your Victory Pile.
// COST: 7
  ra: makeHeroCard("Blade", "Vampiric Surge", 7, u, 0, Color.INSTINCT, "Marvel Knights", "GAT", ev => addAttackEvent(ev, playerState.victory.count(isVillain))),
},
{
  name: "Cable",
  team: "X-Force",
...
// COST: 3
  c1: makeHeroCard("Cable", "Disaster Survivalist", 3, 2, u, Color.TECH, "X-Force", "DT", [], { trigger:
...
// COST: 4
// GUN: 1
  c2: makeHeroCard("Cable", "Strike at the Heart of Evil", 4, u, 2, Color.RANGED, "X-Force", "GD4A", ev => addAttackSpecialEv(ev, isMastermind, 2)),
// ATTACK: 3+
// <b>Teleport</b>
// {TEAMPOWER X-Force} You get +1 Attack for each other X-Force Hero you played this turn.
// COST: 6
// GUN: 1
  uc: makeHeroCard("Cable", "Rapid Response Force", 6, u, 3, Color.COVERT, "X-Force", "GAT", ev => superPowerLikelyEv(ev, "X-Force", n => addAttackEvent(ev, n)), { teleport: true }),
// ATTACK: 5+
// KO any number of cards from your hand. You get +1 Attack for each card KO'd this way.
// COST: 8
// GUN: 1
  ra: makeHeroCard("Cable", "Army of One", 8, u, 5, Color.TECH, "X-Force", "GAT", ev => selectObjectsAnyEv(ev, "KO cards", playerState.hand.deck, c => { KOEv(ev, c); addAttackEvent(ev, 1); })),
},
{
  name: "Colossus",
  team: "X-Force",
...
// COST: 3
  c2: makeHeroCard("Colossus", "Invulnerability", 3, 2, u, Color.STRENGTH, "X-Force", "DT", [], { trigger:
...
// FLAVOR: No one expects an enormous metal brawler to take the stealthy approach.
  uc: makeHeroCard("Colossus", "Silent Statue", 6, u, 4, Color.COVERT, "X-Force", "FD4A", ev => {
    superPowerLikelyEv(ev, Color.STRENGTH, () => addAttackEvent(ev, 2));
  }),
// ATTACK: 6
// If another player would gain a Wound, you may reveal this card to gain that Wound and draw a card.
// COST: 8
  ra: makeHeroCard("Colossus", "Russian Heavy Tank", 8, u, 6, Color.STRENGTH, "X-Force", "T", [], { trigger:
...
// COST: 3
  c1: makeHeroCard("Daredevil", "Backflip", 3, 2, u, Color.STRENGTH, "Marvel Knights", "DT", ev => turnState.nextHeroRecruit = "DECK"),
// ATTACK: 2+
// Choose a number, then reveal the top card of your deck. If the card is that Cost, you get +2 Attack.
// COST: 4
  c2: makeHeroCard("Daredevil", "Radar Sense", 4, u, 2, Color.INSTINCT, "Marvel Knights", "D4AT", ev => {
...
// COST: 6
  uc: makeHeroCard("Daredevil", "Blind Justice", 6, u, 4, Color.COVERT, "Marvel Knights", "4T", ev => chooseCostEv(ev, n => drawIfEv(ev, c => c.cost === n))),
// ATTACK: 7
// Choose a number, then reveal the top card of your deck. If the card is that Cost, draw it and repeat this process.
// COST: 8
  ra: makeHeroCard("Daredevil", "The Man Without Fear", 8, u, 7, Color.INSTINCT, "Marvel Knights", "T", ev => {
...
// COST: 1
  c1: makeHeroCard("Domino", "Lucky Break", 1, 0, 0, Color.TECH, "X-Force", "GRA", [ ev => drawEv(ev, 1), ev => {
...
// FLAVOR: With Domino's mutant probability powers, every day is the luckiest day of her life.
  c2: makeHeroCard("Domino", "Ready for Anything", 3, 0, 0, Color.INSTINCT, "X-Force", "GFDRA", ev => versatileEv(ev, 2)),
// RECRUIT: 0+
// ATTACK: 0+
...
// COST: 5
  uc: makeHeroCard("Domino", "Specialized Ammunition", 5, 0, 0, Color.TECH, "X-Force", "G4RAT", ev => selectCardOptEv(ev, "Choose a card to discard", playerState.hand.deck, sel => {
    discardEv(ev, sel);
...
// COST: 7
  ra: makeHeroCard("Domino", "Against All Odds", 7, 0, 0, Color.COVERT, "X-Force", "GRAT", [ ev => {
    superPowerEv(ev, "X-Force", () => turnState.versatileBoth = true);
  }, ev => versatileEv(ev, 5)]),
},
{
  name: "Elektra",
...
// COST: 1
  c1: makeHeroCard("Elektra", "First Strike", 1, u, 1, Color.COVERT, "Marvel Knights", "AT", ev => { if (turnState.cardsPlayed.size === 0) addAttackEvent(ev, 1); }),
// RECRUIT: 0+
// Draw a card.
// {POWER Covert} You get +2 Recruit.
// COST: 2
// FLAVOR: Zen is the absence of motion. Ninjitsu, the absence of stillness.
  c2: makeHeroCard("Elektra", "Ninjitsu", 2, 0, u, Color.INSTINCT, "Marvel Knights", "FDR", [ ev => drawEv(ev, 1), ev => {
    superPowerLikelyEv(ev, Color.COVERT, () => addRecruitEvent(ev, 2));
  } ]),
// ATTACK: 4+
// You get +1 Attack for each Hero you played this turn that costs 1 or 2.
// COST: 6
  uc: makeHeroCard("Elektra", "Sai Blades", 6, u, 4, Color.INSTINCT, "Marvel Knights", "D4AT", ev => addAttackEvent(ev, turnState.cardsPlayed.count(c => c.cost === 1 || c.cost === 2))),
// RECRUIT: 5+
...
// COST: 7
  ra: makeHeroCard("Elektra", "Silent Meditation", 7, 5, u, Color.INSTINCT, "Marvel Knights", "DRT", ev => {
    turnState.nextHeroRecruit = "HAND";
    superPowerLikelyEv(ev, "Marvel Knights", () => addRecruitEvent(ev, 2));
  }),
},
{
  name: "Forge",
...
// COST: 3
// GUN: 1
  c1: makeHeroCard("Forge", "Dirty Work", 3, u, 2, Color.TECH, "X-Force", "GDT", ev => {
...
// COST: 4
// GUN: 1
  c2: makeHeroCard("Forge", "Reboot", 4, 2, u, Color.TECH, "X-Force", "GD4T", ev => {
...
// FLAVOR: When Forge can't find the turret remote, he just takes a couple of spoons and builds a new one.
  uc: makeHeroCard("Forge", "Overdrive", 5, 0, 0, Color.TECH, "X-Force", "FRA", ev => versatileEv(ev, 3)),
// ATTACK: 5
...
// COST: 5
  c1: makeHeroCard("Ghost Rider", "Blazing Hellfire", 5, u, 2, Color.RANGED, "Marvel Knights", "DAT", ev => {
...
// FLAVOR: Most motorcycles don't drive up walls. Most don't drive into your nightmares.
  c2: makeHeroCard("Ghost Rider", "Hell on Wheels", 3, 2, u, Color.TECH, "Marvel Knights", "FDR", ev => {
    superPowerLikelyEv(ev, "Marvel Knights", () => addRecruitEvent(ev, 2));
  }),
// Draw a card.
// {POWER Strength} Defeat a Villain of 3 Attack or less for free.
// COST: 2
  uc: makeHeroCard("Ghost Rider", "Infernal Chains", 2, u, u, Color.STRENGTH, "Marvel Knights", "DT", [ ev => drawEv(ev, 1), ev => {
...
// COST: 8
  ra: makeHeroCard("Ghost Rider", "Penance Stare", 8, u, 3, Color.RANGED, "Marvel Knights", "AT", ev => {
    let koed: Card[] = [];
...
// COST: 2
  c1: makeHeroCard("Iceman", "Deep Freeze", 2, 0, u, Color.RANGED, "X-Men", "DRT", [ ev => drawEv(ev, 1), ev => superPowerLikelyEv(ev, Color.RANGED, n => addRecruitEvent(ev, n)) ]),
// ATTACK: 2+
// {POWER Ranged} You get +1 Attack for each other [Ranged] Hero you played this turn.
// COST: 4
  c2: makeHeroCard("Iceman", "Ice Slide", 4, u, 2, Color.RANGED, "X-Men", "D4AT", ev => superPowerLikelyEv(ev, Color.RANGED, n => addAttackEvent(ev, n))),
// ATTACK: 3
// {POWER Ranged} Draw a card for each [Ranged] Hero you played this turn.
// COST: 5
  uc: makeHeroCard("Iceman", "Frost Spike Armor", 5, u, 3, Color.STRENGTH, "X-Men", "T", ev => superPowerEv(ev, Color.RANGED, n => drawEv(ev, n))),
// ATTACK: 7
...
// COST: 8
  ra: makeHeroCard("Iceman", "Impenetrable Ice Wall", 8, u, 7, Color.RANGED, "X-Men", "T", [], { triggers: [
...
// COST: 3
  c1: makeHeroCard("Iron Fist", "Focus Chi", 3, 0, u, Color.INSTINCT, "Marvel Knights", "RT", ev => addRecruitEvent(ev, yourHeroes().uniqueCount(c => c.cost))),
// ATTACK: 0+
// You get +1 Attack for each Hero with a different Cost you have.
// COST: 4
  c2: makeHeroCard("Iron Fist", "Wield the Iron Fist", 4, u, 0, Color.STRENGTH, "Marvel Knights", "4AT", ev => addAttackEvent(ev, yourHeroes().uniqueCount(c => c.cost))),
// RECRUIT: 0+
// ATTACK: 0+
// Draw a card.
// {POWER Strength Strength} {VERSATILE 2}
// COST: 1
  uc: makeHeroCard("Iron Fist", "Ancient Legacy", 1, 0, 0, Color.STRENGTH, "Marvel Knights", "DRA", [ ev => drawEv(ev, 1), ev => {
...
// COST: 9
  ra: makeHeroCard("Iron Fist", "Living Weapon", 9, u, 8, Color.STRENGTH, "Marvel Knights", "T", ev => {
    let costs: boolean[] = [];
...
// FLAVOR: Amid violent chaos, a soundless voice leads to safety.
  c1: makeHeroCard("Jean Grey", "Psychic Search", 3, u, 2, Color.RANGED, "X-Men", "FD", ev => {
    superPowerEv(ev, "X-Men", () => rescueEv(ev));
  }),
// RECRUIT: 3+
// Whenever you rescue a Bystander this turn, you get +1 Recruit.
// COST: 5
  c2: makeHeroCard("Jean Grey", "Read Your Thoughts", 5, 3, u, Color.COVERT, "X-Men", "RT", ev => addTurnTrigger("RESCUE", ev => isBystander(ev.what), ev => addRecruitEvent(ev, 1))),
// ATTACK: 4
// Whenever you rescue a Bystander this turn, draw a card.
// COST: 6
  uc: makeHeroCard("Jean Grey", "Mind Over Matter", 6, u, 4, Color.COVERT, "X-Men", "4T", ev => addTurnTrigger("RESCUE", ev => isBystander(ev.what), ev => drawEv(ev))),
// ATTACK: 5+
...
// COST: 7
  ra: makeHeroCard("Jean Grey", "Telekinetic Mastery", 7, u, 5, Color.RANGED, "X-Men", "AT", [
    ev => addTurnTrigger("RESCUE", ev => isBystander(ev.what), ev => addAttackEvent(ev, 1)),
    ev => cont(ev, () => superPowerEv(ev, "X-Men", n => rescueEv(ev, n)))
   ]),
},
{
  name: "Nightcrawler",
...
// FLAVOR: Sometimes it is best to hide now and fight later.
  c2: makeHeroCard("Nightcrawler", "Blend Into Shadows", 4, u, 2, Color.COVERT, "X-Men", "FD4", [], { teleport: true }),
// ATTACK: 3+
// {POWER Covert Instinct} You get +3 Attack.
// COST: 5
// FLAVOR: Chivalry wears blue fur.
  uc: makeHeroCard("Nightcrawler", "Swashbuckler", 5, u, 3, Color.INSTINCT, "X-Men", "FA", ev => {
    superPowerLikelyEv(ev, [Color.COVERT, Color.INSTINCT], () => addAttackEvent(ev, 3));
  }),
// ATTACK: 5
// <b>Teleport</b>
// When you play or <b>Teleport</b> this card, you may also <b>Teleport</b> up to three other cards from your hand.
// COST: 7
  ra: makeHeroCard("Nightcrawler", "Along for the Ride", 7, u, 5, Color.COVERT, "X-Men", "T", ev => {
...
// FLAVOR: "What do they call you? Wheels?"
  c1: makeHeroCard("Professor X", "Class Dismissed", 3, 2, u, Color.INSTINCT, "X-Men", "FDT", [
    ev => selectCardOptEv(ev, "Choose a Hero", hqHeroes(), c => moveCardEv(ev, c, gameState.herodeck, true)),
    ev => {
      superPowerEv(ev, Color.INSTINCT, () => KOHandOrDiscardEv(ev, undefined));
    },
  ]),
// ATTACK: 1+
...
// FLAVOR: In a plane of pure mental energy, Xavier's body is as powerful as his mind.
  c2: makeHeroCard("Professor X", "Psionic Astral Form", 2, u, 1, Color.RANGED, "X-Men", "FDA", ev => {
    superPowerLikelyEv(ev, "X-Men", () => addAttackEvent(ev, 2));
  }),
// ATTACK: 3
...
// COST: 5
  uc: makeHeroCard("Professor X", "Telepathic Probe", 5, u, 3, Color.RANGED, "X-Men", "T", ev => revealVillainDeckEv(ev, 1, r => {
...
// COST: 8
  ra: makeHeroCard("Professor X", "Mind Control", 8, u, 6, Color.COVERT, "X-Men", "T", ev =>
...
// FLAVOR: The Punisher always knows which cops are corrupt.
  c1: makeHeroCard("Punisher", "Boom Goes the Dynamite", 2, u, u, Color.TECH, "Marvel Knights", "GFDT", [
...
// COST: 5
  c2: makeHeroCard("Punisher", "Hail of Bullets", 5, u, 2, Color.TECH, "Marvel Knights", "GDAT", ev => {
...
// COST: 3
  uc: makeHeroCard("Punisher", "Hostile Interrogation", 3, 2, u, Color.STRENGTH, "Marvel Knights", "GD4RT", ev => {
    superPowerEv(ev, Color.STRENGTH, () => {
      let count = 0;
...
// COST: 8
  ra: makeHeroCard("Punisher", "The Punisher", 8, u, 4, Color.TECH, "Marvel Knights", "G4AT", ev => {
...
// FLAVOR: To avoid injury, it's best to keep a distance from Wolverine of at least 5,000 miles.
  c1: makeHeroCard("Wolverine", "Animal Instincts", 2, u, 0, Color.INSTINCT, "X-Force", "FDA", [ ev => drawEv(ev, 1), ev => {
    superPowerLikelyEv(ev, Color.INSTINCT, () => addAttackEvent(ev, 2));
  } ]),
// ATTACK: 2+
// If you drew any extra cards this turn, you get +2 Attack.
// COST: 4
  c2: makeHeroCard("Wolverine", "Sudden Ambush", 4, u, 2, Color.COVERT, "X-Force", "D4AT", ev => {if (cardsDrawn() > 0) addAttackEvent(ev, 2); }),
// Draw a card.
// You may KO a card from your hand or discard pile.
// COST: 4
  uc: makeHeroCard("Wolverine", "No Mercy", 4, u, u, Color.STRENGTH, "X-Force", "4T", [ ev => drawEv(ev, 1), ev => KOHandOrDiscardEv(ev, undefined) ]),
// ATTACK: 3
// Count the number of extra cards you drew this turn. Draw that many cards.
// COST: 7
  ra: makeHeroCard("Wolverine", "Reckless Abandon", 7, u, 3, Color.COVERT, "X-Force", "T", ev => drawEv(ev, cardsDrawn())),
},
]);
...
// FLAVOR: The Fantastic Four has access to all sorts of communications; Johnny prefers his own methods.
  c1: makeHeroCard("Human Torch", "Call for Backup", 3, 2, u, Color.INSTINCT, "Fantastic Four", "FDRT", ev => KOHandOrDiscardEv(ev, isWound, () => addRecruitEvent(ev, 1))),
// ATTACK: 4
// You gain a Wound.
// COST: 4
// FLAVOR: "I like to know my limits. So I can break them."
  c2: makeHeroCard("Human Torch", "Hothead", 4, u, 4, Color.RANGED, "Fantastic Four", "F4", ev => gainWoundEv(ev)),
// ATTACK: 4+
// {FOCUS 6} You get +4 Attack.
// COST: 6
  uc: makeHeroCard("Human Torch", "Flame On!", 6, u, 4, Color.RANGED, "Fantastic Four", "4A", ev => setFocusEv(ev, 6, ev => addAttackEvent(ev, 4))),
// ATTACK: 6+
// {TEAMPOWER Fantastic Four} You get +1 Attack for each city space that contains a Villain.
// COST: 8
  ra: makeHeroCard("Human Torch", "Nova Flame", 8, u, 6, Color.RANGED, "Fantastic Four", "AT", ev => superPowerLikelyEv(ev, "Fantastic Four", () => addAttackEvent(ev, cityVillains().size))),
},
{
...
// FLAVOR: "Now you see it...Now you don't!"
  c1: makeHeroCard("Invisible Woman", "Disappearing Act", 4, 2, u, Color.COVERT, "Fantastic Four", "FD4T", ev => setFocusEv(ev, 2, ev => KOHandOrDiscardEv(ev, undefined))),
// ATTACK: 2+
// If you played any other cards that cost 4 this turn, you get +2 Attack.
// COST: 4
// FLAVOR: A family that plays together stays together.
  c2: makeHeroCard("Invisible Woman", "Four of a Kind", 4, u, 2, Color.RANGED, "Fantastic Four", "FD4AT", ev => turnState.cardsPlayed.has(c => c.cost === 4) && addAttackEvent(ev, 2)),
// ATTACK: 2
...
// FLAVOR: "If seeing is believing, you are not going to believe this."
  uc: makeHeroCard("Invisible Woman", "Unseen Rescue", 4, u, 2, Color.COVERT, "Fantastic Four", "FD4T", ev => setFocusEv(ev, 2, ev => rescueEv(ev), 4)),
// ATTACK: 5
// If an ambush effect would occur, you may reveal this card and draw two cards instead.
// COST: 7
  ra: makeHeroCard("Invisible Woman", "Invisible Barrier", 7, u, 5, Color.COVERT, "Fantastic Four", "T", [], { trigger:
...
// FLAVOR: "I consider the laws of physics more like guidelines."
  c1: makeHeroCard("Mr. Fantastic", "Twisting Equations", 3, 2, u, Color.TECH, "Fantastic Four", "FDT", ev => setFocusEv(ev, 2, ev => addEndDrawMod(1))),
// Draw two cards.
// COST: 5
...
// FLAVOR: "Most of my career is thinking. Then there's this."
  uc: makeHeroCard("Mr. Fantastic", "One Gigantic Hand", 5, u, 1, Color.INSTINCT, "Fantastic Four", "FAT", ev => superPowerLikelyEv(ev, "Fantastic Four", () => addAttackEvent(ev, playerState.hand.size))),
// ATTACK: 4+
...
// COST: 7
  ra: makeHeroCard("Mr. Fantastic", "Ultimate Nullifier", 7, u, 4, Color.TECH, "Fantastic Four", "4AT", [
...
// GUN: 1
  c1: makeHeroCard("Silver Surfer", "Epic Destiny", 4, 2, u, Color.STRENGTH, u, "GFD4", ev => setFocusEv(ev, 6, ev => selectCardEv(ev, "Defeat villain", villains().limit(c => c.defense === 5 || c.defense === 6), (c) => defeatEv(ev, c)))),
// RECRUIT: 2
// {FOCUS 2} Draw a card.
// COST: 3
// FLAVOR: "Engage!"
...
// FLAVOR: As a Herald, Surfer selected many planets for the Devourer of Worlds, until Earth taught him compassion.
  uc: makeHeroCard("Silver Surfer", "The Power Cosmic", 6, 3, 0, Color.RANGED, u, "FA", ev => setFocusEv(ev, 9, ev => addAttackEvent(ev, 9))),
...
// FLAVOR: Yancy Street is Thing's turf. Trespass at your own risk.
  c1: makeHeroCard("Thing", "It Started on Yancy Street", 3, 2, u, Color.INSTINCT, "Fantastic Four", "FDR", ev => superPowerLikelyEv(ev, "Fantastic Four", () => addRecruitEvent(ev, 2))),
// RECRUIT: 3
// ATTACK: 0+
// {FOCUS 3} You get +2 Attack.
// COST: 5
// FLAVOR: Recipe prep time: 3 seconds. Serves: 20
  c2: makeHeroCard("Thing", "Knuckle Sandwich", 5, 3, 0, Color.STRENGTH, "Fantastic Four", "FDA", ev => setFocusEv(ev, 3, ev => addAttackEvent(ev, 2))),
// ATTACK: 4
...
// COST: 6
  uc: makeHeroCard("Thing", "Crime Stopper", 6, u, 4, Color.STRENGTH, "Fantastic Four", "4T", [
...
// FLAVOR: Thing doesn't wear a watch, but he's happy to tell you what time it is.
  ra: makeHeroCard("Thing", "It's Clobberin' Time!", 8, u, 5, Color.STRENGTH, "Fantastic Four", "FAT", ev => superPowerLikelyEv(ev, Color.STRENGTH, () => superPowerLikelyEv(ev, Color.STRENGTH, n => addAttackEvent(ev, 3 * n)))),
},
]);
...
// COST: 4
  c1: makeHeroCard("Black Cat", "Casual Bank Robbery", 4, 2, u, Color.COVERT, "Spider Friends", "D4RT",
...
// COST: 1
// GUN: 1
  c2: makeHeroCard("Black Cat", "Pickpocket", 1, u, 0, Color.COVERT, "Spider Friends", "GAT",
...
// FLAVOR: Bad luck comes to all who cross Black Cat's path.
  uc: makeHeroCard("Black Cat", "Jinx", 5, u, 3, Color.INSTINCT, "Spider Friends", "FT", ev => eachPlayer(p => {
...
// COST: 8
  ra: makeHeroCard("Black Cat", "Cat Burglar", 8, u, 5, Color.COVERT, "Spider Friends", "AT", [
...
// FLAVOR: Criminals feel the cold light of the moon on their sins...but they never think to look up.
  c1: makeHeroCard("Moon Knight", "Climbing Claws", 3, 2, u, Color.TECH, "Marvel Knights", "FDR", ev => superPowerLikelyEv(ev, Color.INSTINCT, () => addRecruitEvent(ev, 1)), { wallcrawl: true }),
// ATTACK: 2
// {WALLCRAWL}
// Whenever you defeat a Villain on the Rooftops this turn, you may KO one of your cards or a card from your discard pile.
// COST: 3
  c2: makeHeroCard("Moon Knight", "Lunar Communion", 3, u, 2, Color.INSTINCT, "Marvel Knights", "DT",
...
// FLAVOR: Villains face the crescent moon's judgment. Then they get the crescent moon's judgment in their face.
  uc: makeHeroCard("Moon Knight", "Crescent Moon Darts", 5, u, 3, Color.TECH, "Marvel Knights", "FT",
...
// COST: 8
  ra: makeHeroCard("Moon Knight", "Golden Ankh of Khonshu", 8, u, 6, Color.INSTINCT, "Marvel Knights", "T", [
...
// COST: 2
  c1: makeHeroCard("Scarlet Spider", "Flip Out", 2, 1, u, Color.STRENGTH, "Spider Friends", "D", ev => superPowerEv(ev, "Spider Friends", () => drawEv(ev, 1)), { wallcrawl: true }),
// ATTACK: 1
// {WALLCRAWL}
// Draw a card.
// COST: 4
// FLAVOR: Predators who underestimate Scarlet Spider quickly find themselves the prey.
  c2: makeHeroCard("Scarlet Spider", "Perfect Hunter", 4, u, 1, Color.INSTINCT, "Spider Friends", "F4", ev => drawEv(ev, 1), { wallcrawl: true }),
// ATTACK: 3+
// {WALLCRAWL}
// {POWER Instinct} You get +2 Attack.
// COST: 6
// FLAVOR: A life of chaos lends Scarlet Spider an unpredictability that opponents can't escape.
  uc: makeHeroCard("Scarlet Spider", "Leap From Above", 6, u, 3, Color.COVERT, "Spider Friends", "FDA", ev => superPowerLikelyEv(ev, Color.INSTINCT, () => addAttackEvent(ev, 2)), { wallcrawl: true }),
// ATTACK: 5
...
// FLAVOR: Many people are allergic...to getting punched in the face by a truck.
  ra: makeHeroCard("Scarlet Spider", "Sting of the Spider", 7, u, 5, Color.STRENGTH, "Spider Friends", "FT",
...
// COST: 4
  c1: makeHeroCard("Spider-Woman", "Bioelectric Shock", 4, u, 2, Color.RANGED, "Spider Friends", "D4T",
...
// COST: 2
// FLAVOR: Et tu, Brute?
  c2: makeHeroCard("Spider-Woman", "Radioactive Spider", 2, 3, u, Color.STRENGTH, "Spider Friends", "FDT", [], { playCost: 1, playCostType: 'TOPDECK' }),
// ATTACK: 3
// {WALLCRAWL}
...
// FLAVOR: For prison psychologists, arachnophobia is a surprisingly common diagnosis.
  uc: makeHeroCard("Spider-Woman", "Venom Blast", 6, u, 3, Color.RANGED, "Spider Friends", "FT",
...
// FLAVOR: They'll follow her anywhere.
  ra: makeHeroCard("Spider-Woman", "Arachno-Pheromones", 7, u, u, Color.COVERT, "Spider Friends", "FT",
    ev => selectCardEv(ev, 'Rectuit a Hero for free', hqHeroes(), c => {
      superPowerEv(ev, "Spider Friends", () => turnState.nextHeroRecruit = 'DECK');
...
// COST: 2
  c1: makeHeroCard("Symbiote Spider-Man", "Dark Strength", 2, u, 1, Color.STRENGTH, "Spider Friends", "DAT",
...
// COST: 2
  c2: makeHeroCard("Symbiote Spider-Man", "Spider-Sense Tingling", 2, u, u, Color.INSTINCT, "Spider Friends", "DT",
...
// COST: 2
  uc: makeHeroCard("Symbiote Spider-Man", "Shadowed Spider", 2, u, 1, Color.COVERT, "Spider Friends", "DAT",
...
// COST: 2
  ra: makeHeroCard("Symbiote Spider-Man", "Thwip!", 2, u, 4, Color.RANGED, "Spider Friends", "D4T", [], { playCost: 2, playCostType: 'TOPDECK' }),
},
]);
...
// FLAVOR: "And for my next trick..."
  c1: makeHeroCard("Bullseye", "Everything's a Weapon", 3, u, 2, Color.RANGED, "Crime Syndicate", "FD", ev => superPowerEv(ev, Color.INSTINCT, () => drawEv(ev, 1))),
// RECRUIT: 0+
// {DODGE}
// Choose an Adversary Group. You get +1 Recruit for each Adversary in your Victory Pile from that Adversary Group.
// COST: 2
  c2: makeHeroCard("Bullseye", "Fulfill the Contract", 2, 0, u, Color.INSTINCT, "Crime Syndicate", "DRT", ev => {
...
// COST: 6
  uc: makeHeroCard("Bullseye", "Specialist Assassin", 6, u, 3, Color.COVERT, "Crime Syndicate", "T", ev => {
    const p = playerState;
...
// COST: 7
// GUN: 1
  ra: makeHeroCard("Bullseye", "Perfect Aim", 7, u, 5, Color.RANGED, "Crime Syndicate", "GAT", ev => {
...
// COST: 3
  c1: makeHeroCard("Dr. Octopus", "Brilliant Research", 3, 2, u, Color.TECH, "Sinister Six", "DT", ev => {
    superPowerEv(ev, Color.TECH, () => addEndDrawMod(1));
  }),
// ATTACK: 2
// Draw a card.
// COST: 5
...
// FLAVOR: If at first you don't succeed...
  uc: makeHeroCard("Dr. Octopus", "Eighth Time's a Charm", 6, u, 4, Color.STRENGTH, "Sinister Six", "FD4AT", ev => {
...
// COST: 8
  ra: makeHeroCard("Dr. Octopus", "Octo-Pulverize", 8, u, 0, Color.TECH, "Sinister Six", "AT", ev => {
...
// FLAVOR: "I'm not really all that shocked to see you go"
  c1: makeHeroCard("Electro", "Electroshock Therapy", 2, u, u, Color.RANGED, "Sinister Six", "FDT", ev => {
...
// COST: 3
  c2: makeHeroCard("Electro", "Shocking Robbery", 3, u, 0, Color.RANGED, "Sinister Six", "AT", ev => {
...
// FLAVOR: Unlimited Power!
  uc: makeHeroCard("Electro", "Supercharge", 5, u, 2, Color.INSTINCT, "Sinister Six", "FDAT", ev => addAttackEvent(ev, cardsDiscarded())),
// ATTACK: 4
// All Adversaries and the Commander get -1 Attack this turn.
// {TEAMPOWER Sinister Six, Sinister Six} Same Effect
// COST: 7
  ra: makeHeroCard("Electro", "Anti-Matter", 7, u, 4, Color.RANGED, "Sinister Six", "4T", ev => {
    addTurnMod('defense', c => isVillain(c) || isMastermind(c), -1);
    superPowerEv(ev, ["Sinister Six", "Sinister Six"], () => addTurnMod('defense', c => isVillain(c) || isMastermind(c), -1));
  }),
},
{
  name: "Enchantress",
...
// COST: 3
  c1: makeHeroCard("Enchantress", "Enchant the Senses", 3, u, 2, Color.RANGED, "Foes of Asgard", "DT", ev => {
...
// COST: 4
  c2: makeHeroCard("Enchantress", "Soul Sacrifice", 4, 1, u, Color.COVERT, "Foes of Asgard", "4RT", ev => KOHandOrDiscardEv(ev, undefined, c => addRecruitEvent(ev, c.cost))),
// RECRUIT: 3
...
// COST: 6
  uc: makeHeroCard("Enchantress", "Irresistible Bribe", 6, 3, u, Color.COVERT, "Foes of Asgard", "T", [
...
// COST: 7
  ra: makeHeroCard("Enchantress", "Unending Anguish", 7, u, u, Color.COVERT, "Foes of Asgard", "T", [
    ev => drawEv(ev, 3),
...
// COST: 4
  c1: makeHeroCard("Green Goblin", "Goblin Glider", 4, u, 2, Color.TECH, "Sinister Six", "D4T", ev => {
...
// COST: 3
  c2: makeHeroCard("Green Goblin", "Pumpkin Bombs", 3, u, 1, Color.TECH, "Sinister Six", "DAT", ev => cardsDiscarded() && addAttackEvent(ev, 2), { cardActions: [ dodge ] }),
// RECRUIT: 3
// {DODGE}
// If you discarded any cards this turn, kidnap a Bystander.
// COST: 5
  uc: makeHeroCard("Green Goblin", "Unstable Kidnapper", 5, 3, u, Color.INSTINCT, "Sinister Six", "T", ev => cardsDiscarded() && rescueEv(ev), { cardActions: [ dodge ] }),
// ATTACK: 4
// Return from your discard pile to your hand all the cards you discarded this turn.
// COST: 7
  ra: makeHeroCard("Green Goblin", "Experimental Goblin Serum", 7, u, 4, Color.TECH, "Sinister Six", "4T", ev => {
...
// COST: 4
  c1: makeHeroCard("Juggernaut", "Crimson Gem of Cyttorak", 4, 2, u, Color.STRENGTH, "Brotherhood", "D4RT", ev => {
...
// COST: 4
  c2: makeHeroCard("Juggernaut", "Size Matters", 4, u, 2, Color.STRENGTH, "Brotherhood", "D4AT", ev => addAttackEvent(ev, turnState.cardsPlayed.count(c => c.cost >= 4))),
// ATTACK: 4
// To play this card, you must discard a card from your hand.
// COST: 5
// FLAVOR: Move it or lose it.
  uc: makeHeroCard("Juggernaut", "Runaway Train", 5, u, 4, Color.STRENGTH, "Brotherhood", "F4T", [], { playCost: 1, playCostType: 'DISCARD'}),
// ATTACK: 5+
...
// COST: 8
  ra: makeHeroCard("Juggernaut", "Unstoppable Force", 8, u, 5, Color.STRENGTH, "Brotherhood", "AT", ev => {
    let count = 0;
...
// COST: 3
  c1: makeHeroCard("Kingpin", "Pull the Strings", 3, u, u, Color.COVERT, "Crime Syndicate", "T", [
...
// FLAVOR: "Anyone else want to punch Daredevil in the face?"
  c2: makeHeroCard("Kingpin", "Recruitment Day", 3, 2, u, Color.STRENGTH, "Crime Syndicate", "FD", ev => {
    superPowerEv(ev, Color.STRENGTH, () => gameState.newRecruit.withTop(c => gainEv(ev, c)));
  }),
// ATTACK: 3+
// You get +1 Attack for each New Recruit you played this turn.
// COST: 5
  uc: makeHeroCard("Kingpin", "Import Illegal Weapons", 5, u, 3, Color.TECH, "Crime Syndicate", "AT", ev => {
...
// COST: 8
  ra: makeHeroCard("Kingpin", "Endless Underlings", 8, u, u, Color.STRENGTH, "Crime Syndicate", "T", [
...
// FLAVOR: Sometimes it's not best to go it alone.
  c1: makeHeroCard("Kraven", "Ceaseless Tracker", 2, 1, u, Color.INSTINCT, "Sinister Six", "FDR", ev => superPowerLikelyEv(ev, "Sinister Six", () => addRecruitEvent(ev, 2)), { cardActions: [ dodge ] }),
// ATTACK: 2
// Choose an Adversary. If there are no empty city spaces adjacent to that Adversary, it gets -1 Attack this turn.
// COST: 4
// GUN: 1
  c2: makeHeroCard("Kraven", "Corner the Prey", 4, u, 2, Color.COVERT, "Sinister Six", "GD4T", ev => {
...
// COST: 5
  uc: makeHeroCard("Kraven", "Hunt Down", 5, u, 2, Color.STRENGTH, "Sinister Six", "DAT", ev => {
...
// FLAVOR: No one's gonna ever keep him down.
  ra: makeHeroCard("Kraven", "He's the Best Around", 8, u, 0, Color.INSTINCT, "Sinister Six", "FAT", ev => {
...
// COST: 3
  c1: makeHeroCard("Loki", "All Humans Are Expendable", 3, u, 2, Color.COVERT, "Foes of Asgard", "DT", ev => superPowerEv(ev, Color.COVERT, () => KOHandOrDiscardEv(ev, undefined, () => gameState.newRecruit.withTop(c => gainEv(ev, c))))),
// RECRUIT: 2+
...
// COST: 4
  c2: makeHeroCard("Loki", "Illusionary Bindings", 4, 2, u, Color.RANGED, "Foes of Asgard", "D4RT", ev => {
...
// COST: 5
  uc: makeHeroCard("Loki", "Father of Lies", 5, u, 3, Color.COVERT, "Foes of Asgard", "T", ev => {
...
// COST: 8
  ra: makeHeroCard("Loki", "God of Mischief", 8, u, 6, Color.COVERT, "Foes of Asgard", "T", ev => {
...
// COST: 3
  c1: makeHeroCard("Magneto", "Magnetic Levitation", 3, u, 1, Color.RANGED, "Brotherhood", "DAT", ev => {
...
// COST: 4
  c2: makeHeroCard("Magneto", "Mutants Will Rule", 4, 2, u, Color.STRENGTH, "Brotherhood", "D4RT", ev => {
...
// FLAVOR: One person's trash is another person's high velocity projectile weapon.
  uc: makeHeroCard("Magneto", "Weapons From Scrap Metal", 5, u, 3, Color.RANGED, "Brotherhood", "FT", ev => cardsDiscarded() && drawEv(ev)),
// ATTACK: 4+
...
// COST: 7
  ra: makeHeroCard("Magneto", "Master of Magnetism", 7, u, 4, Color.RANGED, "Brotherhood", "D4AT", ev => {
    superPowerEv(ev, "Brotherhood", n => {
      repeat(n, () => choosePlayerEv(ev, p => gameState.bindings.withTop(c => gainEv(ev, c, p))));
...
// FLAVOR: Mysterio is at his best when the mist rolls in.
  c1: makeHeroCard("Mysterio", "Psychedelic Mist", 2, u, 1, Color.RANGED, "Sinister Six", "FDA", ev => superPowerLikelyEv(ev, Color.COVERT, () => addAttackEvent(ev, 2)), { cardActions: [ dodge ] }),
// RECRUIT: 0+
// ATTACK: 0+
...
// COST: 3
  c2: makeHeroCard("Mysterio", "Shifting Decoy", 3, 0, 0, Color.COVERT, "Sinister Six", "DRAT", ev => {
...
// COST: 5
  uc: makeHeroCard("Mysterio", "Holographic Illusion", 5, u, 0, Color.TECH, "Sinister Six", "AT", ev => addAttackEvent(ev, hqHeroes().uniqueCount(c => c.color))),
// RECRUIT: 0+
// ATTACK: 0+
...
// COST: 7
  ra: makeHeroCard("Mysterio", "False Reflection", 7, 0, 0, Color.INSTINCT, "Sinister Six", "RAT", ev => {
    const f = () => cont(ev, () => selectCardEv(ev, "Select a card to put on the bottom of the Ally Deck", hqCards(), c => {
    ...
    superPowerEv(ev, "Sinister Six", n => repeat(n + 1, f), () => f());
  }),
},
{
  name: "Mystique",
...
// GUN: 1
  c1: makeHeroCard("Mystique", "Hidden Weapons", 4, u, 2, Color.TECH, "Brotherhood", "GFD4A", ev => superPowerLikelyEv(ev, [Color.INSTINCT, Color.TECH], () => addAttackEvent(ev, 3))),
// RECRUIT: 2
// {DODGE}
// As you play this card, you may choose a class. This card is that class instead of [Covert] this turn.
// COST: 3
  c2: makeHeroCard("Mystique", "Show Your True Colors", 3, 2, u, Color.COVERT, "Brotherhood", "DT", ev => {
...
// COST: 4
  uc: makeHeroCard("Mystique", "Turn the Tide", 4, u, u, Color.INSTINCT, "Brotherhood", "4T", ev => {
...
// COST: 7
  ra: makeHeroCard("Mystique", "Spy Games", 7, u, 0, Color.COVERT, "Brotherhood", "AT", ev => {
...
// COST: 3
  c1: makeHeroCard("Sabretooth", "Leap of the Tiger", 3, u, 2, Color.INSTINCT, "Brotherhood", "DAT", ev => {
...
// COST: 4
  c2: makeHeroCard("Sabretooth", "Take One for the Team", 4, 1, u, Color.INSTINCT, "Brotherhood", "4T", ev => {
    let draw = false;
...
// COST: 2
  uc: makeHeroCard("Sabretooth", "Stealthy Predator", 2, u, u, Color.COVERT, "Brotherhood", "DT", ev => {
...
// COST: 7
  ra: makeHeroCard("Sabretooth", "Upper Hand", 7, u, 4, Color.STRENGTH, "Brotherhood", "4AT", [
...
// COST: 3
  c1: makeHeroCard("Ultron", "Army of Ultrons", 3, 2, u, Color.TECH, u, "DT", ev => {
...
// COST: 2
  c2: makeHeroCard("Ultron", "Encephalo-Ray", 2, u, 0, Color.TECH, u, "DAT", ev => superPowerLikelyEv(ev, Color.TECH, n => addAttackEvent(ev, n)), { cardActions: [ dodge ] }),
// ATTACK: 3
// {POWER Tech} Kidnap a Bystander for each other [Tech] Ally you played this turn.
// COST: 6
  uc: makeHeroCard("Ultron", "Genetic Experimentation", 6, u, 3, Color.TECH, u, "T", ev => superPowerEv(ev, Color.TECH, n => rescueEv(ev, n))),
// ATTACK: 5+
...
// COST: 8
  ra: makeHeroCard("Ultron", "Molecular Rearrangement", 8, u, 5, Color.TECH, u, "AT", ev => {
...
// COST: 4
// FLAVOR: Feeding Time!
  c1: makeHeroCard("Venom", "Devour", 4, u, 2, Color.INSTINCT, "Sinister Six", "FD4AT", ev => {
...
// FLAVOR: "Where do you think you're going?"
  c2: makeHeroCard("Venom", "Symbiote Takeover", 3, 2, u, Color.STRENGTH, "Sinister Six", "FD", ev => superPowerEv(ev, Color.STRENGTH, () => rescueEv(ev))),
// ATTACK: 4
// Each Adversary with a 4 Attack or more guards a Bystander.
// COST: 6
  uc: makeHeroCard("Venom", "Horrify the Populace", 6, u, 4, Color.STRENGTH, "Sinister Six", "4T", ev => {
...
// COST: 7
  ra: makeHeroCard("Venom", "Ravenous Greed", 7, 0, 5, Color.INSTINCT, "Sinister Six", "RT", [
...
addHeroTemplates("Guardians of the Galaxy", [
  ...
  // COST: 3
    c2: makeHeroCard("Drax the Destroyer", "Interstellar Tracker", 3, 2, u, Color.INSTINCT, "Guardians of the Galaxy", "DT", ev => {
  ...
  // COST: 6
    uc: makeHeroCard("Drax the Destroyer", "The Destroyer", 6, u, 4, Color.INSTINCT, "Guardians of the Galaxy", "4T", ev => {
  ...
  // COST: 3
    c2: makeHeroCard("Gamora", "Deadliest Woman in the Universe", 3, u, u, Color.INSTINCT, "Guardians of the Galaxy", "", ev => {
      gainShardEv(ev, 2);
      superPowerLikelyEv(ev, Color.COVERT, () => gainShardEv(ev));
    }),
  // ATTACK: 3
  ...
  // COST: 5
  // GUN: 1
    uc: makeHeroCard("Gamora", "Galactic Assassin", 5, u, 3, Color.COVERT, "Guardians of the Galaxy", "GT", [
  ...
  // COST: 8
    ra: makeHeroCard("Gamora", "Godslayer Blade", 8, u, u, Color.COVERT, "Guardians of the Galaxy", "T", [
      ev => gainShardEv(ev, 2),
  ...
  // COST: 4
    c1: makeHeroCard("Groot", "Prune the Growths", 4, u, 2, Color.STRENGTH, "Guardians of the Galaxy", "D4T", ev => superPowerEv(ev, Color.STRENGTH, () => KOHandOrDiscardEv(ev, undefined, () => gainShardEv(ev)))),
  // ATTACK: 1
  // When you draw a new hand of cards at the end of this turn, draw an extra card.
  // COST: 3
    c2: makeHeroCard("Groot", "Surviving Sprig", 3, u, 1, Color.STRENGTH, "Guardians of the Galaxy", "T", ev => addEndDrawMod(1)),
  ...
  // COST: 4
    uc: makeHeroCard("Groot", "Groot and Branches", 4, u, u, Color.COVERT, "Guardians of the Galaxy", "4T", [
      ev => gainShardEv(ev, 2),
  ...
  // COST: 8
    ra: makeHeroCard("Groot", "I Am Groot", 8, 5, u, Color.STRENGTH, "Guardians of the Galaxy", "T", ev => {
      let once = 0;
  ...
  // COST: 3
    c1: makeHeroCard("Rocket Raccoon", "Gritty Scavenger", 3, 2, u, Color.TECH, "Guardians of the Galaxy", "GDT", ev => {
  ...
  // COST: 4
    c2: makeHeroCard("Rocket Raccoon", "Trigger Happy", 4, u, 2, Color.RANGED, "Guardians of the Galaxy", "GD4T", ev => {
      superPowerLikelyEv(ev, "Guardians of the Galaxy", n => gainShardEv(ev, n));
    }),
  // <b>Artifact -</b>
  // Whenever a Master Strike or Villain's Ambush ability is completed, you may gain a Shard.
  // COST: 4
    uc: makeHeroCard("Rocket Raccoon", "Incoming Detector", 4, u, u, Color.INSTINCT, "Guardians of the Galaxy", "G4T", [], {
      isArtifact: true,
      triggers: [ {
        event: "CARDEFFECT",
  ...
  // COST: 7
    ra: makeHeroCard("Rocket Raccoon", "Vengeance is Rocket", 7, u, 5, Color.TECH, "Guardians of the Galaxy", "GAT", ev => {
      superPowerLikelyEv(ev, Color.TECH, () => addAttackEvent(ev, strikerCount(false)));
    }),
  },
  {
    name: "Star-Lord",
  ...
  // COST: 4
  // GUN: 1
    c1: makeHeroCard("Star-Lord", "Element Guns", 4, u, u, Color.RANGED, "Guardians of the Galaxy", "G4", ev => gainShardEv(ev), oncePerTurnArtifact()),
  // RECRUIT: 2
  // Choose an <b>Artifact</b> any player controls with a "once per turn" ability. Play a copy of one of those abilities.
  // COST: 4
    c2: makeHeroCard("Star-Lord", "Legendary Outlaw", 4, 2, u, Color.COVERT, "Guardians of the Galaxy", "D4T", ev => {
  ...
  // COST: 8
  // GUN: 1
    ra: makeHeroCard("Star-Lord", "Sentient Starship", 8, u, u, Color.RANGED, "Guardians of the Galaxy", "GT", ev => gainShardEv(ev, playerState.artifact.size), oncePerTurnArtifact()),
  },
]);
...
// FLAVOR: When Absorbing Man seized the Mace, he was reborn as Greithoth, body and soul.
  c1: makeHeroCard("Greithoth, Breaker of Wills", "Mace of Chains", 3, u, u, Color.INSTINCT, "Foes of Asgard", "FDT", ev => addRecruitEvent(ev, 2), {
    ...thrownArtifact
  }),
// ATTACK: 1+
// If you control an <b>Artifact</b>, you get +2 Attack.
// COST: 3
  c2: makeHeroCard("Greithoth, Breaker of Wills", "Absorb Metal", 3, u, 1, Color.COVERT, "Foes of Asgard", "DAT", ev => playerState.artifact.size && addAttackEvent(ev, 2)),
// ATTACK: 3+
// {POWER Covert} Each player discards the bottom card of their deck. For each non-grey card discard this way, you get +1 Attack.
// COST: 5
  uc: makeHeroCard("Greithoth, Breaker of Wills", "Break the Will to Resist", 5, u, 3, Color.STRENGTH, "Foes of Asgard", "AT", ev => superPowerEv(ev, Color.COVERT, () => (eachPlayer(p => p.deck.withLast(c => discardEv(ev, c))), addAttackEvent(ev, turnState.pastEvents.count(e => e.type === "DISCARD" && e.parent === ev && !isColor(Color.GRAY)(ev.what)))))),
// ATTACK: 4+
// You get +Attack equal to the total number of <b>Artifact</b>s controlled by players and <b>Artifact</b>s the Lair.
// COST: 7
  ra: makeHeroCard("Greithoth, Breaker of Wills", "Body of Uru", 7, u, 4, Color.COVERT, "Foes of Asgard", "4AT", ev => addAttackEvent(ev, hqCards().count(c => c.isArtifact) + gameState.players.sum(p => p.artifact.size))),
},
{
...
// COST: 4
  c1: makeHeroCard("Kuurth, Breaker of Stone", "Unstoppable Sledge", 4, u, u, Color.RANGED, "Foes of Asgard", "D4T", ev => addAttackEvent(ev, 2), {
    ...thrownArtifact
  }),
// RECRUIT: 2+
// Reveal the top or bottom card of your deck. If it costs 4 or more, you get +2 Recruit.
// COST: 4
  c2: makeHeroCard("Kuurth, Breaker of Stone", "Reach for Power", 4, 2, u, Color.STRENGTH, "Foes of Asgard", "D4RT", ev => {
...
// COST: 5
  uc: makeHeroCard("Kuurth, Breaker of Stone", "Contest of Strength", 5, u, 3, Color.STRENGTH, "Foes of Asgard", "DAT", ev => {
    superPowerEv(ev, "Foes of Asgard", () => choosePlayerEv(ev, p => {
      let revealed: Card;
...
// COST: 7
  ra: makeHeroCard("Kuurth, Breaker of Stone", "Break Every Bone", 7, u, 0, Color.STRENGTH, "Foes of Asgard", "AT", ev => {
...
// COST: 3
  c1: makeHeroCard("Nerkkod, Breaker of Oceans", "Pull of the Tides", 3, 2, u, Color.STRENGTH, "Foes of Asgard", "DT", ev => {
...
// FLAVOR: "It's feeding time!"
  c2: makeHeroCard("Nerkkod, Breaker of Oceans", "Feed My Undersea Legions", 4, u, 2, Color.COVERT, "Foes of Asgard", "FD4T", ev => {
...
// COST: 5
  uc: makeHeroCard("Nerkkod, Breaker of Oceans", "Cudgel of the Deep", 5, u, u, Color.RANGED, "Foes of Asgard", "T", ev => {
...
// COST: 7
  ra: makeHeroCard("Nerkkod, Breaker of Oceans", "Break Their Loyalties", 7, u, 5, Color.INSTINCT, "Foes of Asgard", "T", ev => {
    superPowerEv(ev, "Foes of Asgard", () => eachOtherPlayer(p => {
...
// COST: 3
  c1: makeHeroCard("Nul, Breaker of Worlds", "Demolition Derby", 3, 2, u, Color.STRENGTH, "Foes of Asgard", "DT", ev => {
...
// COST: 4
  c2: makeHeroCard("Nul, Breaker of Worlds", "Otherworldly Maul", 4, u, u, Color.INSTINCT, "Foes of Asgard", "D4T", ev => {
    addAttackEvent(ev, 2 * superPowerCount(Color.STRENGTH));
  }, { ...thrownArtifact }),
// ATTACK: 4
...
// COST: 6
  uc: makeHeroCard("Nul, Breaker of Worlds", "Nul Smash!", 6, u, 4, Color.STRENGTH, "Foes of Asgard", "4T", ev => {
...
// COST: 8
  ra: makeHeroCard("Nul, Breaker of Worlds", "Break the World", 8, u, 6, Color.STRENGTH, "Foes of Asgard", "T", ev => {
...
// FLAVOR: The daughter of the Red Skull will fulfill his final dream.
  c1: makeHeroCard("Skadi", "Dark Prophecy", 3, 2, u, Color.TECH, "HYDRA", "FD", ev => superPowerEv(ev, Color.TECH, () => gameState.madame.withTop(c => gainEv(ev, c)))),
// ATTACK: 1
...
// FLAVOR: Skadi hails HYDRA. Immortal HYDRA. Whenever she cuts off a limb, two more take its place.
  c2: makeHeroCard("Skadi", "Ancient Oath of HYDRA", 5, u, 1, Color.TECH, "HYDRA", "FT", ev => {
...
// COST: 5
  uc: makeHeroCard("Skadi", "Hammer of the Serpent", 5, u, u, Color.STRENGTH, "HYDRA", "DT", ev => {
...
// COST: 7
  ra: makeHeroCard("Skadi", "War Banner of HYDRA", 7, u, u, Color.COVERT, "HYDRA", "T", ev => {
...
// FLAVOR: It's easy to look up to a leader like Skirn. About 50 feet up.
  c1: makeHeroCard("Skirn, Breaker of Men", "Towering Leader", 3, u, u, Color.INSTINCT, "Foes of Asgard", "F", ev => {
    repeat(2, () => cont(ev, () => gameState.newRecruit.withTop(c => gainEv(ev, c))));
    superPowerEv(ev, Color.INSTINCT, () => cont(ev, () => gameState.newRecruit.withTop(c => gainEv(ev, c))));
  }),
// ATTACK: 2
// Look at the bottom card of your deck. Discard it or put it back.
// {POWER Covert} Draw a card from the bottom of your deck.
// COST: 4
  c2: makeHeroCard("Skirn, Breaker of Men", "Underhanded Dealings", 4, u, 2, Color.COVERT, "Foes of Asgard", "D4T", ev => {
...
// COST: 2
  uc: makeHeroCard("Skirn, Breaker of Men", "Titanic Bludgeon", 2, u, u, Color.RANGED, "Foes of Asgard", "DT", ev => addAttackEvent(ev, turnState.pastEvents.count(e => e.type === "DRAW" && e.who === playerState)), { ...thrownArtifact}),
// ATTACK: 4
// Each player reveals a [Covert] Ally or discards a card. For each card discarded this way, you draw a card.
// COST: 7
// GUN: 1
  ra: makeHeroCard("Skirn, Breaker of Men", "Break Your Hopes", 7, u, 4, Color.STRENGTH, "Foes of Asgard", "G4T", ev => {
...
// {POWER Covert} You may KO a card from your hand or discard pile. If you do, you get +1 Attack.
  c1: makeHeroCard("Apocalyptic Kitty Pryde", "Phase Out", 4, u, 2, Color.COVERT, "X-Men", "D4AT", ev => superPowerEv(ev, Color.COVERT, () => KOHandOrDiscardEv(ev, undefined, () => addAttackEvent(ev, 1)))),
// You may put a Hero from the HQ on the bottom of the Hero Deck. The Hero that replaces it in the HQ costs 1 less during this turn.
  c2: makeHeroCard("Apocalyptic Kitty Pryde", "Infiltrate HQ", 3, 2, u, Color.TECH, "X-Men", "DT", ev => {
    let where: Deck;
...
// You get +1 Attack for each [Tech] Hero in the HQ.
  uc: makeHeroCard("Apocalyptic Kitty Pryde", "Disrupt Circuits", 5, u, 2, Color.COVERT | Color.TECH, "X-Men", "FDA", ev => {
...
// When any player defeats a Villain or Mastermind with a "Fight" effect, you may discard this card to cancel that fight effect. If you do, draw three cards.
  ra: makeHeroCard("Apocalyptic Kitty Pryde", "Untouchable", 7, 5, u, Color.COVERT, "X-Men", "T", [], { trigger:
...
// You get +1 Attack if you reveal four cards with no rules text.
  c1: makeHeroCard("Black Bolt", "Destructive Whisper", 3, u, 2, Color.RANGED, "Illuminati", "FDAT", ev => {
    let count = 0;
    selectObjectsEv(ev, "Reveal cards with no text", 4, revealable().limit(hasFlag('N')), () => count++);
    cont(ev, () => count === 4 && addAttackEvent(ev, 1));
  }),
  c2: makeHeroCard("Black Bolt", "Speak No Words", 4, 2, 1, Color.COVERT | Color.RANGED, "Illuminati", "D4N"),
// Choose a card you played this turn with no rules text. You get its Recruit and Attack again.
  uc: makeHeroCard("Black Bolt", "Silence is Golden", 6, 0, 4, Color.STRENGTH, "Illuminati", "4RAT", ev => {
...
// For each card with no rules text you played this turn, draw a card.
  ra: makeHeroCard("Black Bolt", "Hypersonic Scream", 8, u, 3, Color.RANGED, "Illuminati", "T", ev => {
...
// You get +1 Attack for each other multicolored card you played this turn.
  c2: makeHeroCard("Black Panther", "Multifaceted Genius", 4, u, 2, Color.STRENGTH | Color.TECH, "Illuminati", "FD4AT", ev => {
...
// Whenever you defeat a Villain on the Rooftops or Streets this turn, you may KO one of your cards or a card from your discard pile.
  uc: makeHeroCard("Black Panther", "Stalk the Urban Jungle", 6, u, 4, Color.STRENGTH | Color.COVERT, "Illuminati", "G4T", ev => {
...
// {TEAMPOWER Illuminati} Put them on top of your deck.
  ra: makeHeroCard("Black Panther", "King of Wakanda", 7, u, u, Color.INSTINCT | Color.TECH, "Illuminati", "T", ev => {
    superPowerCondEv(ev, "Illuminati", n => repeat(3, () => cont(ev, () => gameState.sidekick.withTop(c => n ? gainToDeckEv(ev, c) : gainEv(ev, c)))));
  }),
},
{
  name: "Captain Marvel",
...
// {POWER Ranged} For each other [Ranged] Hero you have played this turn, you get +1 Recruit.
  c1: makeHeroCard("Captain Marvel", "Absorb Energies", 3, 2, u, Color.RANGED, "Avengers", "FDRT", ev => superPowerLikelyEv(ev, Color.RANGED, n => addRecruitEvent(ev, n))),
// Draw a card.
...
// {POWER Strength} For each other [Strength] Hero you have played this turn, you get +1 Attack.
  uc: makeHeroCard("Captain Marvel", "Marvelous Strength", 5, u, 3, Color.STRENGTH, "Avengers", "GAT", ev => superPowerLikelyEv(ev, Color.STRENGTH, n => addAttackEvent(ev, n))),
// {POWER Ranged Ranged Strength Strength} You get +6 Attack.
  ra: makeHeroCard("Captain Marvel", "Cosmic Energies", 7, u, 5, Color.RANGED, "Avengers", "FA", ev => superPowerLikelyEv(ev, [Color.RANGED, Color.RANGED, Color.STRENGTH, Color.STRENGTH], () => addAttackEvent(ev, 6))),
},
{
  name: "Dr. Strange",
  team: "Illuminati",
// {POWER Ranged} Reveal the top card of your deck. Draw it or {TELEPORT} it.
  c1: makeHeroCard("Dr. Strange", "Cloak of Levitation", 4, u, 2, Color.RANGED, "Illuminati", "FD4T", ev => {
...
// {TEAMPOWER Illuminati} You may KO a card from your hand or discard pile. If you do, you get +1 Recruit.
  c2: makeHeroCard("Dr. Strange", "Trust Me, I'm a Doctor", 2, 1, u, Color.INSTINCT | Color.RANGED, "Illuminati", "DRT", ev => superPowerEv(ev, "Illuminati", () => KOHandOrDiscardEv(ev, undefined, () => addRecruitEvent(ev, 1)))),
// {POWER Instinct} Reveal the top card of the Villain Deck. If it's a Villain, you get +2 Attack and may fight that Villain this turn.
  uc: makeHeroCard("Dr. Strange", "Fight the Future", 5, u, 3, Color.INSTINCT, "Illuminati", "DAT", ev => superPowerEv(ev, Color.INSTINCT, () => revealVillainDeckEv(ev, 1, r => {
    r.limit(isVillain).each(c => {
      addAttackEvent(ev, 2);
      addTurnSet('isFightable', card => c === gameState.villaindeck.top && card === c, () => true);
    });
...
// Reveal the top three cards of your deck. Draw any number of them and {TELEPORT} the rest.
  ra: makeHeroCard("Dr. Strange", "Sorcerer Supreme", 7, u, u, Color.COVERT, "Illuminati", "T", ev => {
...
// Once per turn, if you made at least 6 Recruit this turn, draw a card.
  c1: makeHeroCard("Lady Thor", "Mysterious Origin", 3, 2, u, Color.RANGED, "Avengers", "DT", ev => {
...
// Once per turn, if you made at least 6 Recruit this turn, you get +2 Attack.
  c2: makeHeroCard("Lady Thor", "Chosen by Asgard", 4, 2, 0, Color.STRENGTH, "Avengers", "D4AT", ev => {
    addTurnAction(new Ev(ev, 'EFFECT', {
      cost: { cond: () => !countPerTurn('ladyThor', ev.source) && turnState.totalRecruit >= 6 },
...
// {POWER Ranged Strength} You get +2 Attack.
  uc: makeHeroCard("Lady Thor", "Heir to the Hammer", 6, u, 4, Color.STRENGTH | Color.RANGED, "Avengers", "FD4A", ev => superPowerLikelyEv(ev, [Color.RANGED, Color.STRENGTH], () => addAttackEvent(ev, 2))),
// One per turn, if you made at least 6 Recruit this turn, you get +6 Attack.
  ra: makeHeroCard("Lady Thor", "Living Thunderstorm", 8, 4, 0, Color.STRENGTH, "Avengers", "F4AT", ev => {
    addTurnAction(new Ev(ev, 'EFFECT', {
      cost: { cond: () => !countPerTurn('ladyThor', ev.source) && turnState.totalRecruit >= 6 },
...
// {POWER Covert} Gain another Sidekick.
  c1: makeHeroCard("Magik", "Rally the New Mutants", 2, u, u, Color.COVERT, "X-Men", "FD", [ ev => gainSidekickEv(ev), ev => superPowerEv(ev, Color.COVERT, () => gainSidekickEv(ev)) ]),
// {TELEPORT}
// {POWER Ranged} You get +2 Attack.
  c2: makeHeroCard("Magik", "Travel through Limbo", 3, u, 1, Color.RANGED, "X-Men", "FDA", ev => superPowerLikelyEv(ev, Color.RANGED, () => addAttackEvent(ev, 2)), { teleport: true }),
// {TELEPORT}
// For each Sidekick you played this turn, you get +1 Attack.
  uc: makeHeroCard("Magik", "Dimensional Portal", 5, u, 2, Color.COVERT | Color.RANGED, "X-Men", "DAT", ev => addAttackEvent(ev, turnState.cardsPlayed.count(isSidekick)), { teleport: true }),
// {TELEPORT}
// Choose a Villain or Mastermind in your Victory Pile. You get +Attack equal to its printed VP.
  ra: makeHeroCard("Magik", "Wield the Soulsword", 7, u, 2, Color.COVERT, "X-Men", "DAT", ev => {
...
// {POWER Tech} Whenever you defeat a Villain this turn, you gain a Sidekick.
  c2: makeHeroCard("Maximus", "Enslave the Will", 4, u, 2, Color.TECH, "Cabal", "FD4T", ev => {
...
// You may have a Henchman Villain from your Victory Pile enter the city. If you do, draw a card.
  uc: makeHeroCard("Maximus", "Pieces on a Chessboard", 5, u, 3, Color.COVERT | Color.TECH, "Cabal", "T", ev => {
...
// {TEAMPOWER Cabal} You get +1 Attack for each Henchman you defeated this turn.
  ra: makeHeroCard("Maximus", "Inhuman Mastery", 7, u, 4, Color.TECH, "Cabal", "4AT", [
...
// {POWER Strength} You get +2, usable only against Villains on the Bridge or the Mastermind.
  c2: makeHeroCard("Namor, the Sub-Mariner", "Ruler of the Seas", 4, u, 2, Color.STRENGTH, "Cabal", "FD4AT", ev => superPowerLikelyEv(ev, Color.STRENGTH, () => addAttackSpecialEv(ev, c => isLocation(c.location, 'BRIDGE') || isMastermind(c), 2))),
// You may KO a card from your hand or discard pile. If you do, draw a card.
  uc: makeHeroCard("Namor, the Sub-Mariner", "Feed the Sharks", 6, u, 2, Color.STRENGTH | Color.INSTINCT, "Cabal", "DT", ev => KOHandOrDiscardEv(ev, undefined, () => drawEv(ev, 1))),
// Defeat a Villain for free.
// {POWER Instinct Instinct Strength Strength} Instead, defeat the Mastermind once for free.
  ra: makeHeroCard("Namor, the Sub-Mariner", "Imperius Rex", 7, u, u, Color.STRENGTH, "Cabal", "T", ev => {
    superPowerCondEv(ev, [Color.INSTINCT, Color.INSTINCT, Color.STRENGTH, Color.STRENGTH], n => selectCardEv(ev, "Choose a card to defeat", fightableCards().limit(n ? isMastermind : isVillain), c => defeatEv(ev, c)));
  }),
},
{
  name: "Old Man Logan",
...
// {POWER Instinct} You may KO a card from your hand or discard pile. If you KO a wound this way, draw a card.
  c1: makeHeroCard("Old Man Logan", "Last Survivor", 3, u, 2, Color.INSTINCT, "X-Men", "DT", ev => superPowerEv(ev, Color.INSTINCT, () => KOHandOrDiscardEv(ev, undefined, c => isWound(c) && drawEv(ev)))),
// If you don't recruit any heroes this turn, you get +2 Attack.
  c2: makeHeroCard("Old Man Logan", "Loner", 5, u, 2, Color.INSTINCT | Color.COVERT, "X-Men", "FDAT", ev => {
...
// {POWER Instinct} {XDRAMPAGE Wolverine}. For each other player who gained a Wound this way, you get +1 Attack.
  uc: makeHeroCard("Old Man Logan", "Rage Out", 6, u, 3, Color.INSTINCT, "X-Men", "AT", ev => {
    superPowerEv(ev, Color.INSTINCT, () => xdRampageEv(ev, 'Wolverine'));
...
// Reveal your hand. You get +5 Attack if you haven't played any S.H.I.E.L.D. or HYDRA cards this turn and don't have any in your hand.
  ra: makeHeroCard("Old Man Logan", "No More Heroes", 7, u, 5, Color.INSTINCT, "X-Men", "AT", ev => {
...
// If the most recent Hero you have played this turn has a Recruit icon, you get +2 Recruit. If it has an Attack icon, you get +2 Attack.
  c2: makeHeroCard("Proxima Midnight", "Master Combatant", 4, 0, 0, Color.INSTINCT, "Cabal", "D4RAT", ev => turnState.cardsPlayed.withLast(c => {
      hasAttackIcon(c) && addAttackEvent(ev, 2);
      hasRecruitIcon(c) && addRecruitEvent(ev, 2);
  })),
// {POWER Instinct} You get +3 Recruit.
  uc: makeHeroCard("Proxima Midnight", "General of the Black Order", 5, 0, 3, Color.COVERT, "Cabal", "FR", ev => superPowerLikelyEv(ev, Color.INSTINCT, () => addRecruitEvent(ev, 3))),
// {POWER Covert} You get +4 Recruit and +4 Attack.
  ra: makeHeroCard("Proxima Midnight", "Supernova Spear", 8, 4, 4, Color.INSTINCT, "Cabal", "4RA", ev => superPowerEv(ev, Color.COVERT, () => (addAttackEvent(ev, 4), addRecruitEvent(ev, 4)))),
},
{
  name: "Superior Iron Man",
  team: "Illuminati",
// {POWER Tech} You get +2 Attack.
  c1: makeHeroCard("Superior Iron Man", "Armor Upgrades", 2, u, 1, Color.TECH, "Illuminati", "FDA", ev => superPowerLikelyEv(ev, Color.TECH, () => addAttackEvent(ev, 2))),
// Draw a card.
...
// {POWER Ranged} Look at the top two cards of your deck. If one of them has a higher cost than the other, draw it. Put the rest back in any order.
  uc: makeHeroCard("Superior Iron Man", "Superior to Others", 3, 2, u, Color.RANGED, "Illuminati", "DT", ev => superPowerEv(ev, Color.RANGED, () => lookAtDeckEv(ev, 2, c => {
...
// Draw a card for each other player who has fewer cards in their Victory Pile than you.
  ra: makeHeroCard("Superior Iron Man", "#Humblebrag", 8, u, 5, Color.TECH, "Illuminati", "T", ev => drawEv(ev, gameState.players.count(p => p.victory.size < playerState.victory.size))),
},
{
  name: "Thanos",
  team: "Cabal",
// {TEAMPOWER Cabal} KO a Bystander from the Bystander Stack. Then, you get +1 Recruit for every three Bystanders in the KO pile.
  c1: makeHeroCard("Thanos", "Revel in Destruction", 3, 2, u, Color.STRENGTH | Color.RANGED, "Cabal", "DRT", ev => {
...
// {TELEPORT}
// You may KO a Bystander from your Victory Pile. If you do, you get +2 Attack.
  c2: makeHeroCard("Thanos", "Transdimensional Overlord", 5, u, 2, Color.STRENGTH, "Cabal", "DAT", ev => {
...
// {POWER Ranged} Each other player reveals a [Ranged] Hero or chooses a Bystander from their Victory Pile. You "rescue" those bystanders.
  uc: makeHeroCard("Thanos", "Galactic Domination", 6, u, 4, Color.RANGED, "Cabal", "4T",
...
// KO six Bystanders from the Bystander Stack. Then, defeat any Villain or Mastermind whose Attack is less than the number of Bystanders in the KO pile.
  ra: makeHeroCard("Thanos", "Utter Annihilation", 8, u, u, Color.RANGED, "Cabal", "T", [
...
// Reveal the top card of your deck. If it costs 2 or less, draw it.
  c1: makeHeroCard("Ultimate Spider-Man", "Marvel Team-Up", 2, u, u, Color.STRENGTH | Color.INSTINCT, "Spider Friends", "DT", [
    ev => gainSidekickEv(ev),
    ev => drawIfEv(ev, c => c.cost <= 2),
  ]),
// Reveal the top card of your deck. If it costs 2 or less, draw it.
// {POWER Strength} You get +2 Attack.
  c2: makeHeroCard("Ultimate Spider-Man", "Leaping Spider", 2, u, 0, Color.STRENGTH, "Spider Friends", "DAT", [
    ev => drawIfEv(ev, c => c.cost <= 2),
    ev => superPowerLikelyEv(ev, Color.STRENGTH, () => addAttackEvent(ev, 2)),
  ]),
// You get +2 Attack usable only against the Mastermind or Villains on the Rooftops or Bridge.
// Reveal the top card of your deck. If it costs 2 or less, draw it.
  uc: makeHeroCard("Ultimate Spider-Man", "Web-Slinger", 2, u, 0, Color.TECH, "Spider Friends", "DAT", [
...
// You get +2 Attack for each other card you have played this turn that costs 1 or 2.
  ra: makeHeroCard("Ultimate Spider-Man", "Hero from Another Dimension", 2, u, 0, Color.COVERT, "Spider Friends", "DAT",
...
// GUN: 1
  c1: makeHeroCard("Agent Venom", "Multi-Gun", 2, 1, 1, Color.TECH, "Spider Friends", "GFDRA", ev => spectrumPower() && (addAttackEvent(ev, 1), addRecruitEvent(ev, 1))),
// {WALLCRAWL}
// {PATROL Bank}: If it's empty, you get +2 Recruit. If it's not, you get +2 Attack.
  c2: makeHeroCard("Agent Venom", "Government Payroll", 3, 0, 0, Color.STRENGTH | Color.INSTINCT, "Spider Friends", "DRAT", ev => patrolCity('BANK', () => addRecruitEvent(ev, 2), () => addAttackEvent(ev, 2)), { wallcrawl: true }),
// {WALLCRAWL}
...
// (If another card has both Recruit and Attack, you get both bonuses.)
  ra: makeHeroCard("Agent Venom", "Shapeshifting Symbiote", 7, 0, 0, Color.STRENGTH, "Spider Friends", "RAT", [
...
// {PATROL Sewers}: If it's empty, you get +1 Recruit.
  c1: makeHeroCard("Arkon the Magnificent", "All-Terrain Barbarian", 3, 2, u, Color.STRENGTH | Color.COVERT, u, "FDR", ev => patrolCity('SEWERS', () => addRecruitEvent(ev, 1)), { wallcrawl: true }),
...
// If they're both empty, you get +1 Attack.
  uc: makeHeroCard("Arkon the Magnificent", "Warlord of Open Spaces", 5, u, 3, Color.INSTINCT, u, "AT", ev => {
...
// {PATROL Rooftops}: If it's empty, you get +4 Recruit and +4 Attack. If it's not, defeat the Villain there for free.
  ra: makeHeroCard("Arkon the Magnificent", "Lord of Dragons", 7, 0, 0, Color.INSTINCT, u, "4RAT",
...
// Reveal the top card of your deck. If it's [Tech] or [Strength], draw it.
  c1: makeHeroCard("Beast", "Balanced Attack", 3, u, 2, Color.STRENGTH | Color.TECH, "Illuminati", "FDT", ev => drawIfEv(ev, Color.TECH | Color.STRENGTH)),
// {WALLCRAWL}
// {PATROL any city space}:
// If it's empty, then the hero in the HQ space under it costs 3 less this turn.
  c2: makeHeroCard("Beast", "Upside-down Thinking", 4, u, u, Color.STRENGTH | Color.TECH, "Illuminati", "4T", ev => {
...
// For each other [Tech] card you played this turn, you get +1 Attack.
  uc: makeHeroCard("Beast", "Doctor of Beatdown", 6, u, 2, Color.STRENGTH | Color.TECH, "Illuminati", "DAT", ev => addAttackEvent(ev, turnState.cardsPlayed.count(Color.STRENGTH) + turnState.cardsPlayed.count(Color.TECH))),
// {POWER Strength Strength Tech Tech} Draw three cards.
  ra: makeHeroCard("Beast", "Multi-Variable Smackulus", 8, u, 4, Color.STRENGTH | Color.TECH, "Illuminati", "F4", ev => superPowerEv(ev, [Color.STRENGTH, Color.STRENGTH, Color.TECH, Color.TECH], () => drawEv(ev, 3))),
},
{
  name: "Black Swan",
  team: "Cabal",
// {POWER Ranged} Reveal the top card of the Villain Deck. If it's a Scheme Twist, you get +2 Attack. Otherwise, put it back on the top or bottom.
  c1: makeHeroCard("Black Swan", "Apocalyptic Vision", 3, u, 2, Color.RANGED, "Cabal", "DAT", ev => superPowerEv(ev, Color.RANGED, () => revealVillainDeckEv(ev, 1, cards => {
...
// {POWER Instinct} You may KO a card from your hand or discard pile. If you do, draw a card.
  c2: makeHeroCard("Black Swan", "Witness the End", 5, 2, u, Color.INSTINCT, "Cabal", "FDT", ev => superPowerEv(ev, Color.INSTINCT, () => KOHandOrDiscardEv(ev, undefined, () => drawEv(ev, 1)))),
// Reveal the top three cards of the Villain Deck. Rescue any Bystanders you revealed, then put the rest back in any order.
  uc: makeHeroCard("Black Swan", "Dark Foretelling", 6, u, 4, Color.INSTINCT | Color.RANGED, "Cabal", "4T", ev => {
...
// {TEAMPOWER Cabal} Instead, you get + Attack for two of those cards.
  ra: makeHeroCard("Black Swan", "Telepathic Control", 7, u, 0, Color.COVERT, "Cabal", "AT", ev => {
    superPowerCondEv(ev, "Cabal", n => revealVillainDeckEv(ev, 5, cards => selectObjectsEv(ev, "Select cards to gain Attack", n ? 2 : 1, cards, c => addAttackEvent(ev, c.vp)), false));
  }),
},
{
...
// {SPECTRUM} you get +2 Recruit.
  c1: makeHeroCard("The Captain and the Devil", "Jurassic America", 2, 1, u, Color.STRENGTH | Color.TECH, "Avengers", "FDR", ev => spectrumPower() && addRecruitEvent(ev, 2)),
// {SPECTRUM} You get +2 Attack.
  c2: makeHeroCard("The Captain and the Devil", "Patriotic Chomp", 4, u, 2, Color.INSTINCT, "Avengers", "FD4A", ev => spectrumPower() && addAttackEvent(ev, 2)),
// {PATROL Streets}: If it's empty, you may KO a card from your hand or discard pile.
  uc: makeHeroCard("The Captain and the Devil", "Feeding Grounds", 6, u, 3, Color.COVERT, "Avengers", "FT", ev => patrolCity('STREETS', () => KOHandOrDiscardEv(ev, undefined))),
// Whenever you defeat a Villain this turn, each Villain and Mastermind adjacent to it gets -2 Attack this turn.
  ra: makeHeroCard("The Captain and the Devil", "Dino-Roar of Triumph", 8, u, 6, Color.RANGED, "Avengers", "DT", ev => {
...
// You get +1 Attack for each different team icon among your heroes.
  c1: makeHeroCard("Captain Britain", "Combined Strength", 4, u, 0, Color.STRENGTH, "Illuminati", "F4AT", ev => {
...
// You get +1 Recruit for each different team icon among your heroes.
  c2: makeHeroCard("Captain Britain", "Transatlantic Savior", 3, 0, u, Color.COVERT, "Illuminati", "RT", ev => {
...
// {PATROL Rooftops}: If it's empty, reveal the top two cards of your deck. If they have different team icons, draw them. Otherwise, put them back in any order.
  uc: makeHeroCard("Captain Britain", "Raise the Union Jack", 5, u, 2, Color.STRENGTH | Color.COVERT, "Illuminati", "DT", ev => {
...
// When you draw a new hand of cards at the end of this turn, draw three extra cards.
  ra: makeHeroCard("Captain Britain", "Lead the Captain Britain Corps", 7, u, u, Color.STRENGTH, "Illuminati", "T", ev => addEndDrawMod(3)),
},
{
  name: "Corvus Glaive",
  team: "Cabal",
// KO a Bystander from the Bystander Deck. If it's a Special Bystander, you may use its Rescue effect.
  c1: makeHeroCard("Corvus Glaive", "Culling Blade", 3, u, 2, Color.INSTINCT, "Cabal", "FDT", ev => gameState.bystanders.withTop(c => {
    KOEv(ev, c);
...
// {PATROL Escape Pile}: If there are Bystanders in it, you get +2 Attack. Otherwise, you get +2 Recruit.
  c2: makeHeroCard("Corvus Glaive", "Let None Escape You", 2, 0, 0, Color.STRENGTH | Color.INSTINCT, "Cabal", "FDRAT", ev => {
...
// GUN: 1
  uc: makeHeroCard("Corvus Glaive", "Rictus Grin", 6, u, 3, Color.STRENGTH, "Cabal", "GAT", ev => superPowerEv(ev, "Cabal", () => (gameState.bystanders.withTop(c => KOEv(ev, c)), addAttackEvent(ev, Math.floor(gameState.ko.count(isBystander)/4))))),
// {TEAMPOWER Cabal} You may KO a Bystander from the Escape Pile and from each player's Victory Pile. You get +1 Attack for each Bystander KO'd this way.
  ra: makeHeroCard("Corvus Glaive", "Atom-Splitting Glaive", 8, u, 6, Color.TECH, "Cabal", "AT", ev => {
    superPowerEv(ev, "Cabal", () => {
...
// {POWER Tech} Reveal the top card of your deck. If it costs 0, KO it and you get +1 Attack.
  c2: makeHeroCard("Dr. Punisher, Soldier Supreme", "You're a Slow Learner", 4, u, 2, Color.TECH, "Marvel Knights", "D4AT", ev => superPowerEv(ev, Color.TECH, () => revealPlayerDeckEv(ev, 1, cards => {
...
// {POWER Ranged Ranged} You get +Attack equal to that Villain's printed VP value.
  uc: makeHeroCard("Dr. Punisher, Soldier Supreme", "Ice Magic", 3, u, 2, Color.RANGED, "Marvel Knights", "DAT", ev => {
...
// GUN: 1
  ra: makeHeroCard("Dr. Punisher, Soldier Supreme", "Calm Before the Storm", 7, u, 5, Color.RANGED, "Marvel Knights", "GFAT", ev => {
...
// {SPECTRUM} You may KO a card from your hand or discard pile. If you do, you get +1 Recruit.
  c1: makeHeroCard("Elsa Bloodstone", "Bloodstone Pendant", 5, 2, u, Color.INSTINCT, "S.H.I.E.L.D.", "DRT", ev => spectrumPower() && KOHandOrDiscardEv(ev, undefined, () => addRecruitEvent(ev, 1))),
...
// You get +1 Attack for each other S.H.I.E.L.D. Hero you played this turn.
// GUN: 1
  uc: makeHeroCard("Elsa Bloodstone", "Defend the S.H.I.E.L.D. Wall", 6, u, 0, Color.RANGED, "S.H.I.E.L.D.", "GFAT", ev => addAttackEvent(ev, turnState.cardsPlayed.count("S.H.I.E.L.D.")), { wallcrawl: true }),
// {SPECTRUM} You get +3 Attack.
  ra: makeHeroCard("Elsa Bloodstone", "Prodigy of Ulysses Bloodstone", 8, u, 6, Color.STRENGTH, "S.H.I.E.L.D.", "FA", ev => spectrumPower() && addAttackEvent(ev, 3)),
},
{
  name: "Phoenix Force Cyclops",
  team: "X-Men",
// You may KO this card. If you do, you gain +2 Attack.
  c1: makeHeroCard("Phoenix Force Cyclops", "Burn Out", 4, u, 2, Color.RANGED, "X-Men", "FD4AT", ev => chooseMayEv(ev, "KO this card", () => (KOEv(ev, ev.source), addAttackEvent(ev, 2)))),
// KO this card. Gain a hero from the S.H.I.E.L.D. Office stack or HQ that costs 4 or less and put it into your hand.
  c2: makeHeroCard("Phoenix Force Cyclops", "Reincarnate", 3, u, u, Color.COVERT, "X-Men", "4T", ev => {
    KOEv(ev, ev.source);
...
// KO up to three cards from your hand. Draw that many cards.
  ra: makeHeroCard("Phoenix Force Cyclops", "Destruction Is Creation", 8, u, 4, Color.RANGED, "X-Men", "4T", ev => {
...
// When a card effect causes you to discard this card, if it is your turn, {TELEPORT} it instead. If it is not your turn, set it aside and add it to your hand at the end of this turn.
  c1: makeHeroCard("Ruby Summers", "Guerrilla Warfare", 3, u, 2, Color.RANGED, "X-Men", "FDT", [], { trigger: {
    event: 'DISCARD',
    match: (ev, source) => ev.what === source && ev.parent.getSource() instanceof Card,
    replace: ev => {
...
// To play this card, you must discard a card from your hand.
  c2: makeHeroCard("Ruby Summers", "Heir to Legends", 5, 2, 2, Color.STRENGTH | Color.RANGED, "X-Men", "FDT", [], { playCost: 1, playCostType: 'DISCARD' }),
// {TEAMPOWER X-Men} Whenever you defeat a villain or mastermind this turn, you get +2 Recruit.
  uc: makeHeroCard("Ruby Summers", "Form of Solid Ruby", 6, 0, 4, Color.STRENGTH, "X-Men", "FD4RT", ev => superPowerEv(ev, "X-Men", () => addTurnTrigger('DEFEAT', ev => isEnemy(ev.what), () => addRecruitEvent(ev, 2)))),
// To play this card, you must discard three cards from your hand.
  ra: makeHeroCard("Ruby Summers", "Extinction Blast", 8, u, 10, Color.RANGED, "X-Men", "T", [], { playCost: 3, playCostType: 'DISCARD' }),
},
{
  name: "Shang-Chi",
  team: "Marvel Knights",
...
// {PATROL Rooftops}: If it's empty, you get +1 Attack.
  c2: makeHeroCard("Shang-Chi", "Acrobatic Kung-Fu", 4, u, 2, Color.INSTINCT | Color.COVERT, "Marvel Knights", "D4A", ev => patrolCity('ROOFTOPS', () => addAttackEvent(ev, 1)), { wallcrawl: true }),
// {PATROL your discard pile}: If it's empty, you get +2 Attack.
  uc: makeHeroCard("Shang-Chi", "Seek the Empty Mind", 5, u, 3, Color.COVERT, "Marvel Knights", "DAT", ev => patrolDeck(playerState.discard, () => addAttackEvent(ev, 2))),
// {WALLCRAWL}
// Any time you are shuffling your deck with this card in it, you may set this card aside and put it on top of your deck at the end of the shuffle.
  ra: makeHeroCard("Shang-Chi", "Muscle Memory", 7, u, 5, Color.INSTINCT, "Marvel Knights", "T", [], { trigger: {
    event: 'RESHUFFLE',
...
// {SPECTRUM} Reveal the top card of your deck. If it costs 2 or less, draw it.
  c1: makeHeroCard("Silk", "Long-Range Spider-Sense", 2, u, 2, Color.RANGED, "Spider Friends", "FDT", ev => spectrumPower() && drawIfEv(ev, c => c.cost <= 2)),
// {WALLCRAWL}
// {SPECTRUM} Draw a card.
...
// {TEAMPOWER Spider Friends} Reveal the top card of your deck. If it costs 0, KO it. If it costs 1 or 2, draw it.
  uc: makeHeroCard("Silk", "Silk Stalking", 2, u, 1, Color.COVERT, "Spider Friends", "DT", ev => superPowerEv(ev, "Spider Friends", () => revealPlayerDeckEv(ev, 1, cards => {
...
// {SPECTRUM} Reveal the top four cards of your deck. Put any combination of those cards with a total cost of 2 or less into your hand. But the rest back in any order.
  ra: makeHeroCard("Silk", "Borrowed Cloaking Device", 2, u, 1, Color.TECH, "Spider Friends", "DT", ev => {
...
// {POWER Covert} Once this turn, you may fight the top card of the Bystander Stack as if it were a 3 Attack Demon Villain with "Fight: KO one of your heroes."
  c1: makeHeroCard("Soulsword Colossus", "Invade the Inferno", 3, 2, u, Color.COVERT, "X-Men", "DT", ev => {
    superPowerEv(ev, Color.COVERT, () => {
      let once = false;
...
// If a player would gain a Wound, you may discard this card instead. If you do, draw two cards.
  c2: makeHeroCard("Soulsword Colossus", "Steel Interception", 4, u, 2, Color.STRENGTH | Color.COVERT, "X-Men", "D4T", [], { trigger:
...
// {POWER Strength} {XDRAMPAGE Colossus}. You get +2 Attack if at least one other player didn't reveal a Colossus card.
  uc: makeHeroCard("Soulsword Colossus", "Possessed by the Soulsword", 6, u, 3, Color.STRENGTH, "X-Men", "DAT", ev => {
...
// {TEAMPOWER X-Men} You may gain an X-Men Hero from the HQ or the KO pile to your hand.
  ra: makeHeroCard("Soulsword Colossus", "Rescue My Family from Hell", 7, u, 5, Color.INSTINCT, "X-Men", "FT", ev => superPowerLikelyEv(ev, "X-Men", () => selectCardOptEv(ev, "Choose an X-Men to gain", [...hqHeroes(), ...gameState.ko.deck].limit("X-Men"), c => gainToHandEv(ev, c)))),
},
{
  name: "Spider-Gwen",
  team: "Spider Friends",
// {PATROL Bridge}: If it's empty, reveal the top card of your deck. If that card costs 2 or less, draw it.
  c1: makeHeroCard("Spider-Gwen", "Fateful Bridge", 2, u, 2, Color.INSTINCT | Color.TECH, "Spider Friends", "DT", ev => patrolCity('BRIDGE', () => drawIfEv(ev, c => c.cost <= 2))),
// {PATROL Rooftops}: If it's empty, rescue a Bystander, and then you get +1 Attack for every two Bystanders in your Victory Pile.
  c2: makeHeroCard("Spider-Gwen", "Save the Day", 2, u, 1, Color.TECH, "Spider Friends", "DAT", ev => patrolCity('ROOFTOPS', () => {
    rescueEv(ev);
...
// {PATROL your Victory Pile}: If it's empty, you get +1 Attack.
  uc: makeHeroCard("Spider-Gwen", "First Adventure", 2, u, 1, Color.STRENGTH, "Spider Friends", "DAT", [
...
// Reveal the top three cards of your deck, then put them back in any order. You get +1 Attack for each card you revealed that costs 2 or less.
  ra: makeHeroCard("Spider-Gwen", "Intertwining Webs", 2, u, 0, Color.COVERT, "Spider Friends", "DAT", ev => revealPlayerDeckEv(ev, 3, cards => addAttackEvent(ev, cards.count(c => c.cost <= 2))), { wallcrawl: true }),
},
{
  name: "Time-Traveling Jean Grey",
  team: "X-Men",
// {POWER Covert} Choose a Villain on the Rooftops or Bridge. It gets -2 Attack this turn.
  c1: makeHeroCard("Time-Traveling Jean Grey", "Throw Over the Railing", 3, u, 2, Color.COVERT, "X-Men", "DT", ev => {
...
// {PATROL Bridge}: If it's empty, then when you draw a new hand of cards at the end of this turn, draw an extra card.
  c2: makeHeroCard("Time-Traveling Jean Grey", "Bridge to a Better Future", 4, u, u, Color.INSTINCT, "X-Men", "4T", ev => patrolCity('BRIDGE', () => addEndDrawMod(1))),
// You may move a villain to an adjacent city space. If another Villain is already there, swap them.
  uc: makeHeroCard("Time-Traveling Jean Grey", "Telekinesis", 5, u, 3, Color.COVERT | Color.RANGED, "X-Men", "T", ev => {
    selectCardOptEv(ev, "Choose a Villain to move", cityVillains(), v => {
      selectCardEv(ev, "Choose a new city space", cityAdjacent(v.location), dest => swapCardsEv(ev, v.location, dest));
    });
  }),
// {TEAMPOWER X-Men} {PATROL any city space}: If it's empty, gain the hero in the HQ space under it. Put that hero on top of your deck.
  ra: makeHeroCard("Time-Traveling Jean Grey", "Change History", 7, u, 5, Color.COVERT, "X-Men", "T", ev => superPowerEv(ev, "X-Men", () => selectCardEv(ev, 'Choose an empty city space', gameState.city.limit(d => !d.size), c => {
...
// GUN: 1
  c2: makeHeroCard("Agent X-13", "Paramilitary Ops", 4, u, 2, Color.TECH, "S.H.I.E.L.D.", "GFD4AT", ev => addAttackEvent(ev, turnState.cardsPlayed.limit('S.H.I.E.L.D.').count(c => c.cost >= 1))),
// Choose one: Gain a S.H.I.E.L.D. Officer, or you get +2 Attack.
// {POWER Covert} {OUTOFTIME}.
  uc: makeHeroCard("Agent X-13", "Spy Network", 4, u, 0, Color.COVERT, "S.H.I.E.L.D.", "D4AT", [ ev => {
  ...
  }, ev => superPowerEv(ev, Color.COVERT, () => outOfTimeEv(ev)) ]),
// KO up to two S.H.I.E.L.D. Heroes from your hand and/or discard pile.
// {SAVIOR} For each card KO'd this way, you get +1 Attack.
  ra: makeHeroCard("Agent X-13", "Mobilize for War", 7, u, 4, Color.INSTINCT, "S.H.I.E.L.D.", "4AT", ev => {
...
// {POWER Instinct} Rescue a Bystander.
  c1: makeHeroCard("Captain America (Falcon)", "Aerial Catch", 3, 2, u, Color.INSTINCT, "Avengers", "FD", ev => superPowerEv(ev, Color.INSTINCT, () => rescueEv(ev))),
// {SAVIOR} You get +2 Attack.
  c2: makeHeroCard("Captain America (Falcon)", "Winged Salvation", 4, u, 2, Color.RANGED, "Avengers", "FD4A", ev => saviorPower() && addAttackEvent(ev, 2)),
// Once per turn, if a player would gain a Wound, you may reveal this card and rescue a Bystander instead.
  uc: makeHeroCard("Captain America (Falcon)", "Flying Shield Block", 6, u, 4, Color.TECH, "Avengers", "4T", [], { trigger:
...
// {SAVIOR} You get +2 Recruit for each Hero Class you have.
  ra: makeHeroCard("Captain America (Falcon)", "Star-Spangled Hero", 7, 0, 0, Color.COVERT, "Avengers", "DRAT", [
...
// {POWER Strength} {OUTOFTIME}
  c1: makeHeroCard("Captain America 1941", "Devoted Patriot", 3, u, u, Color.STRENGTH, "Avengers", "FD4", [ ev => drawEv(ev, 1), ev => superPowerEv(ev, Color.STRENGTH, () => outOfTimeEv(ev)) ]),
// You get +1 Attack for each Hero class you have.
// {OUTOFTIME}.
  c2: makeHeroCard("Captain America 1941", "Storm the Beachhead", 5, u, 0, Color.TECH, "Avengers", "4AT", [ ev => addAttackEvent(ev, numClasses()), ev => outOfTimeEv(ev) ]),
// {TEAMPOWER Avengers} Rescue a Bystander
// {SAVIOR} Draw a card.
  uc: makeHeroCard("Captain America 1941", "Liberate the Prisoners", 6, u, 3, Color.COVERT, "Avengers", "F4", [ ev => superPowerEv(ev, "Avengers", () => rescueEv(ev)), ev => saviorPower() && drawEv(ev) ]),
// {SAVIOR} {OUTOFTIME}
  ra: makeHeroCard("Captain America 1941", "Punch Evil in the Face", 8, u, 5, Color.INSTINCT, "Avengers", "F4", ev => saviorPower() && outOfTimeEv(ev)),
},
{
...
// {SAVIOR} You get +1 Attack for each Hero Class you have.
  c1: makeHeroCard("Steve Rogers, Director of S.H.I.E.L.D.", "International Strike Force", 3, 0, 0, Color.STRENGTH, "S.H.I.E.L.D.", "GRAT", [
...
// {TEAMPOWER S.H.I.E.L.D., S.H.I.E.L.D., S.H.I.E.L.D.} You may KO a S.H.I.E.L.D. Hero that you played this turn. If you do, rescue a Bystander.
  c2: makeHeroCard("Steve Rogers, Director of S.H.I.E.L.D.", "Reassign to Civilian Duty", 5, u, 2, Color.INSTINCT, "S.H.I.E.L.D.", "GFDT", ev => {
...
// {SAVIOR} {OUTOFTIME}
  uc: makeHeroCard("Steve Rogers, Director of S.H.I.E.L.D.", "Shadow of Wars Past", 4, u, 2, Color.COVERT, "S.H.I.E.L.D.", "GFD4", ev => saviorPower() && outOfTimeEv(ev)),
// Rescue a Bystander
// {SAVIOR} You get +3 Attack.
  ra: makeHeroCard("Steve Rogers, Director of S.H.I.E.L.D.", "Save the World", 8, u, 4, Color.TECH, "S.H.I.E.L.D.", "G4A", [ ev => rescueEv(ev), ev => saviorPower() && addAttackEvent(ev, 3) ]),
},
{
  name: "Winter Soldier",
  team: "(Unaffiliated)",
// {POWER Tech} {OUTOFTIME}.
  c1: makeHeroCard("Winter Soldier", "Bionic Arm", 3, u, 2, Color.STRENGTH, u, "FD", ev => superPowerEv(ev, Color.TECH, () => outOfTimeEv(ev))),
// Draw a card.
// {POWER Tech} {OUTOFTIME}
// GUN: 1
  c2: makeHeroCard("Winter Soldier", "Sniper Nest", 4, 1, u, Color.TECH, u, "GF4", [ ev => drawEv(ev, 1), ev => superPowerEv(ev, Color.TECH, () => outOfTimeEv(ev)) ]),
// If you played at least 7 other cards this turn you get +2 Attack.
// GUN: 1
  uc: makeHeroCard("Winter Soldier", "KGB Training", 5, u, 3, Color.COVERT, u, "GDAT", ev => turnState.cardsPlayed.size >= 7 && addAttackEvent(ev, 2)),
// A Hero in your hand gains {OUTOFTIME} this turn.
// {POWER Tech} Another Hero in your hand gains {OUTOFTIME} this turn.
  ra: makeHeroCard("Winter Soldier", "2>4", 7, u, 4, Color.TECH, u, "D4T", ev => {
    superPowerCondEv(ev, Color.TECH, n => selectObjectsEv(ev, "Select a Hero", n ? 2 : 1, playerState.hand.limit(isHero), c => addTurnSet('effects', v => v === c, (c, prev) => addHandler(prev, outOfTimeEv))));
  }),
},
]);
addHeroTemplates("Civil War", [
{
  ...
  team: "Avengers",
// You get +1 Recruit for each Hero Class you have.
  c1: makeHeroCard("Captain America, Secret Avenger", "Bold Leadership", 2, 0, u, Color.COVERT, "Avengers", "FDR", ev => addRecruitEvent(ev, numClasses())),
...
// You get +1 Attack for each Sidekick and other Avengers Hero you played this turn.
  uc: makeHeroCard("Captain America, Secret Avenger", "Secret Avengers Assemble!", 5, u, 2, Color.TECH, "Avengers", "DAT", ev => addAttackEvent(ev, turnState.cardsPlayed.count(c => isTeam("Avengers")(c) || isSidekick(c)))),
// Whenever you play a Sidekick or another Avengers Hero this turn set that card aside. At the end of your turn, put those cards on the bottom of your deck in random order before you draw your new hand.
  ra: makeHeroCard("Captain America, Secret Avenger", "Freedom Never Dies", 7, u, 5, Color.RANGED, "Avengers", "T", ev => {
...
// You get +3 Recruit usable only to recruit Heroes in the HQ space under the Sewers.
  c1: makeDividedHeroCard(
    ...
    makeHeroCard("Dagger", "Below", 3, 0, u, Color.RANGED, "Marvel Knights", "RT", ev => addRecruitSpecialEv(ev, c => isLocation(c.location.below, 'SEWERS'), 3)),
  ),
// DIVIDED: Flee
// {PHASING}
...
// {POWER Ranged} You get +1 Attack.
  c2: makeDividedHeroCard(
    makeHeroCard("Cloak", "Flee", 4, 2, u, Color.COVERT, "Avengers", "D4R", ev => superPowerLikelyEv(ev, Color.COVERT, () => addRecruitEvent(ev, 1)), { cardActions: [ phasingActionEv ] }),
    makeHeroCard("Dagger", "Fight", 4, u, 2, Color.RANGED, "Marvel Knights", "D4A", ev => superPowerLikelyEv(ev, Color.RANGED, () => addAttackEvent(ev, 1)), { cardActions: [ phasingActionEv ] }),
  ),
// DIVIDED: Darkness
...
// {POWER Ranged} Reveal the top card of your deck. If it costs 1 or more, draw it.
  uc: makeDividedHeroCard(
    makeHeroCard("Cloak", "Darkness", 6, u, 3, Color.COVERT, "Avengers", "T", ev => superPowerEv(ev, Color.COVERT, () => revealPlayerDeckEv(ev, 1, cards => cards.limit(c => c.cost === 0).each(c => KOEv(ev, c))))),
    makeHeroCard("Dagger", "Light", 6, 3, u, Color.RANGED, "Marvel Knights", "T", ev => superPowerEv(ev, Color.RANGED, () => drawIfEv(ev, c => c.cost >= 1))),
  ),
// Whenever you play a <b>Divided</b> card this turn: play both sides as if they were two different cards.
  ra: makeHeroCard("Cloak & Dagger", "Penumbra", 7, u, 4, Color.RANGED, "Avengers", "4T", ev => turnState.playDividedBoth = true),
},
{
  name: "Daredevil",
  team: "Avengers | Marvel Knights",
// Look at the top two cards of your deck. Draw one and put the other back.
  c1: makeHeroCard("Daredevil", "Dual Existence", 2, u, u, Color.INSTINCT, "Avengers", "FDT", ev => lookAtDeckEv(ev, 2, cards => selectCardEv(ev, "Choose a card to draw", cards, c => drawCardEv(ev, c)))),
// Choose a number, then reveal the top card of your deck. If that card is that cost, gain a Sidekick.
  c2: makeHeroCard("Daredevil", "Roundhouse Side Kick", 4, u, 2, Color.COVERT, "Avengers", "FD4T", ev => {
...
// You get +1 Attack for each different cost of Hero you have.
  uc: makeDividedHeroCard(
    makeHeroCard("Daredevil", "Hidden Identity", 6, 3, u, Color.INSTINCT, "Avengers", "T", ev => turnState.nextHeroRecruit = 'DECK'),
    makeHeroCard("Iron Fist", "Revealed Identity", 6, u, 0, Color.STRENGTH, "Marvel Knights", "AT", ev => addAttackEvent(ev, yourHeroes().uniqueCount(c => c.cost))),
  ),
// {TEAMPOWER Avengers} Discard the top two cards of your deck. If they have different costs, you get +2 Attack, then repeat this process.
  ra: makeHeroCard("Daredevil", "Master of Martial Arts", 8, u, 4, Color.COVERT, "Avengers", "D4AT", ev => {
...
// {POWER Tech} If that Hero had a Recruit icon, you get +1 Recruit.
  c1: makeHeroCard("Falcon", "Rapid Reinforcements", 3, 2, u, Color.TECH, "Avengers", "DRT", ev => {
    selectCardEv(ev, "Choose a Hero", hqHeroes(), c => {
      moveCardEv(ev, c, gameState.herodeck, true);
      superPowerEv(ev, Color.TECH, () => hasRecruitIcon(c) && addRecruitEvent(ev, 1));
    });
  }),
...
// Look at the top three cards of your deck. Draw one. Put the rest back in any order.
  c2: makeDividedHeroCard(
    makeHeroCard("Falcon", "Talk with Birds", 4, u, 2, Color.RANGED, "Avengers", "D4", ev => superPowerEv(ev, Color.RANGED, () => gainSidekickEv(ev))),
    makeHeroCard("Redwing", "Squawk Back", 4, u, u, Color.INSTINCT, "Avengers", "4T", ev => lookAtDeckEv(ev, 3, cards => selectCardEv(ev, "Choose a card to draw", cards, c => drawCardEv(ev, c)))),
  ),
// You get +1 Attack for each card in the HQ with an Attack icon.
  uc: makeHeroCard("Falcon", "Scout the Battlefield", 6, u, 0, Color.RANGED, "Avengers", "FAT", ev => addAttackEvent(ev, hqCards().count(hasAttackIcon))),
// {TEAMPOWER Avengers} You get +Attack equal to the printed Attack of a Hero in the HQ.
  ra: makeHeroCard("Falcon", "Fly in a Friend", 7, u, 4, Color.INSTINCT, "Avengers", "4AT", ev => superPowerEv(ev, "Avengers", () => selectCardEv(ev, "Choose a Hero", hqHeroes(), c => addAttackEvent(ev, c.printedAttack || 0)))),
},
{
  name: "Goliath",
  team: "Avengers",
...
// {SIZECHANGING STRENGTH}
  c1: makeDividedHeroCard(
    makeHeroCard("Goliath", "Brilliant Biochemist", 4, 2, u, Color.TECH, "Avengers", "D4", [], { sizeChanging: Color.TECH }),
    makeHeroCard("Goliath", "Massive Warrior", 4, u, 2, Color.STRENGTH, "Avengers", "D4", [], { sizeChanging: Color.STRENGTH }),
  ),
// {SIZECHANGING TECH}
// {POWER Tech} Draw a card
  c2: makeHeroCard("Goliath", "Growth Industry", 5, u, 2, Color.TECH, "Avengers", "FD", ev => superPowerEv(ev, Color.TECH, () => drawEv(ev, 1)), { sizeChanging: Color.TECH }),
// {SIZECHANGING STRENGTH}
// You get +1 Attack for each other card you played this turn that costs 4 or more.
  uc: makeHeroCard("Goliath", "Being Big is Best", 6, u, 3, Color.STRENGTH, "Avengers", "4AT", ev => addAttackEvent(ev, turnState.cardsPlayed.count(c => c.cost >= 4)), { sizeChanging: Color.STRENGTH }),
// {SIZECHANGING STRENGTH}
// You get +Attack equal to the cost of another card you played this turn.
  ra: makeHeroCard("Goliath", "Enormous Implications", 8, u, 0, Color.STRENGTH, "Avengers", "AT", ev => selectCardEv(ev, "Choose a Hero", turnState.cardsPlayed, c => addAttackEvent(ev, c.cost)), { sizeChanging: Color.STRENGTH }),
},
{
  name: "Hercules",
  team: "Avengers",
// {POWER Instinct} Whenever you defeat a Villain this turn, rescue a Bystander.
  c1: makeHeroCard("Hercules", "Crowd Favorite", 4, u, 2, Color.INSTINCT, "Avengers", "FD4T", ev => superPowerEv(ev, Color.INSTINCT, () => addTurnTrigger('DEFEAT',
...
// Draw a card.
  c2: makeDividedHeroCard(
    makeHeroCard("Hercules", "Manly Dullard", 3, u, 3, Color.STRENGTH, "Avengers", "T", [], { playCost: 1, playCostType: 'DISCARD'}),
...
// {POWER Strength} Reveal the top card of your deck. If it costs 0, KO it.
  uc: makeHeroCard("Hercules", "Prince of Power", 5, 3, u, Color.STRENGTH, "Avengers", "FT", ev => superPowerEv(ev, Color.STRENGTH, () => revealPlayerDeckEv(ev, 1, cards => cards.filter(c => c.cost === 0).each(c => KOEv(ev, c))))),
...
// {TEAMPOWER Avengers} You get +1 Recruit for each Bystander in your Victory Pile.
  ra: makeHeroCard("Hercules", "Son of Zeus", 7, 0, 0, Color.STRENGTH, "Avengers", "RAT", [ ev => rescueEv(ev), ev => {
    const n = playerState.victory.count(isBystander);
    addAttackEvent(ev, n);
    superPowerLikelyEv(ev, "Avengers", () => addRecruitEvent(ev, n))
  } ]),
},
{
  name: "Hulkling",
...
// You may KO a Wound from your hand or discard pile. If you do, you get +1 Attack.
  c1: makeHeroCard("Hulkling", "Cellular Regeneration", 5, u, 2, Color.STRENGTH, "Avengers", "DAT", ev => KOHandOrDiscardEv(ev, isWound, () => addAttackEvent(ev, 1)), { sizeChanging: Color.STRENGTH }),
// DIVIDED: Half-Kree
// {SIZECHANGING STRENGTH}
// Gain a Wound.
// DIVIDED: Half-Skrull
// {SIZECHANGING COVERT}
  c2: makeDividedHeroCard(
    makeHeroCard("Hulkling", "Half-Kree", 4, 3, u, Color.STRENGTH, "Avengers", "4", ev => gainWoundEv(ev), { sizeChanging: Color.STRENGTH }),
    makeHeroCard("Hulkling", "Half-Skrull", 4, u, 2, Color.COVERT, "Avengers", "D4", [], { sizeChanging: Color.COVERT }),
  ),
// {SIZECHANGING COVERT}
// Play this card as a copy of another Hero you played this turn. This card is both [Covert] and the class and color you copy.
// GUN: 1
  uc: makeHeroCard("Hulkling", "Impersonate", 6, u, u, Color.COVERT, "Avengers", "GT", [], { sizeChanging: Color.COVERT, copyPasteCard: true }),
// {SIZECHANGING COVERT}
// {POWER Covert} You get +4 Attack.
// GUN: 1
  ra: makeHeroCard("Hulkling", "Enormous Shapeshifter", 8, u, 4, Color.COVERT, "Avengers", "GF4A", ev => superPowerLikelyEv(ev, Color.COVERT, () => addAttackEvent(ev, 4)), { sizeChanging: Color.COVERT }),
},
{
  name: "Luke Cage",
  team: "Avengers",
// If any player would gain a Wound, you may discard this card instead. If you do, draw two cards.
  c1: makeHeroCard("Luke Cage", "Take a Bullet for the Team", 4, 1, 1, Color.STRENGTH, "Avengers", "4T", [], { trigger:
    youMayDiscardThisInsteadEv("GAIN", ev => isWound(ev.what), "draw two cards", ev => drawEv(ev, 2, owner(ev.source)))
  }),
// DIVIDED: Cautious
// DIVHERO: Luke Cage
...
// {POWER Instinct} Look at the top three cards of your deck. Discard them all or put them back in any order.
  uc: makeHeroCard("Luke Cage", "Sweet Christmas", 5, u, 3, Color.INSTINCT, "Avengers", "T", ev => superPowerEv(ev, Color.INSTINCT, () => lookAtDeckEv(ev, 3, cards => chooseMayEv(ev, "Discard revealed cards", () => cards.each(c => discardEv(ev, c)))))),
// {TEAMPOWER Avengers} <b>Fortify</b> the Wound Stack. While it's fortified, players can't gain Wounds. At the beginning of your next turn, put this card in your discard pile.
  ra: makeHeroCard("Luke Cage", "Unbreakable Skin", 8, u, 6, Color.STRENGTH, "Avengers", "T", ev => {
    superPowerEv(ev, "Avengers", () => {
...
// You get +1 Attack for each Hero Name among your non-S.H.I.E.L.D. Heroes.
  c1: makeHeroCard("Patriot", "Intuitive Tactician", 3, u, 0, Color.INSTINCT, "Avengers", "FAT", ev => addAttackEvent(ev, numHeroNames(yourHeroes().filter(c => !isTeam('S.H.I.E.L.D.')(c))))),
// You get +1 Recruit for each Hero Name among your non-S.H.I.E.L.D. Heroes.
  c2: makeHeroCard("Patriot", "New Generation of Heroes", 2, u, u, Color.STRENGTH, "Avengers", "DT", ev => addRecruitEvent(ev, numHeroNames(yourHeroes().filter(c => !isTeam('S.H.I.E.L.D.')(c))))),
...
// DIVTEAM: Avengers
  uc: makeDividedHeroCard(
    makeHeroCard("Patriot", "Incredible Effort", 5, u, 1, Color.COVERT, "Avengers", "A", ev => superPowerLikelyEv(ev, Color.COVERT, () => addAttackEvent(ev, 3))),
...
// Reveal the top three cards of your deck. If you revealed at least three different Hero Names this way, draw those three cards. Otherwise, put them back in any order.
  ra: makeHeroCard("Patriot", "Lead the Young Avengers", 8, u, 3, Color.TECH, "Avengers", "T", ev => revealPlayerDeckEv(ev, 3, cards => {
...
// {POWER Tech} Reveal the top card of your deck. If it costs 2 or less, draw it.
  c1: makeHeroCard("Peter Parker", "Conflicted Loyalties", 2, 1, 1, Color.TECH, "Avengers", "FDT", ev => superPowerEv(ev, Color.TECH, () => drawIfEv(ev, c => c.cost <= 2))),
// Gain a Sidekick.
// {POWER Instinct} Put that Sidekick on top of your deck.
  c2: makeHeroCard("Peter Parker", "Spider-Man Unmasked", 2, u, 1, Color.INSTINCT, "Avengers", "FDT", ev => superPowerCondEv(ev, Color.INSTINCT, n => gainSidekickEv(ev, n ? 'DECK' : undefined))),
...
// You may KO a Wound from your hand or discard pile.
  uc: makeDividedHeroCard(
    ...
    makeHeroCard("Aunt May", "Hot Bowl of Soup", 2, 1, u, Color.INSTINCT, "Spider Friends", "DT", ev => KOHandOrDiscardEv(ev, isWound)),
  ),
// {POWER Instinct} You get +1 Attack for each extra card you've drawn this turn.
  ra: makeHeroCard("Peter Parker", "Reluctant Celebrity", 2, u, 2, Color.INSTINCT, "Avengers", "DAT", ev => superPowerLikelyEv(ev, Color.INSTINCT, () => addAttackEvent(ev, cardsDrawn()))),
},
{
  name: "Speedball",
  team: "New Warriors",
// {POWER Covert} If there are any Bystanders in the city or KO pile, you get +2 Attack.
  c1: makeHeroCard("Speedball", "Bounce Around", 4, u, 2, Color.COVERT, "New Warriors", "FD4AT", ev => superPowerLikelyEv(ev, Color.COVERT, () => gameState.ko.has(isBystander) && addAttackEvent(ev, 2))),
// {POWER Ranged} Reveal the top card of the Villain Deck. If it's a Villain, rescue a Bystander. Otherwise, KO a Bystander from the Bystander Deck.
  c2: makeHeroCard("Speedball", "Reckless Rescue Attempt", 3, 2, u, Color.RANGED, "New Warriors", "DT", ev => superPowerEv(ev, Color.RANGED, () => revealVillainDeckEv(ev, 1, c => {
...
// You get +3 Attack usable only against Villains on the Bridge or against the Mastermind.
  uc: makeDividedHeroCard(
    ...
    makeHeroCard("Namorita", "Bubble Up", 5, u, 0, Color.COVERT, "New Warriors", "AT", ev => addAttackSpecialEv(ev, c => isLocation(c.location, 'BRIDGE') || isMastermind(c), 3)),
  ),
// If a Master Strike would occur, you may reveal this card to KO that Master Strike, cancel its effects, and draw a card.
  ra: makeHeroCard("Speedball", "Kinetic Force Field", 7, u, 5, Color.RANGED, "New Warriors", "T", [], { trigger:
...
// Draw a card.
// {POWER Tech} You get +1 Attack.
  c1: makeHeroCard("Stature", "Shrink to Nothing", 2, u, 0, Color.TECH, "Avengers", "FDA", [ ev => drawEv(ev, 1), ev => superPowerLikelyEv(ev, Color.TECH, () => addAttackEvent(ev, 1)) ], { sizeChanging: Color.TECH }),
// DIVIDED: Crush Ants
// DIVHERO: Stature
// DIVTEAM: Avengers
// {SIZECHANGING STRENGTH}
...
// {POWER Tech} Draw a card.
  c2: makeDividedHeroCard(
    makeHeroCard("Stature", "Crush Ants", 5, u, 2, Color.STRENGTH, "Avengers", "DT", ev => superPowerEv(ev, Color.STRENGTH, () => selectCardEv(ev, "Choose a Villain to defeat", villains().limit(c => c.defense <= 3), c => defeatEv(ev, c))), { sizeChanging: Color.STRENGTH }),
...
// {POWER Strength} You get +1 Attack for each Villain in your Victory Pile that has a printed Attack 3 or less.
  uc: makeHeroCard("Stature", "Growing Confidence", 6, u, 2, Color.STRENGTH, "Avengers", "FDAT", ev => superPowerLikelyEv(ev, Color.STRENGTH, () => addAttackEvent(ev, playerState.victory.limit(isVillain).count(c => c.defense <= 3))), { sizeChanging: Color.STRENGTH }),
// {SIZECHANGING STRENGTH}
// {POWER Strength} Defeat each Villain that has 4 Attack or less.
// GUN: 1
  ra: makeHeroCard("Stature", "Trample the Tiny", 8, u, 5, Color.STRENGTH, "Avengers", "G4T", ev => superPowerEv(ev, Color.STRENGTH, () => villains().limit(c => c.defense <= 3).each(c => defeatEv(ev, c))), { sizeChanging: Color.STRENGTH }),
},
{
...
// {POWER Instinct} Draw a card.
  c1: makeDividedHeroCard(
    makeHeroCard("Storm", "Gathering Rain Clouds", 2, 1, u, Color.RANGED, "X-Men", "D", ev => superPowerEv(ev, Color.RANGED, () => drawEv(ev, 1))),
    makeHeroCard("Black Panther", "Gathering Clues", 2, u, 1, Color.INSTINCT, "Avengers", "D", ev => superPowerEv(ev, Color.INSTINCT, () => drawEv(ev, 1))),
  ),
...
// You may move a Villain to an adjacent empty city space.
  c2: makeDividedHeroCard(
    makeHeroCard("Storm", "Lightning Strike", 3, u, 2, Color.RANGED, "X-Men", "DT", ev => addTurnMod('defense', c => isLocation(c.location, 'ROOFTOPS'), -1)),
    makeHeroCard("Black Panther", "Pouncing Strike", 3, 2, u, Color.INSTINCT, "Avengers", "DT", ev => {
      selectCardOptEv(ev, "Choose a Villain to move", cityVillains(), v => {
...
// GUN: 1
  uc: makeDividedHeroCard(
    makeHeroCard("Storm", "Tsunami of Water", 5, u, 3, Color.RANGED, "X-Men", "D", ev => superPowerLikelyEv(ev, Color.RANGED, () => addAttackSpecialEv(ev, isMastermind, 2))),
    makeHeroCard("Black Panther", "Tsunami of Justice", 5, u, 3, Color.COVERT, "Avengers", "GT", ev => superPowerEv(ev, Color.COVERT, () => KOHandOrDiscardEv(ev, undefined))),
  ),
// Storm & Black Panther
// Reveal any number of multi-class cards from your hand. Gain that many sidekicks.
  ra: makeHeroCard("Storm & Black Panther", "King & Queen of Wakanda", 7, u, 5, Color.TECH, "Avengers", "T", ev => repeat(playerState.hand.count(c => numClasses([c]) > 1), () => gainSidekickEv(ev))),
},
{
  name: "Tigra",
  team: "Avengers",
...
// {POWER Instinct} Draw a card.
  c1: makeDividedHeroCard(
    makeHeroCard("Tigra", "Friendship", 2, 1, u, Color.COVERT, "Avengers", "D", ev => superPowerEv(ev, Color.COVERT, () => gainSidekickEv(ev))),
    makeHeroCard("Tigra", "Ferocity", 2, u, 1, Color.INSTINCT, "Avengers", "D", ev => superPowerEv(ev, Color.INSTINCT, () => drawEv(ev, 1))),
  ),
// Look at the top card of your deck. Discard it or put it back.
// {POWER Instinct Instinct} You may KO the card you discarded this way.
// GUN: 1
  c2: makeHeroCard("Tigra", "Supernatural Senses", 3, u, 2, Color.INSTINCT, "Avengers", "GDT", ev => {
    let sel: Card[] = [];
...
// If an Ambush effect would occur, you may discard this card to cancel that effect and draw two cards.
  uc: makeHeroCard("Tigra", "Can't Surprise a Cat", 5, u, 2, Color.COVERT, "Avengers", "DT", [], { trigger:
...
// {TEAMPOWER Avengers} You get that Hero's printed Recruit and Attack.
  ra: makeHeroCard("Tigra", "Mystic Talisman", 7, 0, 0, Color.COVERT, "Avengers", "RAT", ev => {
    selectCardEv(ev, "Choose a hero to recruit", hqHeroes(), c => {
      recruitForFreeEv(ev, c);
      superPowerLikelyEv(ev, "Avengers", () => addAttackEvent(ev, c.printedAttack || 0));
      superPowerLikelyEv(ev, "Avengers", () => addRecruitEvent(ev, c.printedRecruit || 0));
    });
  }),
},
{
...
// {PHASING}
// {POWER Ranged} You get +2 Attack.
  c1: makeHeroCard("Vision", "Solar Energy", 3, u, 1, Color.RANGED, "Avengers", "FDA", ev => superPowerLikelyEv(ev, Color.RANGED, () => addAttackEvent(ev, 2)), { cardActions: [ phasingActionEv ] }),
// {PHASING}
// Choose a Hero Class. Reveal the top card of your deck. If it's the Hero class you named, then draw it.
  c2: makeHeroCard("Vision", "Through Solid Objects", 4, 2, u, Color.TECH, "Avengers", "D4T", ev => chooseClassEv(ev, col => drawIfEv(ev, col)), { cardActions: [ phasingActionEv ] }),
...
// GUN: 1
  ra: makeHeroCard("Vision", "Insubstantial Accomplishments", 7, u, 4, Color.TECH, "Avengers", "G4T", ev => {
...
// Choose a number, and then reveal the top card of your deck. If that card is that cost, then you get +1 Attack.
  c1: makeHeroCard("Wiccan", "Astral Projection", 4, u, 2, Color.RANGED, "Avengers", "D4AT", ev => chooseCostEv(ev, n => revealPlayerDeckEv(ev, 1, cards => cards.has(c => c.cost == n) && addAttackEvent(ev, 1))), { cardActions: [ phasingActionEv ] }),
// {PHASING}
// {POWER Covert} You get +2 Recruit.
  c2: makeHeroCard("Wiccan", "Sorcerous Illusions", 2, 1, u, Color.COVERT, "Avengers", "FDR", ev => superPowerLikelyEv(ev, Color.COVERT, () => addRecruitEvent(ev, 2)), { cardActions: [ phasingActionEv ] }),
...
// {POWER Covert} Draw another card.
  uc: makeDividedHeroCard(
    makeHeroCard("Wiccan", "Supersonic Spells", 4, u, 2, Color.RANGED, "Avengers", "D4", ev => superPowerEv(ev, Color.RANGED, () => drawEv(ev, 1))),
    makeHeroCard("Speed", "Supersonic Speed", 4, u, u, Color.COVERT, "Avengers", "4", [ ev => drawEv(ev, 1), ev => superPowerEv(ev, Color.COVERT, () => drawEv(ev, 1)) ]),
  ),
// Choose a number, and then reveal the top card of your deck. If that card is that cost, draw it and draw another card.
  ra: makeHeroCard("Wiccan", "Clairvoyance", 7, u, 3, Color.RANGED, "Avengers", "T", ev => chooseCostEv(ev, n => revealPlayerDeckEv(ev, 1, cards => cards.has(c => c.cost == n) && (cards.each(c => drawCardEv(ev, c)), drawEv(ev))))),
},
]);
...
// GUN: 1
  c2: makeHeroCard("Bob, Agent of HYDRA", "HYDRA Half-Wit", 2, u, 1.5, Color.TECH, "HYDRA", "GFDT", ev => drawIfEv(ev, 'S.H.I.E.L.D.')),
// {POWER Covert} Look at the top card of another player's deck. Ask them a yes or no question about it. If they guess right, then they draw that card. If not, then you draw a card.
  uc: makeHeroCard("Bob, Agent of HYDRA", "How Do I Get Out of Here??", 6, u, 4, Color.COVERT, "HYDRA", "4T", ev => superPowerEv(ev, Color.COVERT, () => chooseOtherPlayerEv(ev, p => {
...
// GUN: 1
  ra: makeHeroCard("Bob, Agent of HYDRA", "Epic Middle Manager", 8, u, 5, Color.COVERT, "HYDRA", "GT", [], { excessiveViolence: ev => {
...
// If you have a Wound in your hand or discard pile, KO it at you get +1 Attack. Otherwise, gain a Wound. These days, getting wounded mostly just pisses me off.
  c1: makeHeroCard("Deadpool", "It'll Grow Back", 4, u, 2.5, Color.INSTINCT, "Mercs for Money", "D4AT", ev => {
...
// {POWER Tech} Screw it, just take both!
  c2: makeHeroCard("Deadpool", "Nighttime Is the Right Time", 3, 0, 0, Color.TECH, "Mercs for Money", "FDRAT", ev => {
    superPowerLikelyEv(ev, Color.TECH, () => (addAttackEvent(ev, 2), addRecruitEvent(ev, 2)), () => chooseOneEv(ev, "Is it between 8 p.m. and midnight?",
...
// You get +1/2 Attack for each other card with flavor text you played this turn. Now maybe you'll stop telling me to shut up.
  uc: makeHeroCard("Deadpool", "Running Commentary", 5, u, 3.5, Color.COVERT, "Mercs for Money", "FDAT", ev => {
...
// {VIOLENCE} Take another turn after this one. But don't use this ability more than once per game - trilogies are stupid.
  ra: makeHeroCard("Deadpool", "Deadpool Rage!", 7, u, 5, Color.STRENGTH, "Mercs for Money", "FT", [], { excessiveViolence: ev => {
...
// {POWER Ranged} If any other players are taller than you, draw a card. If any other players are shorter than you, you get +1 Recruit. If both, get both!
  c1: makeHeroCard("Slapstick", "Napoleon Complex", 4, 2, u, Color.RANGED, "Mercs for Money", "FD4RT", ev => {
    if (gameState.players.size > 1) superPowerEv(ev, Color.RANGED, () => {
...
// {VIOLENCE} When you have a new hand of cards at the end of this turn, draw an extra card.
  uc: makeHeroCard("Slapstick", "Surprise Chainsaw", 6, u, 4.5, Color.STRENGTH, "Mercs for Money", "FD4T", [], { excessiveViolence: ev => addEndDrawMod(1) }),
// {VIOLENCE} Recruit a Hero from the HQ for free. Then, you may shuffle your discard pile into your deck.
  ra: makeHeroCard("Slapstick", "Electroplasmic Insanity", 8, u, 5, Color.RANGED, "Mercs for Money", "T", [], { excessiveViolence: ev => {
...
},
{
  name: "Solo",
  team: "Mercs for Money",
  c1: makeHeroCard("Solo", "Half-Cocked", 2, 1.5, 1.5, Color.TECH, "Mercs for Money", "GFDN"),
// {VIOLENCE} You get +1 Recruit.
  c2: makeHeroCard("Solo", "Merc's Gotta Get Paid", 3, 0, 2.5, Color.INSTINCT, "Mercs for Money", "GFDR", [], { excessiveViolence: ev => addRecruitEvent(ev, 1) }),
// {POWER Tech} Does the top card of your deck have a gun in the art? If so, draw that gun!
  uc: makeHeroCard("Solo", "Guns on My Guns", 5, u, 3.5, Color.TECH, "Mercs for Money", "GFDT", ev => superPowerEv(ev, Color.TECH, () => drawIfEv(ev, hasFlag("G")))),
...
// {TEAMPOWER Mercs for Money} Cut the Mastermind's Attack in half for one fight this turn.
  ra: makeHeroCard("Solo", "Cut in Half", 7, u, 2.5, Color.INSTINCT, "Mercs for Money", "GFD4T", ev => {
    selectCardEv(ev, "Choose a Villain", villains(), c => addTurnSet('defense', v => v === c, (c, n) => n / 2));

    superPowerEv(ev, "Mercs for Money", () => {
      let once = false;
...
// Draw a card.
// You may move a Villain to an adjacent city space. If another Villain is already there, swap them.
  c1: makeHeroCard("Stingray", "Deck Chairs on the Titanic", 4, u, 1.5, Color.TECH, "Mercs for Money", "D4T", [ ev => drawEv(ev, 1), ev => {
    selectCardOptEv(ev, "Choose a Villain to move", cityVillains(), v => {
      selectCardEv(ev, "Choose a new city space", cityAdjacent(v.location), dest => swapCardsEv(ev, v.location, dest));
    });
  } ]),
...
// {POWER Tech} You get +2 Attack, usable only against Villains in the Sewers or Bridge or the Mastermind.
  c2: makeHeroCard("Stingray", "Superpowered Swimsuit", 2, u, .5, Color.TECH, "Mercs for Money", "FDAT", [
    ev => drawEv(ev, 1),
...
// {VIOLENCE} You may KO one of your cards or a card from your discard pile.
  uc: makeHeroCard("Stingray", "Sting of the Stingray's Sting", 5, 3, u, Color.RANGED, "Mercs for Money", "FT", [], { excessiveViolence: ev => selectCardOptEv(ev, "Choose a card to KO", revealable().concat(playerState.discard.deck), c => KOEv(ev, c)) }),
// You may KO a card from your hand or discard pile.
// {TEAMPOWER Mercs for Money} You get 1/2 Attack for each Hero in the KO pile.
  ra: makeHeroCard("Stingray", "PhD in Oceanography", 8, u, 4, Color.TECH, "Mercs for Money", "D4AT", [
...
// GUN: 1
  c1: makeHeroCard("Angel Noir", "Impetuous Dive", 3, u, 2, Color.INSTINCT, "X-Men", "GFDA", ev => superPowerLikelyEv(ev, Color.INSTINCT, () => addAttackEvent(ev, 1))),
// Choose a Hero Class. <b>Investigate</b> for a card of that Hero Class.
  c2: makeHeroCard("Angel Noir", "Multitalented", 4, 1, 1, Color.STRENGTH, "X-Men", "F4T", ev => chooseClassEv(ev, col => investigateEv(ev, col))),
// You get the printed Recruit and Attack of a Hero in the HQ. Then put that Hero on the bottom of the Hero Deck.
  uc: makeHeroCard("Angel Noir", "Identical Twin Brother", 5, 0, 0, Color.INSTINCT, "X-Men", "RAT", ev => selectCardEv(ev, "Choose a Hero", hqHeroes(), c => {
    addAttackEvent(ev, c.printedAttack || 0);
    addRecruitEvent(ev, c.printedRecruit || 0);
    moveCardEv(ev, c, gameState.herodeck, true);
  })),
// <b>Investigate</b> the Hero Deck for any card and put that card in your hand.
  ra: makeHeroCard("Angel Noir", "Missing Person Case", 8, u, 3, Color.COVERT, "X-Men", "T", ev => investigateEv(ev, u, gameState.herodeck, c => moveCardEv(ev, c, playerState.hand))),
},
{
  name: "Daredevil Noir",
  team: "Marvel Knights",
// The next Hero you recruit this turn goes on top of your deck.
  c1: makeHeroCard("Daredevil Noir", "Balancing Act", 3, 1, 1, Color.COVERT, "Marvel Knights", "FT", ev => turnState.nextHeroRecruit = 'DECK'),
// Choose a number 1 or more. <b>Investigate</b> for a card of that cost.
// GUN: 1
  c2: makeHeroCard("Daredevil Noir", "Listen for Heartbeats", 4, u, 2, Color.INSTINCT, "Marvel Knights", "GFD4T", ev => chooseCostEv(ev, n => investigateEv(ev, c => c.cost === n), 1)),
...
// Discard a card from the top or bottom of your deck. If it costs 0, you get +1 Attack and repeat this process. If your deck runs out, stop.
  ra: makeHeroCard("Daredevil Noir", "Hitting Rock Bottom", 7, u, 3, Color.INSTINCT, "Marvel Knights", "AT", ev => {
...
// GUN: 1
  c1: makeHeroCard("Iron Man Noir", "Steam-Powered Arsenal", 3, u, 3, Color.RANGED, "Avengers", "GFT", [], { playCost: 1, playCostType: 'TOPDECK' }),
// <b>Investigate</b> for a [Tech] card.
// GUN: 1
  c2: makeHeroCard("Iron Man Noir", "Mechanized Plate-Mail", 4, 2, u, Color.TECH, "Avengers", "GFD4", ev => investigateEv(ev, Color.TECH)),
// {POWER Tech} You may use the "Fight" ability of a Villain worth 1 VP in your Victory Pile.
  uc: makeHeroCard("Iron Man Noir", "Learn from Enemies", 6, u, 3, Color.TECH, "Avengers", "T", ev => superPowerLikelyEv(ev, Color.TECH, () => selectCardOptEv(ev, "Choose a Villain", playerState.victory.limit(isVillain).limit(c => c.vp === 1), c => {
...
// GUN: 1
  ra: makeHeroCard("Iron Man Noir", "Adventurers Assemble!", 7, u, 4, Color.TECH, "Avengers", "G4T", [
...
// <b>Investigate</b> for a card that costs 4 or more.
  c1: makeHeroCard("Luke Cage Noir", "Private Investigations", 4, u, 2, Color.COVERT, "Marvel Knights", "FD4", ev => investigateEv(ev, c => c.cost >= 4)),
// You get +1 Recruit for each other card you played this turn that costs 4 or more.
  c2: makeHeroCard("Luke Cage Noir", "Follow Big Leads", 4, 2, u, Color.STRENGTH, "Marvel Knights", "FD4RT", ev => addRecruitEvent(ev, turnState.cardsPlayed.count(c => c.cost >= 4))),
// Once per turn, if a player would gain a Wound, you may reveal this card and <b>Investigate</b> for any card instead.
  uc: makeHeroCard("Luke Cage Noir", "Unbreakable Cage", 6, u, 4, Color.STRENGTH, "Marvel Knights", "4T", [], { trigger:
...
// You get +2 Attack for each other card you played this turn that costs 4 or more.
  ra: makeHeroCard("Luke Cage Noir", "Weight of the World", 8, u, 5, Color.STRENGTH, "Marvel Knights", "D4AT", ev => addAttackEvent(ev, 2 * turnState.cardsPlayed.count(c => c.cost >= 4))),
},
{
...
// {POWER Ranged} You get 2+ Attack.
  c2: makeHeroCard("Spider-Man Noir", "Webs of Darkness", 2, u, 1, Color.RANGED, "Spider Friends", "FDA", ev => superPowerLikelyEv(ev, Color.RANGED, () => addAttackEvent(ev, 2))),
// {POWER Instinct} <b>Investigate</b> the Bystander Stack for a Bystander and rescue it.
// TODO revealed bytstander deck
  uc: makeHeroCard("Spider-Man Noir", "Solve the Crime", 2, u, 2, Color.INSTINCT, "Spider Friends", "FDT", ev => superPowerEv(ev, Color.INSTINCT, () => investigateEv(ev, isBystander, gameState.bystanders, c => rescueEv(ev, c)))),
// {TEAMPOWER Spider Friends} <b>Investigate</b> each player's deck for a card that costs 2 or less, play a copy of that card, then put it into their discard pile.
  ra: makeHeroCard("Spider-Man Noir", "Spider-Totem's Chosen", 2, u, 1, Color.STRENGTH, "Spider Friends", "DT", ev => {
...
// {BERSERK}
  c2: makeDividedHeroCard(
    makeHeroCard("Aurora", "Blazing Flare", 4, 2, u, Color.RANGED, "X-Men", "D4R", addLightShowActionEv, { lightShow: ev => addRecruitEvent(ev, 2) }),
    makeHeroCard("Northstar", "Blazing Fists", 4, u, 2, Color.STRENGTH, "X-Men", "D4A", ev => berserkEv(ev, 1)),
  ),
// {SOARING FLIGHT}
// {LIGHTSHOW} You get +3 Attack
  uc: makeHeroCard("Aurora & Northstar", "Twin Blast", 5, u, 2, Color.RANGED, "X-Men", "DA", addLightShowActionEv, { soaring: true, lightShow: ev => addAttackEvent(ev, 3) }),
// {SOARING FLIGHT}
...
// {LIGHTSHOW} You get +2 Attack for each <b>Lightshow</b> card you played this turn.
  ra: makeHeroCard("Aurora & Northstar", "Mach 10", 7, 4, 0, Color.INSTINCT, "X-Men", "D4AT", [ev => {
...
// 0+ Piercing
  uc: makeHeroCard("Banshee", "Sonic Blastwave", 5, 3, u, Color.RANGED, "X-Men", "T", [], {
    printedPiercing: 0,
    trigger: {
      event: 'ADDRECRUIT',
      match: (ev, source) => ev.getSource() === source,
      replace: ev => superPowerEv(ev, Color.RANGED, () => chooseOneEv(ev, "Produce Piercing instead", ["Yes", () => addPiercingEv(ev, ev.parent.amount)], ["No", () => doReplacing(ev)]))
    }
  }),
// PIERCING
// {POWER Ranged Covert} You may use Attack as if it were Piercing this turn.
// 4 Piercing
  ra: makeHeroCard("Banshee", "Bone-Shattering Howl", 8, u, u, Color.RANGED, "X-Men", "4T", ev => superPowerEv(ev, [Color.RANGED, Color.COVERT], () => (turnState.piercingWithAttack = true)), { printedPiercing: 4 }),
},
{
  name: "Beast",
  team: "X-Men",
...
// {XGENE [Strength]} {BERSERK}
  c2: makeHeroCard("Beast", "Furry Fury", 4, u, 2, Color.STRENGTH, "X-Men", "D4A", [ ev => berserkEv(ev, 1), ev => xGenePower(Color.STRENGTH) && berserkEv(ev, 1) ]),
// Look at the top card of your deck. Discard it or put it back.
// {BERSERK}
  uc: makeHeroCard("Beast", "Calculated Rage", 5, u, 3, Color.TECH, "X-Men", "AT", [ ev => {
...
// {XGENE X-Men} You may return a 0-cost, 3-cost, and 4-cost card from your discard pile to your hand.
  ra: makeHeroCard("Beast", "Recursive Pummeling", 8, u, 3, Color.TECH, "X-Men", "4AT", [ ev => berserkEv(ev, 1), ev => { if (xGenePower("X-Men")) {
...
// {SOARING FLIGHT}
// {POWER Instinct} You get +2 Attack
  c1: makeHeroCard("Cannonball", "Kinetic Blast Field", 3, u, 1, Color.INSTINCT, "X-Men", "DA", ev => superPowerLikelyEv(ev, Color.INSTINCT, () => addAttackEvent(ev, 2)), { soaring: true }),
// {SOARING FLIGHT}
// {POWER Strength} The next Hero you recruit this turn has {SOARING FLIGHT}.
  c2: makeHeroCard("Cannonball", "Carry to the Air", 4, 2, u, Color.STRENGTH, "X-Men", "D4T", ev => superPowerEv(ev, Color.STRENGTH, () => (turnState.nextHeroRecruit = 'SOARING')), { soaring: true }),
// {SOARING FLIGHT}
// {POWER Strength} Return a S.H.I.E.L.D. Hero from your discard pile to your hand.
  uc: makeHeroCard("Cannonball", "Natural Leader", 6, u, 3, Color.STRENGTH, "X-Men", "T", ev => superPowerEv(ev, Color.STRENGTH, () => selectCardEv(ev, "Choose a card to put in your hand", playerState.discard.limit(isHero).limit('S.H.I.E.L.D.'), c => moveCardEv(ev, c, playerState.hand))), { soaring: true }),
// {SOARING FLIGHT}
// If you played at least 6 other cards this turn, you get +2 Attack.
// Attack: 4+
  ra: makeHeroCard("Cannonball", "Human Cannon", 8, u, 4, Color.STRENGTH, "X-Men", "D4AT", ev => turnState.cardsPlayed.size >= 6 && addAttackEvent(ev, 2), { soaring: true }),
},
{
...
// {BERSERK}, {BERSERK}
  c1: makeDividedHeroCard(
    ...
    makeHeroCard("Wolverine", "Unpredictable", 3, u, 1, Color.INSTINCT, "X-Men", "A", ev => berserkEv(ev, 2)),
  ),
// {SOARING FLIGHT}
// {XGENE [Instinct]} {BERSERK}
  c2: makeHeroCard("Colossus & Wolverine", "Fastball Special", 4, u, 2, Color.STRENGTH, "X-Men", "D4A", ev => xGenePower(Color.INSTINCT) && berserkEv(ev, 1), { soaring: true }),
// {BERSERK}
// If you have a Wound in your hand or discard pile, KO it. Otherwise, gain a Wound.
  uc: makeHeroCard("Colossus & Wolverine", "Insane Disregard for Danger", 6, u, 4, Color.INSTINCT, "X-Men", "4AT", [ ev => berserkEv(ev, 1), ev => selectCardOrEv(ev, "Choose a Wound", handOrDiscard().limit(isWound), c => KOEv(ev, c), () => gainWoundEv(ev)) ]),
// {BERSERK}, {BERSERK}, {BERSERK}
// Then, draw a card for each X-Men card you <b>Berserked</b>.
  ra: makeHeroCard("Colossus & Wolverine", "Uncanny X-Men", 7, u, 3, Color.STRENGTH, "X-Men", "AT", ev => {
    berserkEv(ev, 3);
...
// 0+ Piercing
  c1: makeHeroCard("Dazzler", "Convert Sound to Light", 3, 1, u, Color.INSTINCT, "X-Men", "T", addLightShowActionEv, { lightShow: ev => addPiercingEv(ev, lightShowCount()), printedPiercing: 0 }),
// {LIGHTSHOW} You get +2 Attack.
  c2: makeHeroCard("Dazzler", "Dazzling Glamour", 4, u, 2, Color.RANGED, "X-Men", "D4A", addLightShowActionEv, { lightShow: ev => addAttackEvent(ev, 2) }),
// {LIGHTSHOW} When you draw a new hand of cards at the end of this turn, draw two extra cards.
  uc: makeHeroCard("Dazzler", "City-Wide Mega Concert", 5, u, 3, Color.TECH, "X-Men", "FT", addLightShowActionEv, { lightShow: ev => addEndDrawMod(2) }),
// {LIGHTSHOW} Put a Hero from the HQ on top of your deck.
  ra: makeHeroCard("Dazzler", "Inspire the World", 7, u, 5, Color.RANGED, "X-Men", "T", addLightShowActionEv, { lightShow: ev => selectCardEv(ev, "Choose a Hero", hqHeroes(), c => moveCardEv(ev, c, playerState.deck)) }),
},
{
  name: "Havok",
  team: "X-Men",
...
// To play this card, you must discard a card from your hand.
// {BERSERK}, {BERSERK}
  c2: makeHeroCard("Havok", "Unleash Havok", 4, u, 2, Color.RANGED, "X-Men", "D4AT", ev => berserkEv(ev, 2), { playCost: 1, playCostType: 'DISCARD' }),
// {XGENE [Ranged]} You get +1 Attack for each [Ranged] card in your discard pile.
  uc: makeHeroCard("Havok", "Concussive Plasma", 5, u, 2, Color.RANGED, "X-Men", "DAT", ev => addAttackEvent(ev, xGenePower(Color.RANGED))),
// {BERSERK}
// {XGENE [Ranged]} You get the total printed Attack of all the [Ranged] cards in your discard pile.
  ra: makeHeroCard("Havok", "Radiation Focus Array", 7, u, 3, Color.TECH, "X-Men", "AT", [ ev => berserkEv(ev, 1), ev => xGenePower(Color.RANGED) && addAttackEvent(ev, playerState.discard.limit(Color.RANGED).sum(c => c.printedAttack || 0)) ]),
},
{
  name: "Jubilee",
  team: "X-Men",
...
// {LIGHTSHOW} You get +1 Recruit for each <b>Lightshow</b> card you played this turn.
  c1: makeHeroCard("Jubilee", "Light a Spark", 2, 0, u, Color.COVERT, "X-Men", "DRT", [ev => drawEv(ev, 1), addLightShowActionEv], { lightShow: ev => addRecruitEvent(ev, lightShowCount()) }),
// Draw a card.
// {LIGHTSHOW} You get +1 Attack for each <b>Lightshow</b> card you played this turn.
  c2: makeHeroCard("Jubilee", "Blasting Fireworks", 4, u, 1, Color.RANGED, "X-Men", "4AT", [ev => drawEv(ev, 1), addLightShowActionEv], { lightShow: ev => addAttackEvent(ev, lightShowCount()) }),
// {LIGHTSHOW} Look at the top card of your deck. If it costs 0, KO it.
  uc: makeHeroCard("Jubilee", "Unexpected Explosion", 5, u, 3, Color.INSTINCT, "X-Men", "T", addLightShowActionEv, { lightShow: ev => lookAtDeckEv(ev, 1, cards => cards.limit(c => c.cost === 0).each(c => KOEv(ev, c))) }),
// {LIGHTSHOW} You get +1 Recruit and +1 Attack for each <b>Lightshow</b> card you played this turn.
  ra: makeHeroCard("Jubilee", "Prismatic Cascade", 7, 0, 5, Color.COVERT, "X-Men", "RAT", addLightShowActionEv, { lightShow: ev => { const n = lightShowCount(); addRecruitEvent(ev, n); addAttackEvent(ev, n); } }),
},
{
  name: "Kitty Pryde",
  team: "X-Men",
// Put a card from the HQ on the bottom of the Hero deck. If that card had a Recruit icon, get +2 Recruit. If that card had an Attack icon, you get +2 Attack. (If both, get both.)
  c1: makeHeroCard("Kitty Pryde", "Intangible Qualities", 3, 0, 0, Color.INSTINCT, "X-Men", "DRAT", ev => {
    selectCardEv(ev, "Choose a Hero", hqHeroes(), c => {
      hasAttackIcon(c) && addAttackEvent(ev, 2);
      hasRecruitIcon(c) && addRecruitEvent(ev, 2);
      moveCardEv(ev, c, gameState.herodeck, true);
...
// {XGENE X-Men} Draw a card.
  c2: makeHeroCard("Kitty Pryde", "Going through a Phase", 4, 1, 1, Color.COVERT, "X-Men", "4", ev => xGenePower("X-Men") && drawEv(ev, 1)),
// You get +1 Attack for each different cost among the Heroes in the HQ.
  uc: makeHeroCard("Kitty Pryde", "Ghost in the Machine", 6, u, 0, Color.TECH, "X-Men", "AT", ev => addAttackEvent(ev, hqHeroes().uniqueCount(c => c.cost))),
// {SOARING FLIGHT}
// Put a card from the HQ on the bottom of the Hero Deck. You get +Attack equal to its cost.
  ra: makeHeroCard("Kitty Pryde", "Lockheed, Kitty's Dragon", 8, u, 0, Color.RANGED, "X-Men", "AT", ev => selectCardEv(ev, "Choose a Hero", hqHeroes(), c => {
...
// {LIGHTSHOW} You get +2 Recruit.
  c1: makeDividedHeroCard(
    makeHeroCard("Legion", "Bend Steel", 2, u, 1, Color.STRENGTH, "X-Men", "DA", ev => berserkEv(ev, 1)),
    makeHeroCard("Legion", "Bend Light", 2, 1, u, Color.COVERT, "X-Men", "DR", addLightShowActionEv, { lightShow: ev => addRecruitEvent(ev, 2) }),
  ),
...
// You get +1 Attack for each different Hero Class in your discard pile.
  uc: makeDividedHeroCard(
    ...
    makeHeroCard("Legion", "Channel Fire", 5, u, 0, Color.TECH, "X-Men", "AT", ev => addAttackEvent(ev, numClasses(playerState.discard.limit(isHero)))),
  ),
// {SOARING FLIGHT}
// Reveal the top three cards of the Hero Deck. You get their total printed Attack. Put them on the bottom of the Hero Deck.
  ra: makeHeroCard("Legion", "Maelstrom of Clashing Powers", 8, u, 3, Color.COVERT, "X-Men", "AT", ev => revealHeroDeckEv(ev, 3, cards => addAttackEvent(ev, cards.sum(c => c.printedAttack || 0)), false, true), { soaring: true }),
},
{
  name: "Longshot",
  team: "X-Men",
// To play this card, you must put a card from your hand on top of your deck.
  c1: makeHeroCard("Longshot", "Fortune Favors the Bold", 3, u, 3, Color.INSTINCT, "X-Men", "T", [], { playCost: 1, playCostType: 'TOPDECK' }),
// {BERSERK}
// {POWER Tech} {BERSERK}
  c2: makeHeroCard("Longshot", "Flurry of Blades", 4, u, 2, Color.TECH, "X-Men", "FD4A", [ ev => berserkEv(ev, 1), ev => superPowerEv(ev, Color.TECH, () => berserkEv(ev, 1)) ]),
// Look at the top card of your deck. Discard it or put it back.
// {POWER Covert} You may KO the card you discarded this way.
  uc: makeHeroCard("Longshot", "Make My Own Luck", 6, u, 3, Color.COVERT, "X-Men", "T", ev => {
    lookAtDeckEv(ev, 1, cards => {
      selectCardOptEv(ev, "Choose a card to discard", cards, c => {
        discardEv(ev, c);
        superPowerLikelyEv(ev, Color.COVERT, () => chooseMayEv(ev, "KO discarded", () => KOEv(ev, c)));
      })
    });
  }),
...
// {TEAMPOWER X-Men} You get +Attack equal to the printed Victory Points of the card you revealed.
  ra: makeHeroCard("Longshot", "Escape from Mojo World", 7, u, 5, Color.TECH, "X-Men", "AT", ev => {
    revealVillainDeckEv(ev, 1, cards => cards.each(c => {
      ...
      superPowerLikelyEv(ev, "X-Men", () => addAttackEvent(ev, c.vp));
    }), false, false);
  }),
},
{
...
// KO this card.
// You may KO a card from your hand or discard pile.
  c1: makeHeroCard("Phoenix", "Life & Death Incarnate", 3, 3, u, Color.STRENGTH, "X-Men", "T", [ ev => KOEv(ev, ev.source), ev => KOHandOrDiscardEv(ev, undefined) ]),
// {SOARING FLIGHT}
// PIERCING
// KO this card.
// 4 Piercing
  c2: makeHeroCard("Phoenix", "Obliterating Fire", 4, u, u, Color.RANGED, "X-Men", "4", ev => KOEv(ev, ev.source), { soaring: true, printedPiercing: 4 }),
// Draw two cards.
// You may put a Hero that was KO'd this turn into your discard pile.
  uc: makeHeroCard("Phoenix", "Reincarnating Phoenix", 6, u, u, Color.COVERT, "X-Men", "T", [ ev => drawEv(ev, 2), ev => selectCardOptEv(ev, "Choose a Hero", gameState.ko.limit(isHero).limit(c => pastEvWhat('KO').has(is(c))), c => moveCardEv(ev, c, playerState.discard)) ]),
...
// KO all the cards you <b>Berserked</b>. If this card makes at least 13 Attack, then the Phoenix Force becomes corrupted by power and devours the Earth. You win, Evil wins, and all other players lose.
  ra: makeHeroCard("Phoenix", "Driven Mad by Power", 9, u, 6, Color.STRENGTH, "X-Men", "AT", ev => {
    let n = 0;
...
// {POWER Covert} When you draw a new hand of cards at the end of this turn, draw an extra card.
  c1: makeHeroCard("Polaris", "Ride the Magnetic Waves", 3, 2, u, Color.COVERT, "X-Men", "DT", ev => superPowerEv(ev, Color.COVERT, () => addEndDrawMod(1)), { soaring: true }),
// PIERCING
// {POWER Ranged} Draw a card.
// 2 Piercing
  c2: makeHeroCard("Polaris", "Electromagnetic Pulse", 4, u, u, Color.RANGED, "X-Men", "D4", ev => superPowerEv(ev, Color.RANGED, () => drawEv(ev, 1)), { printedPiercing: 2 }),
// {SOARING FLIGHT}
// {POWER Covert} Look at the top two cards of your deck. You may KO one of them. Put the rest back in any order.
  uc: makeHeroCard("Polaris", "Subtle Attunement", 6, u, 2, Color.COVERT, "X-Men", "DT", ev => superPowerEv(ev, Color.COVERT, () => lookAtDeckEv(ev, 2, cards => selectCardOptEv(ev, "Choose a card to KO", cards, c => KOEv(ev, c)))), { soaring: true }),
// {SOARING FLIGHT}
// {XGENE X-Men} You can use Recruit as Attack this turn, and vice versa.
  ra: makeHeroCard("Polaris", "Reverse Polarity", 8, 4, u, Color.COVERT, "X-Men", "4T", ev => xGenePower("X-Men") && (turnState.attackWithRecruit = true, turnState.recruitWithAttack = true), { soaring: true }),
},
{
  name: "Psylocke",
  team: "X-Men",
...
// 0+ Piercing
  c1: makeHeroCard("Psylocke", "Psychic Knife", 2, u, u, Color.INSTINCT, "X-Men", "D", [ ev => drawEv(ev, 1), ev => superPowerEv(ev, Color.INSTINCT, () => addPiercingEv(ev, 1)) ], { printedPiercing: 0 }),
// Reveal the top card of the Hero Deck. You may recruit it this turn. If you do, draw a card.
  c2: makeHeroCard("Psylocke", "Precognition", 3, 2, u, Color.COVERT, "X-Men", "DT", ev => revealHeroDeckEv(ev, 1, cards => cards.each(c => {
...
// 3 Piercing
  ra: makeHeroCard("Psylocke", "Telepathic Ninjutsu", 7, u, u, Color.INSTINCT, "X-Men", "T", ev => revealHeroDeckEv(ev, 1, cards => cards.each(c => {
...
// {BERSERK}
// You may KO a Wound from your hand or discard pile.
  c2: makeHeroCard("X-23", "Healing Factor Genome", 4, u, 2, Color.INSTINCT, "X-Men", "D4AT", [ ev => berserkEv(ev, 1), ev => KOHandOrDiscardEv(ev, isWound) ]),
// {BERSERK}
// {XGENE [Instinct]} You may KO a card from your hand or discard pile.
  uc: makeHeroCard("X-23", "Bioengineered Assassin", 6, u, 2, Color.COVERT, "X-Men", "DAT", [ ev => berserkEv(ev, 1), ev => xGenePower(Color.INSTINCT) && KOHandOrDiscardEv(ev, undefined) ]),
// {BERSERK}, {BERSERK}
// {XGENE [Instinct]} Count the [Instinct] cards in your discard pile. {BERSERK} that many times.
  ra: makeHeroCard("X-23", "Heir to Wolverine", 7, u, 3, Color.INSTINCT, "X-Men", "DAT", [ ev => berserkEv(ev, 2), ev => berserkEv(ev, xGenePower(Color.INSTINCT)) ]),
},
]);
...
// {POWER Instinct} {DANGERSENSE 2}. If this revealed any Master Strikes, KO those Strikes, then you may KO a card from your hand or discard pile.
  c2: makeHeroCard("Happy Hogan", "Watchful Eye", 4, u, 2, Color.INSTINCT, u, "D4AT", ev => superPowerEv(ev, Color.INSTINCT, () => dangerSenseEv(ev, 2, cards => {
    cards.has(isStrike) && selectCardOptEv(ev, "Choose a card to KO", handOrDiscard(), c => KOEv(ev, c));
    cards.limit(isStrike).each(c => KOEv(ev, c));
  }))),
// {COORDINATE}
// {STRIKER 1}
  uc: makeHeroCard("Happy Hogan", "Loyal Friend", 5, u, 0, Color.TECH, u, "FA", ev => strikerHeroEv(ev, 1), { coordinate: true }),
// {STRIKER 2}
  ra: makeHeroCard("Happy Hogan", "Asset Management", 5, u, 0, Color.INSTINCT, u, "FDA", ev => strikerHeroEv(ev, 2)),
},
{
...
// {POWER Covert} Draw a card.
  c1: makeHeroCard("High-Tech Spider-Man", "Advanced Targeting System", 2, u, u, Color.COVERT, "Spider Friends", "DT", [ ev => drawIfEv(ev, c => c.cost <= 2), ev => superPowerEv(ev, Color.COVERT, () => drawEv(ev, 1)) ]),
// {WALLCRAWL}
// {DANGERSENSE 3}
  c2: makeHeroCard("High-Tech Spider-Man", "Recon Drone Connection", 2, u, 0, Color.TECH, "Spider Friends", "DA", ev => dangerSenseEv(ev, 3), { wallcrawl: true }),
// {WALLCRAWL}
// {POWER Tech} Choose two Villains in adjacent city spaces. Each of them gets -1 Attack this turn.
  uc: makeHeroCard("High-Tech Spider-Man", "Spider-Grip", 2, u, 2, Color.TECH, "Spider Friends", "DT", ev => superPowerEv(ev, Color.TECH, () => selectCardEv(ev, "Choose a Villain", cityVillains(), c => {
...
// You get +3 Attack usable only against the Mastermind or Villains on the Rooftops or Streets.
  ra: makeHeroCard("High-Tech Spider-Man", "Friendly Neighborhood ...", 2, u, 0, Color.TECH, "Spider Friends", "DAT", ev => addAttackSpecialEv(ev, c => isMastermind(c) || isLocation(c.location, 'ROOFTOPS', 'STREETS'), 3), { wallcrawl: true, coordinate: true }),
},
{
  name: "Peter's Allies",
  team: "Spider Friends",
// You may choose a Villain or Mastermind. You can fight it using only Recruit this turn.
  c1: makeHeroCard("Peter's Allies", "Michelle", 3, 2, u, Color.COVERT, "Spider Friends", "DT", ev => selectCardEv(ev, "Choose an Enemy", fightableCards().limit(isEnemy), c => {
    const a = fightActionEv(ev, c);
    a.cost.recruit = (a.cost.recruit || 0) + (a.cost.attack || 0) + (a.cost.either || 0);
    a.cost.attack = 0;
    a.cost.either = 0;
    a.cost.cond = c => isFightable(c);
    a.desc = "Fight with Recruit";
    addTurnAction(a);
  })),
// {COORDINATE}
// {POWER Covert} You get +2 Recruit
  c2: makeHeroCard("Peter's Allies", "Ned", 2, 1, u, Color.COVERT, "Spider Friends", "DR", ev => superPowerLikelyEv(ev, Color.COVERT, () => addRecruitEvent(ev, 2)), { coordinate: true }),
// Whenever you {COORDINATE} a card to another player, you may reveal this to draw two cards instead of one.
  uc: makeHeroCard("Peter's Allies", "Liz", 6, 4, u, Color.INSTINCT, "Spider Friends", "4T", [], { trigger: {
...
// {TEAMPOWER Spider Friends} Each Villain gets -2 Attack this turn. The next time you fight the Mastermind this turn, it gets -2 Attack.
  ra: makeHeroCard("Peter's Allies", "May Parker", 7, 5, u, Color.COVERT, "Spider Friends", "DT", ev => {
    superPowerEv(ev, "Spider Friends", () => {
      let once = false;
...
// {POWER Instinct} {DANGERSENSE 1}. If this revealed a Villain, you may fight it.
  c1: makeHeroCard("Peter Parker, Homecoming", "Avenger in Training", 2, u, 2, Color.INSTINCT, "Spider Friends", "DAT", ev => superPowerEv(ev, Color.INSTINCT, () => dangerSenseEv(ev, 1, cards => {
...
// {DANGERSENSE 2}
// Reveal the top card of your deck. If it costs 2 or less, draw it.
  c2: makeHeroCard("Peter Parker, Homecoming", "Heightened Senses", 2, u, u, Color.COVERT, "Spider Friends", "DT", [ ev => dangerSenseEv(ev, 2), ev => drawIfEv(ev, c => c.cost <= 2) ]),
// {WALLCRAWL}
// {POWER Tech} {DANGERSENSE 1}. If this revealed a Bystander, rescue it.
  uc: makeHeroCard("Peter Parker, Homecoming", "Homemade Web-Shooters", 2, u, 2, Color.TECH, "Spider Friends", "DAT", ev => superPowerEv(ev, Color.TECH, () => dangerSenseEv(ev, 1, cards => {
...
// If this revealed any Scheme Twists, you may shuffle the Villain Deck.
  ra: makeHeroCard("Peter Parker, Homecoming", "Something is Happening", 2, u, 0, Color.STRENGTH, "Spider Friends", "D4AT", ev => dangerSenseEv(ev, 4, cards => {
...
// {POWER Tech} {DANGERSENSE 2}
  c2: makeHeroCard("Tony Stark", "Stay Out of Trouble", 4, u, 2, Color.TECH, "Avengers", "FD4A", ev => superPowerEv(ev, Color.TECH, () => dangerSenseEv(ev, 2)), { coordinate: true }),
// {TEAMPOWER Avengers} {DANGERSENSE 1}. If this revealed a Villain, then Villains from that same Villain Group get -1 Attack this turn.
  uc: makeHeroCard("Tony Stark", "Little Grey Area", 5, u, 3, Color.RANGED, "Avengers", "AT", ev => superPowerEv(ev, "Avengers", () => dangerSenseEv(ev, 1, cards => {
...
// If another player accepts this {COORDINATE}, then at the end of this turn, move all cards that entered that player's Victory Pile this turn into your Victory Pile.
  ra: makeHeroCard("Tony Stark", "As Usual, I Did All the Work", 7, u, 5, Color.RANGED, "Avengers", "T", ev => {
...
// {POWER Covert} Instead, {VERSATILE 3}.
  c1: makeHeroCard("Gwenpool", "Come On, Nobody Reads Card Names", 2, 0, 0, Color.COVERT, "Champions", "FDRA", ev => superPowerCondEv(ev, Color.COVERT, n => versatileEv(ev, n ? 3 : 1))),
// Reveal the top card of the Bystander Deck. If it's a Special Bystander, rescue it. Otherwise, put it on the bottom of that deck.
  c2: makeHeroCard("Gwenpool", "I'll Rescue You If I Feel Like It", 3, u, 2, Color.INSTINCT, "Champions", "DT", ev => gameState.bystanders.withTop(c => {
    c.rescue ? rescueEv(ev, c) : moveCardEv(ev, c, gameState.bystanders, true);
  })),
// {SIZECHANGING INSTINCT}
// {POWER Instinct} Draw a card.
// {CHEERING CROWDS}
  uc: makeHeroCard("Gwenpool", "I Heard Keywords Are Powerful", 6, u, 2, Color.INSTINCT, "Champions", "D", ev => superPowerEv(ev, Color.INSTINCT, () => drawEv(ev, 1)), { sizeChanging: Color.INSTINCT, cheeringCrowds: true }),
// <b>Demolish</b> each other player. For each player that discards a card this way, draw a card.
  ra: makeHeroCard("Gwenpool", "I'm the Best at Board Games", 7, u, 5, Color.INSTINCT, "Champions", "T", ev => {
    demolishOtherEv(ev);
    cont(ev, () => drawEv(ev, turnState.pastEvents.count(e => e.type === 'DISCARD' && e.parent === ev)));
  }),
},
...
// {POWER Covert} Rescue a Bystander.
  c1: makeHeroCard("Ms. Marvel", "Long Arm of the Law", 3, u, u, Color.COVERT, "Champions", "", [ ev => drawEv(ev, 1), ev => superPowerEv(ev, Color.COVERT, () => rescueEv(ev)) ], { sizeChanging: Color.COVERT }),
// {SIZECHANGING STRENGTH}
// {VERSATILE 2}
  c2: makeHeroCard("Ms. Marvel", "Big Impact", 4, 0, 0, Color.STRENGTH, "Champions", "D4RA", ev => versatileEv(ev, 2), { sizeChanging: Color.STRENGTH }),
// {SIZECHANGING COVERT}
// {TEAMPOWER Champions} You may KO a card from your hand or discard pile.
// {CHEERING CROWDS}
  uc: makeHeroCard("Ms. Marvel", "Need to Stretch My Legs", 6, u, 2, Color.COVERT, "Champions", "DT", ev => superPowerEv(ev, "Champions", () => KOHandOrDiscardEv(ev, undefined)), { sizeChanging: Color.COVERT, cheeringCrowds: true }),
// {SIZECHANGING STRENGTH COVERT}
// {VERSATILE 4}
// {CHEERING CROWDS}
  ra: makeHeroCard("Ms. Marvel", "Rising Hope", 9, 0, 0, Color.STRENGTH, "Champions", "4RA", ev => versatileEv(ev, 4), { sizeChanging: Color.STRENGTH | Color.COVERT, cheeringCrowds: true }),
},
{
  name: "Nova",
  team: "Champions",
...
// {TEAMPOWER Champions} Rescue a Bystander.
  c1: makeHeroCard("Nova", "Space Cop", 2, 0, 0, Color.STRENGTH, "Champions", "FDRA", [ ev => versatileEv(ev, 1), ev => superPowerEv(ev, "Champions", () => rescueEv(ev)) ]),
// {VERSATILE 2}
// {CHEERING CROWDS}
  c2: makeHeroCard("Nova", "Interstellar Hero", 4, 0, 0, Color.RANGED, "Champions", "FD4RA", ev => versatileEv(ev, 2), { cheeringCrowds: true }),
// {POWER Ranged} {VERSATILE 3}
  uc: makeHeroCard("Nova", "Holographic Projection", 5, 0, 2, Color.RANGED, "Champions", "FDRA", ev => superPowerLikelyEv(ev, Color.RANGED, () => versatileEv(ev, 3))),
...
// For each other card you played this turn with a Recruit icon, you get +1 Recruit. For each other card you played this turn with an Attack icon, you get +1 Attack.
  ra: makeHeroCard("Nova", "Growing Nova Force", 9, 0, 0, Color.RANGED, "Champions", "RAT", ev => {
...
// {POWER Strength} The first time you defeat a Villain this turn, rescue a Bystander.
  c1: makeHeroCard("Totally Awesome Hulk", "Beloved Behemoth", 4, u, 2, Color.STRENGTH, "Champions", "D4T", ev => {
    let once = false;
...
// Draw a card.
// {CHEERING CROWDS}
  c2: makeHeroCard("Totally Awesome Hulk", "Incredible Mind, Awesome Body", 4, 1, u, Color.TECH, "Champions", "4", ev => drawEv(ev, 1), { sizeChanging: Color.TECH, cheeringCrowds: true }),
// {SIZECHANGING STRENGTH}
// If you have a Wound in your hand or discard pile, KO it and you get +2 Attack. Otherwise, gain a Wound.
  uc: makeHeroCard("Totally Awesome Hulk", "Growing Pains", 5, u, 2, Color.STRENGTH, "Champions", "DAT", ev => {
...
// You get +1 Attack for each extra card you drew this turn.
  ra: makeHeroCard("Totally Awesome Hulk", "7th Smartest Man in the World", 9, u, 5, Color.TECH, "Champions", "AT", ev => {
...
// {POWER Tech} Whenever you recruit a Hero from the HQ this turn, rescue a Bystander.
  c1: makeHeroCard("Viv Vision", "Walking Wi-Fi", 3, 2, u, Color.TECH, "Champions", "DT", ev => superPowerEv(ev, Color.TECH, () => addTurnTrigger('RECRUIT', ev => ev.where.isHQ, ev => rescueEv(ev)))),
// {SIZECHANGING TECH}
// {POWER Tech} When you draw a new hand of cards at the end of this turn, draw an extra card.
  c2: makeHeroCard("Viv Vision", "Expanding Neural Network", 4, u, 2, Color.TECH, "Champions", "D4T", ev => superPowerEv(ev, Color.TECH, () => addEndDrawMod(1)), { sizeChanging: Color.TECH }),
// {VERSATILE 3}
// {CHEERING CROWDS}
  uc: makeHeroCard("Viv Vision", "Crowdsourcing", 6, 0, 0, Color.RANGED, "Champions", "RA", ev => versatileEv(ev, 3), { cheeringCrowds: true }),
// {SIZECHANGING TECH RANGED}
// Whenever you recruit a Hero this turn, you get +2 Attack.
  ra: makeHeroCard("Viv Vision", "Alter Molecular Density", 9, 5, 0, Color.TECH, "Champions", "DAT", ev => addTurnTrigger('RECRUIT', () => true, ev => addAttackEvent(ev, 2)), { sizeChanging: Color.TECH | Color.RANGED }),
},
]);
...
// {OUTWIT}: You get +2 Attack.
  c2: makeTransformingHeroCard(
    makeHeroCard("Amadeus Cho", "Gamma-Draining Nanites", 3, u, u, Color.TECH, "Champions", "T", [ ev => drawEv(ev, 1), ev => cardsDrawn() >= 2 && transformHeroEv(ev, ev.source) ]),
    makeHeroCard("Amadeus Cho", "Like Totally Smart Hulk", 5, u, 2, Color.STRENGTH, "Champions", "FDA", ev => mayOutwitEv(ev, () => addAttackEvent(ev, 2))),
  ),
// You get +1 Attack for each different cost of Hero you have.
// {OUTWIT}: Draw a card.
  uc: makeHeroCard("Amadeus Cho", "Renegade Genius", 6, u, 0, Color.TECH, "Champions", "AT", [ ev => addAttackEvent(ev, yourHeroes().uniqueCount(c => c.cost)), ev => mayOutwitEv(ev, () => drawEv(ev, 1)) ]),
...
// {OUTWIT}: Look at the top card of your deck. KO it or put it back.
  ra: makeHeroCard("Amadeus Cho", "Visualize the Variables", 8, u, 4, Color.TECH, "Champions", "4T", [
...
// {OUTWIT}: When you draw a new hand of cards at the end of this turn, draw an extra card.
  c1: makeHeroCard("Bruce Banner", "Solve the Impossible", 2, u, 1, Color.TECH, "Avengers", "DT", ev => mayOutwitEv(ev, () => addEndDrawMod(1))),
// {OUTWIT}: {TRANSFORM} this into Savage Hulk Unleashed.
// TRANSFORMED
// {SMASH 4}
  c2: makeTransformingHeroCard(
    makeHeroCard("Bruce Banner", "Gamma Bomb Disaster", 4, 2, u, Color.TECH, "Avengers", "D4", ev => mayOutwitEv(ev, () => transformHeroEv(ev, ev.source))),
    makeHeroCard("Bruce Banner", "Savage Hulk Unleashed", 5, u, 0, Color.STRENGTH, "Avengers", "F4A", ev => smashEv(ev, 4)),
  ),
// {POWER Tech} Reveal the top card of your deck. If it costs 0, KO it.
  uc: makeHeroCard("Bruce Banner", "Dangerous Testing", 6, u, 3, Color.TECH, "Avengers", "FT", ev => superPowerEv(ev, Color.TECH, () => revealPlayerDeckEv(ev, 1, cards => cards.limit(c => c.cost === 0).each(c => KOEv(ev, c))))),
// {OUTWIT}: Look at the top three cards of your deck. Draw one of them, KO one, and put one back.
  ra: makeHeroCard("Bruce Banner", "Gamma Ray Experiment", 7, u, 4, Color.TECH, "Avengers", "4T", ev => mayOutwitEv(ev, () => lookAtThreeEv(ev, 'DRAW', 'KO'))),
},
{
  name: "Caiera",
  team: "Warbound",
...
// {POWER Covert} {SMASH 2}
  c2: makeHeroCard("Caiera", "Shadowforged Blade", 4, u, 2, Color.COVERT, "Warbound", "FD4A", ev => superPowerEv(ev, Color.COVERT, () => smashEv(ev, 2))),
// {OUTWIT}: You may KO a card from your hand or discard pile.
  uc: makeHeroCard("Caiera", "Focus The Old Power", 6, u, 2, Color.STRENGTH, "Warbound", "FDT", ev => mayOutwitEv(ev, () => KOHandOrDiscardEv(ev, undefined))),
// Double the Recruit you have.
...
// Double the Attack you have.
  ra: makeTransformingHeroCard(
    makeHeroCard("Caiera", "Dutiful Protector", 7, u, u, Color.INSTINCT, "Warbound", "T", [ ev => doubleRecruitEv(ev), ev => gameState.ko.count(isHero) >= 3 * gameState.players.size && transformHeroEv(ev, ev.source)]),
...
// Draw a card.
// {SMASH 2}
  c1: makeHeroCard("Gladiator Hulk", "Don't Make Me Angry", 3, u, 0, Color.STRENGTH, "Warbound", "FDA", [ ev => drawEv(ev, 1), ev => smashEv(ev, 2) ]),
// {SMASH 3}
...
// When a card effect causes you to discard this card, you may return this card to your hand.
  c2: makeTransformingHeroCard(
    makeHeroCard("Gladiator Hulk", "Seize The Throne", 4, u, 0, Color.INSTINCT, "Warbound", "4AT", [ ev => smashEv(ev, 3), ev => cardsDiscarded() >= 2 && transformHeroEv(ev, ev.source, 'DECK') ]),
    makeHeroCard("Gladiator Hulk", "Hulk Is King", 5, u, 3, Color.STRENGTH, "Warbound", "T", ev => [], { trigger: {
      event: 'DISCARD',
...
// If any players gained a Wound this way, you get {WOUNDED FURY}.
  uc: makeHeroCard("Gladiator Hulk", "The Green Scar", 5, u, 3, Color.STRENGTH, "Warbound", "AT", ev => {
    superPowerEv(ev, Color.STRENGTH, () => xdRampageEv(ev, 'Hulk'));
...
// {SMASH 3}
  ra: makeHeroCard("Gladiator Hulk", "Double-Fisted Smashing", 8, u, 0, Color.STRENGTH, "Warbound", "AT", [ ev => turnState.smashMultiplier = 2, ev => smashEv(ev, 3) ]),
},
{
  name: "Hiroim",
  team: "Warbound",
// {POWER Covert} The first time you defeat a Villain this turn, rescue a Bystander.
  c1: makeHeroCard("Hiroim", "Seek Redemption", 3, u, 2, Color.COVERT, "Warbound", "DT", ev => {
    let done = false;
...
// You get +1 Attack for every two Bystanders in your Victory Pile.
  c2: makeTransformingHeroCard(
    makeHeroCard("Hiroim", "Save from the Rubble", 4, 1, u, Color.COVERT, "Warbound", "4T", [ ev => drawEv(ev, 1), ev => playerState.victory.count(isBystander) >= 2 && transformHeroEv(ev, ev.source) ]),
    makeHeroCard("Hiroim", "Hiroim Redeemed", 5, u, 1, Color.STRENGTH, "Warbound", "FAT", ev => addAttackEvent(ev, Math.floor(playerState.victory.count(isBystander) / 2))),
  ),
// {TEAMPOWER Warbound} You may KO a 0-cost card from any player's discard pile. If you KO a Wound this way, rescue a Bystander.
  uc: makeHeroCard("Hiroim", "Mystic Shadow Priest", 6, u, 2, Color.COVERT, "Warbound", "DT", ev => superPowerLikelyEv(ev, "Warbound", () => selectCardOptEv(ev, "Choose a card to KO", gameState.players.map(p => p.discard.limit(c => c.cost === 0)).merge(), c => {
    KOEv(ev, c);
...
// Choose one: Rescue three Bystanders, or defeat any Villain or Mastermind whose Attack is less than the number of Bystanders in your Victory Pile.
  ra: makeHeroCard("Hiroim", "Blade of the People", 7, u, u, Color.INSTINCT, "Warbound", "T", ev => {
...
// Draw a card.
// {POWER Tech} You get +2 Attack.
  c1: makeHeroCard("Hulkbuster Iron Man", "Pound for Pound", 2, u, 0, Color.STRENGTH, "Avengers", "FDA", [ ev => drawEv(ev, 1), ev => superPowerLikelyEv(ev, Color.TECH, () => addAttackEvent(ev, 2)) ]),
// {OUTWIT}: {SMASH 2}
  c2: makeHeroCard("Hulkbuster Iron Man", "Attune Techtonic Transducer", 4, u, 2, Color.TECH, "Avengers", "FD4A", ev => mayOutwitEv(ev, () => smashEv(ev, 2))),
// {POWER Tech Strength} {TRANSFORM} this into Ultra-Massive Armor
// TRANSFORMED
// Draw two cards.
// {SMASH 2}
  uc: makeTransformingHeroCard(
    makeHeroCard("Hulkbuster Iron Man", "Build The Suit", 5, 3, u, Color.TECH, "Avengers", "F", ev => superPowerEv(ev, [Color.TECH, Color.STRENGTH], () => transformHeroEv(ev, ev.source))),
    makeHeroCard("Hulkbuster Iron Man", "Ultra-Massive Armor", 6, u, 0, Color.TECH, "Avengers", "FDA", [ ev => drawEv(ev, 2), ev => smashEv(ev, 2) ]),
  ),
// You get +2 Attack for each other [Tech] and/or [Strength] card you played this turn.
  ra: makeHeroCard("Hulkbuster Iron Man", "Final Battle", 8, u, 5, Color.TECH, "Avengers", "DAT", ev => addAttackEvent(ev, 2 * turnState.cardsPlayed.count(c => isColor(Color.TECH)(c) || isColor(Color.STRENGTH)(c)))),
},
{
  name: "Joe Fixit, Grey Hulk",
  team: "Crime Syndicate",
// {POWER Strength} {SMASH 2}
  c1: makeHeroCard("Joe Fixit, Grey Hulk", "Carefully Considered Smashing", 3, 2, 0, Color.STRENGTH, "Crime Syndicate", "DA", ev => superPowerEv(ev, Color.STRENGTH, () => smashEv(ev, 2))),
// Choose a Villain. You can spend any combination of Recruit and Attack to fight it this turn.
  c2: makeHeroCard("Joe Fixit, Grey Hulk", "Threaten And Bribe", 4, 2, u, Color.COVERT, "Crime Syndicate", "D4T", ev => {
...
// Choose a Villain in your Victory Pile, You get + Attack equal to it's printed VP.
  uc: makeTransformingHeroCard(
    makeHeroCard("Joe Fixit, Grey Hulk", "Ambitious Enforcer", 6, u, 3, Color.STRENGTH, "Crime Syndicate", "T", ev => addTurnTrigger('DEFEAT', ev => isVillain(ev.what) && ev.what.defense >= 6, ev => transformHeroEv(ev, ev.source, 'DECK'))),
    makeHeroCard("Joe Fixit, Grey Hulk", "Underworld Boss", 6, u, 0, Color.INSTINCT, "Crime Syndicate", "FAT", ev => selectCardEv(ev, "Choose a Villain", playerState.victory.limit(isVillain), c => addAttackEvent(ev, c.printedVP || 0))),
  ),
// You can spend any combination of Recruit and Attack to fight the Mastermind this turn.
  ra: makeHeroCard("Joe Fixit, Grey Hulk", "Hulk Runs This Town", 7, u, 4, Color.COVERT, "Crime Syndicate", "4T", ev => {
...
// {POWER Strength} {SMASH 2}. If you {SMASH} a Wound this way, KO it.
  c1: makeHeroCard("Korg", "Nothing Beats Rock", 2, u, 0, Color.STRENGTH, "Warbound", "DAT", [ ev => drawEv(ev, 1), ev => superPowerEv(ev, Color.STRENGTH, () => smashEv(ev, 2, c => isWound(c) && KOEv(ev, c)))]),
// {OUTWIT}: Draw a card.
  c2: makeHeroCard("Korg", "Move Mountains", 4, u, 2, Color.STRENGTH, "Warbound", "FD4", ev => mayOutwitEv(ev, () => drawEv(ev, 1))),
// {POWER Strength Strength} {TRANSFORM} this into Lord of Granite.
// TRANSFORMED
// Draw a card.
// {SMASH 3}
  uc: makeTransformingHeroCard(
    makeHeroCard("Korg", "Forged by Fire", 3, 2, u, Color.STRENGTH, "Warbound", "FD", ev => superPowerEv(ev, [Color.STRENGTH, Color.STRENGTH], () => transformHeroEv(ev, ev.source))),
    makeHeroCard("Korg", "Lord of Granite", 5, u, 0, Color.COVERT, "Warbound", "FA", [ ev => drawEv(ev, 1), ev => smashEv(ev, 3) ]),
  ),
// Put all cards from the HQ on the bottom of the Hero Deck in random order. You get their total printed Attack.
  ra: makeHeroCard("Korg", "Kronan Tactician", 8, u, 0, Color.STRENGTH, "Warbound", "AT", ev => hqCards().shuffled().each(c => { addAttackEvent(ev, c.printedAttack || 0); moveCardEv(ev, c, gameState.herodeck, true); })),
},
{
  name: "Miek, The Unhived",
  team: "Warbound",
// {SMASH 1}
  c1: makeHeroCard("Miek, The Unhived", "This Bug Smashes You", 3, u, 2, Color.INSTINCT, "Warbound", "DA", ev => smashEv(ev, 1)),
// Look at the top card of your deck. Put it back on the top or bottom.
// {POWER Instinct} You may {FEAST}.
  c2: makeHeroCard("Miek, The Unhived", "Devouring Frenzy", 4, 2, u, Color.INSTINCT, "Warbound", "D4T", [
    ...
    ev => superPowerLikelyEv(ev, Color.INSTINCT, () => chooseMayEv(ev, "Feast", () => feastEv(ev))),
  ]),
// Whenever a card is KO'd from your deck this turn, you may draw a card.
  uc: makeHeroCard("Miek, The Unhived", "Endless Appetite", 5, u, 3, Color.INSTINCT, "Warbound", "FT", ev => addTurnTrigger('KO', ev => ev.where === playerState.deck, ev => drawEv(ev))),
...
// Look at the top three cards of your deck and put them back in any order. Then you may {FEAST}.
  ra: makeTransformingHeroCard(
    makeHeroCard("Miek, The Unhived", "Metamorphosis", 7, 5, u, Color.COVERT, "Warbound", "T", [
    ...
    makeHeroCard("Miek, The Unhived", "Hive King Miek", 8, u, 6, Color.STRENGTH, "Warbound", "T", [
...
// {POWER Ranged} {SMASH 3}
  c1: makeHeroCard("Namora", "Crushing Tsunami", 3, u, 0, Color.RANGED, "Champions", "FA", [ ev => drawEv(ev, 1), ev => superPowerEv(ev, Color.RANGED, () => smashEv(ev, 3)) ]),
// You get +1 Attack, usable only against Villains in the Sewers or Bridge or the Mastermind.
  c2: makeHeroCard("Namora", "Heart of the Ocean", 4, u, 2, Color.COVERT, "Champions", "D4AT", ev => addAttackSpecialEv(ev, c => isMastermind(c) || isLocation(c.location, 'SEWERS', 'BRIDGE'), 1)),
...
// If you {SMASH} a 0-cost Hero this way, KO it.
  uc: makeTransformingHeroCard(
    makeHeroCard("Namora", "Herculean Effort", 5, 3, u, Color.RANGED, "Champions", "T", ev => addTurnTrigger('DEFEAT', ev2 => isLocation(ev2.where, 'SEWERS', 'BRIDGE') && isVillain(ev2.what), ev3 => transformHeroEv(ev3, ev.source, 'DECK'))),
    makeHeroCard("Namora", "Master of Depths", 6, u, 0, Color.STRENGTH, "Champions", "AT", ev => smashEv(ev, 3, c => c.cost === 0 && isHero(c) && KOEv(ev, c))),
  ),
// {POWER Covert} If the Bridge is empty, you may move a Villain there from another city space. A Villain moved this way gets -3 Attack this turn.
  ra: makeHeroCard("Namora", "Turning The Tide", 7, u, 5, Color.COVERT, "Champions", "T", ev => superPowerEv(ev, Color.COVERT, () => withCity('BRIDGE', bridge => isCityEmpty(bridge) && selectCardOptEv(ev, "Choose a Villain to move to the Bridge", cityVillains(), c => {
...
// If this is the first card you played this turn, draw a card.
  c1: makeHeroCard("No-Name, Brood Queen", "Surprise Attack", 2, u, 1, Color.COVERT, "Warbound", "FDT", ev => turnState.cardsPlayed.size === 0 && drawEv(ev)),
// Look at the top card of your deck. Discard it or put it back.
// {POWER Covert} You may {FEAST}.
  c2: makeHeroCard("No-Name, Brood Queen", "Appetite for Destruction", 4, u, 2, Color.COVERT, "Warbound", "D4T", [
    ev => lookAtDeckEv(ev, 1, cards => selectCardOptEv(ev, "Choose a card to discard", cards, c => discardEv(ev, c))),
    ev => superPowerLikelyEv(ev, Color.COVERT, () => chooseMayEv(ev, "Feast", () => feastEv(ev)))
  ]),
// You may {FEAST}. Then, if a non-grey Hero was KO'd from you deck this turn, {TRANSFORM} this into Torrent of Broodlings.
// TRANSFORMED
// Draw a card.
  uc: makeTransformingHeroCard(
    makeHeroCard("No-Name, Brood Queen", "Bursting with Life", 3, 2, u, Color.STRENGTH, "Warbound", "DT", [
      ev => chooseMayEv(ev, "Feast", () => feastEv(ev)),
...
// Look at the top card of your deck. Then {FEAST} up to three times. You get +2 Attack for each non-grey Hero that was KO'd from you deck this turn.
  ra: makeHeroCard("No-Name, Brood Queen", "World Spanning Hunger", 8, u, 4, Color.INSTINCT, "Warbound", "D4AT", [
...
// {POWER Tech} Reveal the top card of your deck. If it's a S.H.I.E.L.D., draw it.
  c1: makeHeroCard("Rick Jones", "Hacktivist", 3, u, 2, Color.TECH, "S.H.I.E.L.D.", "FDT", ev => superPowerEv(ev, Color.TECH, () => drawIfEv(ev, 'S.H.I.E.L.D.'))),
...
// Reveal the top card of your deck. If it costs 3 or more, draw it.
  c2: makeTransformingHeroCard(
    makeHeroCard("Rick Jones", "Seek the Nega-Bands", 4, 2, u, Color.INSTINCT, "S.H.I.E.L.D.", "D4T", ev => revealPlayerDeckEv(ev, 1, cards => cards.has(c => c.cost >= 3) && transformHeroEv(ev, ev.source))),
    makeHeroCard("Rick Jones", "Captain Marvel", 5, u, 2, Color.RANGED, "Avengers", "FDT", ev => drawIfEv(ev, c => c.cost >= 3)),
  ),
// If you have at least 5 Villains in your Victory Pile, {TRANSFORM} this into A-Bomb and put it on top of your deck.
// TRANSFORMED
// {SMASH 5}
  uc: makeTransformingHeroCard(
    makeHeroCard("Rick Jones", "Irradiated Blood", 5, u, 3, Color.TECH, "S.H.I.E.L.D.", "T", ev => playerState.victory.count(isVillain) >= 5 && transformHeroEv(ev, ev.source, 'DECK')),
    makeHeroCard("Rick Jones", "A-Bomb", 6, u, 0, Color.STRENGTH, u, "FA", ev => smashEv(ev, 5)),
  ),
...
// Count the number of different printed VP values in your Victory Pile. Draw that many cards.
  ra: makeTransformingHeroCard(
    makeHeroCard("Rick Jones", "Caught in Kree-Skrull War", 7, u, 4, Color.COVERT, "S.H.I.E.L.D.", "4T", ev => {
    ...
    makeHeroCard("Rick Jones", "The Destiny Force", 9, u, u, Color.RANGED, "Avengers", "T", ev => drawEv(ev, playerState.victory.limit(c => c.printedVP !== undefined).uniqueCount(c => c.printedVP))),
  ),
},
{
  name: "Sentry",
...
// You may {TRANSFORM} this into Agoraphobia and put it in your discard pile. If you do, you get +4 Attack.
  c1: makeTransformingHeroCard(
    makeHeroCard("Sentry", "Agoraphobia", 2, u, u, Color.COVERT, "Avengers", "FDT", ev => transformHeroEv(ev, ev.source, 'DISCARD')),
    makeHeroCard("Sentry", "Golden Guardian of Good", 6, u, 0, Color.STRENGTH, "Avengers", "4AT", ev => chooseMayEv(ev, "Transform back into Agoraphobia", () => { transformHeroEv(ev, ev.source, 'DISCARD'); addAttackEvent(ev, 4); })),
  ),
// You get +1 Attack for each card that <b>
// TRANSFORMED</b> this turn.
  c2: makeHeroCard("Sentry", "Rival Personalities", 4, u, 2, Color.STRENGTH, "Avengers", "D4A", ev => addAttackEvent(ev, turnState.pastEvents.count(e => e.type === 'TRANSFORM'))),
...
// Reveal the top card of your deck. If it costs 0, then {FEAST}. Otherwise, {TRANSFORM} this into Mournful Sentinel and put it in your discard pile.
  uc: makeTransformingHeroCard(
    makeHeroCard("Sentry", "Mournful Sentinel", 3, 2, u, Color.RANGED, "Avengers", "DT", ev => revealPlayerDeckEv(ev, 1, cards => { cards.each(c => moveCardEv(ev, c, playerState.deck)); cards.has(c => c.cost >= 1) && transformHeroEv(ev, ev.source, 'DECK'); })),
    makeHeroCard("Sentry", "The Void Unchained", 5, u, 3, Color.COVERT, u, "T", ev => revealPlayerDeckEv(ev, 1, cards => cards.has(c => c.cost === 0) ? feastEv(ev) : transformHeroEv(ev, ev.source, 'DISCARD'))),
  ),
// Reveal the top five cards of the Hero Deck, gain their total printed Attack, and put them on the bottom of that deck. If this card makes 12 Attack or more, then {TRANSFORM} this card into The Void Mastermind and add it to the game at the start of the next turn with one random Tactic.
  ra: makeHeroCard("Sentry", "Vast Unstable Power", 8, u, 0, Color.RANGED, "Avengers", "DAT", ev => revealHeroDeckEv(ev, 5, cards => {
...
// {SMASH 2}
  c1: makeTransformingHeroCard(
    makeHeroCard("She-Hulk", "Hurl Legal Objections", 3, 2, u, Color.INSTINCT, "Avengers", "DT", ev => {
      let done = false;
      addTurnAction(new Ev(ev, 'EFFECT', {
    ...
    makeHeroCard("She-Hulk", "Hurl Trucks", 6, u, 2, Color.STRENGTH, "Avengers", "FDA", [ ev => smashEv(ev, 2), ev => smashEv(ev, 2) ]),
  ),
// {OUTWIT}: Draw a card.
  c2: makeHeroCard("She-Hulk", "Window of Opportunity", 4, 2, u, Color.STRENGTH, "Avengers", "FD4", ev => mayOutwitEv(ev, () => drawEv(ev, 1))),
// Once this turn, if you made at least 6 Recruit this turn, you may KO a card from your hand or discard pile.
  uc: makeHeroCard("She-Hulk", "Radioactive Riot", 6, u, 3, Color.STRENGTH, "Avengers", "T", ev => {
    let done = false;
    addTurnAction(new Ev(ev, 'EFFECT', {
      cost: { cond: () => !done && turnState.totalRecruit >= 6 },
...
// For every 2 Recruit you made this turn, Reveal the top card of the Hero Deck, put it on the bottom of that deck, and you get that card's printed Attack.
  ra: makeHeroCard("She-Hulk", "Jade Giantess", 8, 4, 0, Color.STRENGTH, "Avengers", "D4AT", ev => {
...
// {POWER Strength} {SMASH 3}
  c1: makeHeroCard("Skaar, Son of Hulk", "Anger Management", 3, u, 1, Color.STRENGTH, "Avengers", "FA", ev => superPowerEv(ev, Color.STRENGTH, () => smashEv(ev, 3))),
// {POWER Instinct} {WOUNDED FURY}
  c2: makeHeroCard("Skaar, Son of Hulk", "Scarred Past", 3, u, 2, Color.INSTINCT, "Avengers", "FDA", ev => superPowerEv(ev, Color.INSTINCT, () => woundedFuryEv(ev))),
// {POWER Instinct} You may gain a Wound. If you do, {TRANSFORM} this into Raging Savage.
// TRANSFORMED
// {WOUNDED FURY}
  uc: makeTransformingHeroCard(
    makeHeroCard("Skaar, Son of Hulk", "Mood Swings", 5, 3, u, Color.INSTINCT, "Avengers", "FT", ev => superPowerLikelyEv(ev, Color.INSTINCT, () => chooseMayEv(ev, "Gain a Wound and Transform", () => {
      gainWoundEv(ev);
      transformHeroEv(ev, ev.source);
    }))),
    makeHeroCard("Skaar, Son of Hulk", "Raging Savage", 6, u, 3, Color.STRENGTH, "Avengers", "FA", ev => woundedFuryEv(ev)),
  ),
// {WOUNDED FURY}
// Then, you may KO any number of Wounds from your hand and/or discard pile, then draw that many cards.
  ra: makeHeroCard("Skaar, Son of Hulk", "Planetary-Level Revenge", 8, u, 4, Color.STRENGTH, "Avengers", "4AT", [ ev => woundedFuryEv(ev), ev => {
    let count = 0;
...
// {SIZECHANGING TECH}
// Draw a card.
  c1: makeHeroCard("Ant-Man", "Ride the Ants", 4, u, 1, Color.TECH, "Avengers", "F4", ev => drawEv(ev, 1), { sizeChanging: Color.TECH }),
// {USIZECHANGING TECH 3}
// {POWER Tech} You may discard a card. If you do, draw a card.
  c2: makeHeroCard("Ant-Man", "Risky Science", 5, u, 2, Color.TECH, "Avengers", "DT", ev => superPowerLikelyEv(ev, Color.TECH, () => selectCardOptEv(ev, "Choose a card to discard", playerState.hand.deck, c => {
    discardEv(ev, c); drawEv(ev);
  })), { uSizeChanging: { color: Color.TECH, amount: 3 } }),
// {SIZECHANGING TECH}
// You get +1 Attack for each extra card you drew this turn.
  uc: makeHeroCard("Ant-Man", "Giant Ego", 6, u, 2, Color.STRENGTH, "Avengers", "DAT", ev => addAttackEvent(ev, pastEvents('DRAW').count(e => e.who === playerState)), { sizeChanging: Color.TECH }),
// {USIZECHANGING TECH 5}
// A hero in the HQ without <b>Size-Changing</b> abilities gain {SIZECHANGING TECH} this turn.
  ra: makeHeroCard("Ant-Man", "Pym Particles", 9, u, 5, Color.TECH, "Avengers", "T", ev => selectCardEv(ev, "Choose a Hero", hqHeroes().limit(hasNoSizeChanging), c => {
...
// {POWER Covert} You get +2 Attack.
  c1: makeHeroCard("Wasp", "Bio-Electric Sting", 3, u, 1, Color.COVERT, "Avengers", "FDA", ev => superPowerLikelyEv(ev, Color.COVERT, () => addAttackEvent(ev, 2)), { uSizeChanging: { color: Color.COVERT, amount: 2 } }),
// {SIZECHANGING COVERT}
// {POWER Covert} Draw a card.
  c2: makeHeroCard("Wasp", "Tiny Winged Justice", 4, 2, u, Color.COVERT, "Avengers", "FD4", ev => superPowerEv(ev, Color.COVERT, () => drawEv(ev, 1)), { sizeChanging: Color.COVERT }),
// {SIZECHANGING COVERT}
// You get +1 Attack for each card you recruited this turn.
  uc: makeHeroCard("Wasp", "Swarm Tactics", 6, u, 2, Color.RANGED, "Avengers", "DAT", ev => addAttackEvent(ev, pastEvents('RECRUIT').size), { sizeChanging: Color.COVERT }),
// {USIZECHANGING COVERT 5}
// {TEAMPOWER Avengers} You get +1 Attack for each other Avengers card you played this turn.
  ra: makeHeroCard("Wasp", "Founding Avenger", 9, u, 4, Color.COVERT, "Avengers", "4AT", ev => superPowerLikelyEv(ev, "Avengers", n => addAttackEvent(ev, n)), { uSizeChanging: { color: Color.COVERT, amount: 5 } }),
},
{
  name: "Jocasta",
  team: "Avengers",
// {POWER Tech} You get <b>Empowered</b> by [Tech].
  c1: makeHeroCard("Jocasta", "Creation of Ultron", 3, u, 2, Color.TECH, "Avengers", "FDA", ev => superPowerEv(ev, Color.TECH, () => empowerEv(ev, Color.TECH))),
// If your discard pile is empty, you get +2 Recruit. Otherwise, shuffle your discard pile into your deck.
  c2: makeHeroCard("Jocasta", "Reprocess", 4, 2, u, Color.RANGED, "Avengers", "D4RT", ev => {
...
// GUN: 1
  ra: makeHeroCard("Jocasta", "Electromagnetic Eyebeams", 7, u, 5, Color.RANGED, "Avengers", "GDAT", ev => {
...
// Chose one: Draw a card, or you get <b>Empowered</b> by [Strength].
  c1: makeHeroCard("Wonder Man", "One-Hit Wonder", 2, u, 0, Color.STRENGTH, "Avengers", "FDAT", ev => chooseOneEv(ev, "Choose one",
...
// {POWER Ranged} You get <b>Empowered</b> by [Ranged].
  c2: makeHeroCard("Wonder Man", "Ionic Energy", 4, u, 2, Color.RANGED, "Avengers", "D4AT", [
    ...
    ev => superPowerEv(ev, Color.RANGED, () => empowerEv(ev, Color.RANGED)),
  ]),
// Put a card from the HQ on the bottom of the Hero Deck. If that card had a Recruit icon, you get +3 Recruit. If that card had an Attack icon, you get +3 Attack. (if both, get both).
  uc: makeHeroCard("Wonder Man", "Absorb Ambient Power", 5, 0, 0, Color.RANGED, "Avengers", "RAT", ev => {
...
// Choose any number of cards from the HQ. Put them on the bottom of the Hero Deck. Then you get <b>Empowered</b> by [Ranged] and [Strength].
  ra: makeHeroCard("Wonder Man", "8th Wonder of the World", 8, u, 4, Color.STRENGTH, "Avengers", "4AT", ev => {
...
// You get <b>Empowered</b> by the color of your choice.
  c1: makeHeroCard("Black Knight", "Amulet of Avalon", 3, u, 0, Color.INSTINCT, "Avengers", "FAT", ev => chooseClassEv(ev, c => empowerEv(ev, c))), // TODO choose color
// {POWER Strength} Return a 0-cost card from your discard pile to your hand.
// GUN: 1
  c2: makeHeroCard("Black Knight", "Defend the Weak", 3, 2, u, Color.STRENGTH, "Avengers", "GDT", ev => superPowerEv(ev, Color.STRENGTH, () => selectCardEv(ev, "Choose a card to return to your hand", playerState.discard.limit(c => c.cost === 0), c => moveCardEv(ev, c, playerState.hand)))),
// When a Master Strike is played, before it takes effect, you may discard this card. If you do, draw three extra cards at the end of this turn.
  uc: makeHeroCard("Black Knight", "Flying Steed", 6, u, 3, Color.COVERT, "Avengers", "T", [], { trigger: {
    event: 'STRIKE',
...
// You get + Attack equal to the printed Attack of a Villain in your Victory Pile. (Mastermind tactics aren't Villains).
  ra: makeHeroCard("Black Knight", "The Ebony Blade", 7, u, 0, Color.INSTINCT, "Avengers", "AT", ev => selectCardEv(ev, "Choose a Villain", playerState.victory.limit(isVillain), c => {
...
// {INDIGESTION} You get +2 Recruit.
  c2: makeHeroCard("Carnage", "Carnivore", 4, 0, u, Color.STRENGTH, "Venomverse", "FD4R", ev => digestEv(ev, 4, () => drawEv(ev, 2), () => addRecruitEvent(ev, 2))),
// {VIOLENCE} Reveal the top card of your deck. You may KO it.
  uc: makeHeroCard("Carnage", "Gruesome Feast", 6, u, 3, Color.COVERT, "Venomverse", "T", [], { excessiveViolence: ev => revealPlayerDeckEv(ev, 1, cards => selectCardOptEv(ev, "Choose a card to KO", cards, c => KOEv(ev, c))) }),
// {VIOLENCE} Reveal the top card of your deck. If it costs 0, KO it and you may repeat this process.
  ra: makeHeroCard("Carnage", "Feast or Famine", 8, u, 6, Color.COVERT, "Venomverse", "T", [], { excessiveViolence: ev => {
    const f = () => {
      let again = false;
...
// {POWER Instinct} Instead, you get both.
  c1: makeHeroCard("Venom", "Devouring Drool", 3, 0, 0, Color.INSTINCT, "Venomverse", "DRAT", ev => superPowerCondEv(ev, Color.INSTINCT, n => digestEv(ev, 3, () => addAttackEvent(ev, 2), () => addRecruitEvent(ev, 2), n))),
// {VIOLENCE} You get +2 Recruit.
  c2: makeHeroCard("Venom", "Razor Teeth", 4, 0, 2, Color.STRENGTH, "Venomverse", "FD4R", [], { excessiveViolence: ev => addRecruitEvent(ev, 2) }),
// <b>Choose one</b>:
...
// - Or you get +1 Attack for each other card you played this turn with an Attack icon.
  uc: makeHeroCard("Venom", "Symbiotic Adaptation", 6, 0, 0, Color.INSTINCT, "Venomverse", "RAT", ev => chooseOneEv(ev, "Choose one",
...
// {TEAMPOWER Venomverse, Venomverse} Instead, do both.
  ra: makeHeroCard("Venom", "Insatiable Hunger", 8, 0, 0, Color.INSTINCT, "Venomverse", "RAT", ev => superPowerCondEv(ev, ["Venomverse", "Venomverse"], n => digestEv(ev, 8, () => {
...
// GUN: 1
  c1: makeHeroCard("Venom Rocket", "Hungry for Action", 3, u, 2, Color.INSTINCT, "Venomverse", "GFDT", ev => digestEv(ev, 3, () => {
...
// If a Master Strike or Villain that has an Ambush ability was played this turn, you get +1 Attack.
  c2: makeHeroCard("Venom Rocket", "Spring the Trap", 4, u, 2, Color.TECH, "Venomverse", "FD4AT", ev => {
...
// {VIOLENCE} You may KO a card from your hand or discard pile.
  uc: makeHeroCard("Venom Rocket", "Serious Overkill", 5, u, 2, Color.RANGED, "Venomverse", "DT", [], { excessiveViolence: ev => KOHandOrDiscardEv(ev) }),
...
// GUN: 1
  ra: makeHeroCard("Venom Rocket", "Ultimate Survivor", 7, u, 5, Color.TECH, "Venomverse", "GT", [], { trigger: {
    event: 'STRIKE',
    match: (ev, source) => owner(source) && source.location === owner(source).hand,
    before: ev => {
...
// {POWER Ranged} Reveal the top card of your deck. If it costs 0, discard it and you get +2 Attack.
  c2: makeHeroCard("Venomized Dr. Strange", "See Future Timelines", 4, u, 2, Color.RANGED, "Venomverse", "D4AT", ev => superPowerEv(ev, Color.RANGED, () => revealPlayerDeckEv(ev, 1, cards => {
...
// If you played a 4-cost card and a 2-cost card this turn, you get +2 Attack.
  uc: makeHeroCard("Venomized Dr. Strange", "Complete the Grand Ritual", 6, u, 4, Color.INSTINCT, "Venomverse", "D4AT", ev => {
...
// {TEAMPOWER Venomverse, Venomverse} Do this ability again.
  ra: makeHeroCard("Venomized Dr. Strange", "Crystal of Kadavus", 8, u, 4, Color.RANGED, "Venomverse", "4T", ev => {
    superPowerCondEv(ev, ["Venomverse", "Venomverse"], n => repeat(n ? 2 : 1, () => revealThreeEv(ev, 'DRAW', 'DISCARD', 'KO')));
  }),
},
{
  name: "Venompool",
...
// {POWER Strength} Instead, you get both.
  c1: makeHeroCard("Venompool", "Digest That Chimichanga", 2, u, 0, Color.STRENGTH, "Venomverse", "DAT", ev => superPowerCondEv(ev, Color.STRENGTH, n => digestEv(ev, 2, () => addAttackEvent(ev, 2), () => rescueEv(ev), n))),
// Draw two cards. But you can't draw any more cards until the end of this turn.
// GUN: 1
  c2: makeHeroCard("Venompool", "Shenanigans", 3, u, u, Color.TECH, "Venomverse", "GFT", ev => {
    drawEv(ev, 2);
...
// {VIOLENCE} "Rescue" a Bystander.
  uc: makeHeroCard("Venompool", "Can I Get a Little Gratitude", 5, u, 3, Color.INSTINCT, "Venomverse", "T", ev => {
...
// {TEAMPOWER Venomverse, Venomverse} Instead, do both (in order).
  ra: makeHeroCard("Venompool", "Play to the Crowd", 7, u, 4, Color.STRENGTH, "Venomverse", "4AT", ev => superPowerCondEv(ev, ["Venomverse", "Venomverse"], n => digestEv(ev, 7, () => {
...
// This is a copy of Gwenpool card effect
  c1: makeHeroCard("Howard the Duck", "Traveling Companion", 3, 2, u, Color.INSTINCT, u, "DT", ev => gameState.bystanders.withTop(c => {
    c.rescue ? rescueEv(ev, c) : moveCardEv(ev, c, gameState.bystanders, true);
  })),
// Reveal the top card of your deck. If it costs 0 Cost or has no team icon, draw it.
  c2: makeHeroCard("Howard the Duck", "Rebel Without a Cause", 4, u, 2, Color.COVERT, u, "D4T", ev => drawIfEv(ev, c => c.cost === 0 || !c.team)),
// You get +1 Attack for each other Hero you played this turn with no team icon.
  uc: makeHeroCard("Howard the Duck", "Right Place, Wrong Time", 5, u, 3, Color.INSTINCT, u, "AT", ev => addAttackEvent(ev, turnState.cardsPlayed.count(c => !c.team))),
// Reveal the top three cards of your deck. Draw one of them, discard one, and KO one.
  ra: makeHeroCard("Howard the Duck", "Interplanetary Visitor", 7, u, 4, Color.TECH, u, "4T", ev => revealThreeEv(ev, 'DRAW', 'DISCARD', 'KO')),
},
{
  name: "Jessica Jones",
  team: "Marvel Knights",
// {SWITCHEROO 4}
  c1: makeHeroCard("Jessica Jones", "Alter Ego", 3, u, 2, Color.STRENGTH, "Marvel Knights", "FD4", [], { cardActions: [ switcherooActionEv(4) ] }),
// {SWITCHEROO 5}
// <b>Investigate</b> for a card with an Attack icon.
  c2: makeHeroCard("Jessica Jones", "Alias Investigations", 4, u, 1, Color.COVERT, "Marvel Knights", "4", ev => investigateEv(ev, hasAttackIcon), { cardActions: [ switcherooActionEv(5) ] }),
// {SWITCHEROO 6}
// <b>Investigate</b> for a card with a Recruit icon. You may draw that card or KO it.
  uc: makeHeroCard("Jessica Jones", "Crack the Case", 5, 3, u, Color.STRENGTH, "Marvel Knights", "T", ev => investigateEv(ev, hasRecruitIcon, playerState.deck, c => {
...
// {POWER Covert} <b>Investigate</b> the Villain Deck for a Villain. You may put it into your Victory Pile and do its Fight effect. Otherwise, put it back on the top or bottom of that deck.
  ra: makeHeroCard("Jessica Jones", "Uncover Hidden Evil", 7, u, 4, Color.COVERT, "Marvel Knights", "4T", ev => {
...
// You get +2 Attack, usable only against Villains in the Sewers or the Mastermind
  c1: makeHeroCard("Man-Thing", "Form from Ooze", 2, u, 0, Color.STRENGTH, u, "DAT", ev => addAttackSpecialEv(ev, c => isMastermind(c) || isLocation(c.location, 'SEWERS'), 2), { teleport: true }),
// Choose a Villain or Mastermind. If there are no other Villains adjacent to it, it gets -1 Attack this turn.
  c2: makeHeroCard("Man-Thing", "Burn the Fearful", 4, u, 2, Color.INSTINCT, u, "D4T", ev => {
...
// You may move a Villain to another city space. If another Villain is already there, swap them.
  uc: makeHeroCard("Man-Thing", "Travel the Nexus of Realities", 5, 3, u, Color.COVERT, u, "T", ev => {
    selectCardOptEv(ev, "Choose a Villain to move", cityVillains(), v => {
...
// {POWER Strength} You get +1 Attack for each empty city space.
  ra: makeHeroCard("Man-Thing", "Eternity of Solitude", 7, u, 5, Color.STRENGTH, u, "A", ev => superPowerLikelyEv(ev, Color.STRENGTH, () => addAttackEvent(ev, gameState.city.count(isCityEmpty)))),
},
{
  name: "Ms. America",
  team: "Avengers",
// {TELEPORT}
// {POWER Strength} You get +2 Attack.
  c1: makeHeroCard("Ms. America", "Star Power", 3, u, 1, Color.STRENGTH, "Avengers", "FDA", ev => superPowerLikelyEv(ev, Color.STRENGTH, () => addAttackEvent(ev, 2)), { teleport: true }),
// <b>Investigate</b> for an Avengers card and {TELEPORT} that card.
  c2: makeHeroCard("Ms. America", "Search Parallel Dimensions", 4, 2, u, Color.RANGED, "Avengers", "FD4", ev => investigateEv(ev, 'Avengers', playerState.deck, c => teleportEv(ev, c))),
// {POWER Strength} Reveal the top card of your deck. KO it or {TELEPORT} it.
  uc: makeHeroCard("Ms. America", "Kick a Hole in Reality", 6, u, 3, Color.STRENGTH, "Avengers", "FT", ev => superPowerEv(ev, Color.STRENGTH, () => revealPlayerDeckEv(ev, 1, cards => cards.each(c => {
    chooseOneEv(ev, "Choose", ["KO", () => KOEv(ev, c)], ["Teleport", () => teleportEv(ev, c)]);
  })))),
// You get +1 Attack for each other card in your hand.
  ra: makeHeroCard("Ms. America", "Hyper-Cosmic Awareness", 7, u, 0, Color.COVERT, "Avengers", "FAT", ev => addAttackEvent(ev, playerState.hand.size)),
},
{
  name: "Squirrel Girl",
  team: "Avengers",
...
// {SWITCHEROO 4}
// {POWER Instinct} You get +2 Attack.
  c2: makeHeroCard("Squirrel Girl", "Nut Punch", 3, u, 1, Color.INSTINCT, "Avengers", "FD4A", ev => superPowerLikelyEv(ev, Color.INSTINCT, () => addAttackEvent(ev, 2)), { cardActions: [ switcherooActionEv(4) ] }),
// {SWITCHEROO 5}
// You get +2 Attack if at least 2 cards entered the HQ this turn.
  uc: makeHeroCard("Squirrel Girl", "Squirrelgility", 4, u, 2, Color.COVERT, "Avengers", "D4AT", ev => {
...
// {POWER Instinct Instinct} You may choose a number from 1 to 8 instead.
  ra: makeHeroCard("Squirrel Girl", "Unbeatable Squirrel Girl", 8, u, 5, Color.INSTINCT, "Avengers", "T", ev => {
    superPowerCondEv(ev, [Color.INSTINCT, Color.INSTINCT], n => chooseNumberEv(ev, "Choose a number", 1, n ? 8 : 5, n => {
...
// If you drew any extra cards this turn, you get +1 Attack.
  c2: makeHeroCard("Captain Marvel, Agent of S.H.I.E.L.D.", "Radiant Blast", 4, u, 2, Color.RANGED, "S.H.I.E.L.D.", "FD4AT", ev => pastEvents('DRAW').has(e => e.who === playerState) && addAttackEvent(ev, 1)),
// {POWER Ranged} {LAST STAND}
  uc: makeHeroCard("Captain Marvel, Agent of S.H.I.E.L.D.", "Dominate the Battlefield", 6, u, 2, Color.RANGED, "S.H.I.E.L.D.", "FDA", ev => superPowerEv(ev, Color.RANGED, () => lastStandEv(ev))),
// Choose one: Draw three cards or {LAST STAND}.
// {POWER Strength Strength} Instead, do both.
  ra: makeHeroCard("Captain Marvel, Agent of S.H.I.E.L.D.", "Higher, Further, Faster", 7, u, 0, Color.STRENGTH, "S.H.I.E.L.D.", "AT", ev => {
...
},
{
  ...
  team: "Avengers",
// {POWER Tech} Draw a card.
  c1: makeHeroCard("Darkhawk", "Balance the Darkforce", 3, 1, 1, Color.TECH, "Avengers", "F", ev => superPowerEv(ev, Color.TECH, () => drawEv(ev))),
// Choose Recruit or Attack. Then {HYPERSPEED 4} for that icon.
  c2: makeHeroCard("Darkhawk", "Hawk Dive", 4, 0, 0, Color.COVERT, "Avengers", "F4RA", ev => hyperspeedEv(ev, 4, 'CHOOSE')),
// If the most recent Hero you played this turn has a Recruit icon, you get +3 Recruit. If it has an Attack icon, you get +3 Attack. (If both, you get both.)
  uc: makeHeroCard("Darkhawk", "Travel to Nullspace", 6, 0, 0, Color.TECH, "Avengers", "RAT", ev => turnState.cardsPlayed.withLast(c => {
    hasRecruitIcon(c) && addRecruitEvent(ev, 3);
    hasAttackIcon(c) && addAttackEvent(ev, 3);
  })),
...
// {POWER Tech Tech} Instead, {HYPERSPEED 9}.
  ra: makeHeroCard("Darkhawk", "Warflight", 7, 0, 0, Color.TECH, "Avengers", "RAT", [ ev => turnState.hyperspeedBoth = true, ev => superPowerCondEv(ev, [Color.TECH, Color.TECH], n => hyperspeedEv(ev, n ? 9 : 7))]),
},
{
  name: "Hellcat",
  team: "Avengers",
// {POWER Instinct} Choose one - Draw a card or you get +1 Attack.
  c1: makeHeroCard("Hellcat", "Catlike Agility", 2, u, 1, Color.INSTINCT, "Avengers", "FDA", ev => superPowerEv(ev, Color.INSTINCT, () => chooseOneEv(ev, "Choose one", ["Draw a card", () => drawEv(ev)], ["+1 Attack", () => addAttackEvent(ev, 1)]))),
...
// {POWER Instinct} Choose one - Draw a card or you get +1 Recruit.
  c2: makeHeroCard("Hellcat", "Part-Time PI", 3, 2, u, Color.INSTINCT, "Avengers", "DRT", [ ev => {
...
// {TEAMPOWER Avengers} If it was a Villain, you may fight it this turn.
  uc: makeHeroCard("Hellcat", "Demon Sight", 5, u, 2, Color.COVERT, "Avengers", "DAT", ev => {
...
// If a Master Strike or Scheme Twist would occur, you may discard this card from your hand instead. If you do, draw three cards, then shuffle that Strike or Twist back into the Villain Deck.
  ra: makeHeroCard("Hellcat", "Second Chance at Life", 8, u, 6, Color.INSTINCT, "Avengers", "T", [], { triggers: [
...
// To play this, you must discard a card. Draw two cards.
  c1: makeHeroCard("Photon", "Infrared Conversation", 3, u, u, Color.RANGED, "Avengers", "FT", ev => drawEv(ev, 2), { playCost: 1, playCostType: 'DISCARD' }),
// To play this, you must discard a card.
// {POWER Ranged} {HYPERSPEED 3}.
  c2: makeHeroCard("Photon", "Ultraviolet Radiation", 4, u, 3, Color.RANGED, "Avengers", "F4A", ev => superPowerEv(ev, Color.RANGED, () => hyperspeedEv(ev, 3)), { playCost: 1, playCostType: 'DISCARD' }),
// You get +1 Attack for each card you discarded from your hand this turn.
  uc: makeHeroCard("Photon", "Light the Way", 6, u, 3, Color.COVERT, "Avengers", "AT", ev => addAttackEvent(ev, pastEvents('DISCARD').count(e => e.where === playerState.hand))),
// {TEAMPOWER Avengers, Avengers} {LAST STAND}
  ra: makeHeroCard("Photon", "Coruscating Vengeance", 8, u, 6, Color.RANGED, "Avengers", "A", ev => superPowerEv(ev, ["Avengers", "Avengers"], () => lastStandEv(ev))),
},
{
  name: "Quicksilver",
  team: "Avengers",
...
// {POWER Instinct} Instead, {HYPERSPEED 3} for Recruit and Attack.
  c1: makeHeroCard("Quicksilver", "Too Fast to See", 3, 0, 0, Color.INSTINCT, "Avengers", "RA", ev => superPowerCondEv(ev, Color.INSTINCT, n => hyperspeedEv(ev, 3, n ? 'BOTH' : 'RECRUIT'))),
// {POWER Strength} {HYPERSPEED 4}
  c2: makeHeroCard("Quicksilver", "Perpetual Motion", 4, u, 2, Color.STRENGTH, "Avengers", "FD4A", ev => superPowerEv(ev, Color.STRENGTH, () => hyperspeedEv(ev, 4))),
// Look at the top card of your deck. Discard it or put it back.
// {POWER Instinct} You may KO the card you discarded this way.
  uc: makeHeroCard("Quicksilver", "Jittery Impatience", 6, 2, 2, Color.INSTINCT, "Avengers", "DT", ev => { // Copied from Drax
    lookAtDeckEv(ev, 1, cards => selectCardOptEv(ev, "Discard revealed", cards, c => {
      discardEv(ev, c)
    }));
    superPowerEv(ev, Color.INSTINCT, () => cont(ev, () => turnState.pastEvents.limit(e => e.type === "DISCARD" && e.parent === ev).each(e => {
...
// {TEAMPOWER Avengers, Avengers, Avengers, Avengers} Before you do that, put your discard pile on top of your deck.
  ra: makeHeroCard("Quicksilver", "Around the World Punch", 8, u, 0, Color.STRENGTH, "Avengers", "AT", [
...
// As you play this card, you may choose a color and/or a team icon. This card is that color and team icon this turn. (instead of [Covert] and Avengers)
  c1: makeHeroCard("Ronin", "Mysterious Identity", 3, u, 2, Color.COVERT, "Avengers", "DT", ev => {
...
// {HYPERSPEED 4}
// {POWER Ranged} Draw a card.
  c2: makeHeroCard("Ronin", "Storm of Arrows", 4, u, 0, Color.RANGED, "Avengers", "F4A", [ ev => hyperspeedEv(ev, 4), ev => superPowerEv(ev, Color.RANGED, () => drawEv(ev)) ]),
// {POWER Instinct} {DARK MEMORIES}
  uc: makeHeroCard("Ronin", "Haunted by Loss", 5, u, 2, Color.INSTINCT, "Avengers", "FDA", ev => superPowerEv(ev, Color.INSTINCT, () => darkMemoriesEv(ev))),
// {DARK MEMORIES}
// {POWER Strength} {DARK MEMORIES} again.
  ra: makeHeroCard("Ronin", "Brooding Fury", 7, u, 3, Color.STRENGTH, "Avengers", "A", [ ev => darkMemoriesEv(ev), ev => superPowerEv(ev, Color.STRENGTH, () => darkMemoriesEv(ev)) ]),
},
{
  name: "Scarlet Witch",
  team: "Avengers",
// {POWER Ranged} Discard the top card of any player's deck. You may play a copy of that card this turn.
  c1: makeHeroCard("Scarlet Witch", "Hex Bolt", 2, u, 1, Color.RANGED, "Avengers", "FDT", ev => superPowerEv(ev, Color.RANGED, () => choosePlayerEv(ev, p => {
    revealPlayerDeckEv(ev, 1, cards => cards.each(c => {
      discardEv(ev, c);
...
// {POWER Covert} {DARK MEMORIES}
  c2: makeHeroCard("Scarlet Witch", "Alter Reality", 3, 2, 0, Color.COVERT, "Avengers", "DAT", [ ev => {
    revealPlayerDeckEv(ev, 1, cards => selectCardOptEv(ev, "Discard revealed", cards, c => {
      discardEv(ev, c)
    }));
   }, ev => superPowerEv(ev, Color.COVERT, () => darkMemoriesEv(ev)) ]),
// Reveal the top card of the Hero Deck. You may play a copy of that card this turn. When you do, put that card on the bottom of the Hero Deck.
  uc: makeHeroCard("Scarlet Witch", "Chaos Magic", 4, u, u, Color.COVERT, "Avengers", "4T", ev => {
    revealHeroDeckEv(ev, 1, cards => cards.each(c => addTurnAction(new Ev(ev, 'EFFECT', { what: c, cost: { // TODO make this card visible
      cond: c => c === gameState.herodeck.top
    }, func: ev => {
      playCopyEv(ev, ev.what);
...
// {TEAMPOWER Avengers, Avengers, Avengers} {DARK MEMORIES}
  ra: makeHeroCard("Scarlet Witch", "Warp Time and Space", 7, u, 0, Color.COVERT, "Avengers", "AT", [ ev => {
  ...
  }, ev => superPowerEv(ev, ["Avengers", "Avengers", "Avengers"], () => darkMemoriesEv(ev)) ]),
},
{
  name: "Speed",
  team: "Avengers",
...
// {POWER Instinct} Instead, {HYPERSPEED 6}
  c1: makeHeroCard("Speed", "Accelerate", 2, u, 0, Color.INSTINCT, "Avengers", "FDA", ev => superPowerCondEv(ev, Color.INSTINCT, n => hyperspeedEv(ev, n ? 6 : 2))),
// The next Hero you recruit this turn goes on top of your deck.
  c2: makeHeroCard("Speed", "Speedy Delivery", 4, 2, 1, Color.INSTINCT, "Avengers", "FD4T", ev => turnState.nextHeroRecruit = 'DECK'),
// Choose a Hero Class. ([Strength], [Instinct], [Covert], [Tech] or [Ranged] ) Reveal the top card of your deck. If it's the Hero Class you named, draw it. Otherwise, put it back on the top or bottom.
  uc: makeHeroCard("Speed", "Race to the Rescue", 5, u, 3, Color.COVERT, "Avengers", "T", ev => chooseClassEv(ev, col => {
    revealPlayerDeckEv(ev, 1, cards => {
...
// {POWER Covert} {HYPERSPEED 6}
  ra: makeHeroCard("Speed", "Break the Sound Barrier", 8, u, 0, Color.COVERT, "Avengers", "AT", [ ev => revealPlayerDeckEv(ev, 6, cards => {
  ...
  }), ev => superPowerEv(ev, Color.COVERT, () => hyperspeedEv(ev, 6)) ]),
},
{
  name: "War Machine",
  team: "Avengers",
// {POWER Tech} You may fight a Henchman from your Victory Pile this turn. If you do, KO it and rescue a Bystander. (Do that Henchman's Fight effect too.)
  c1: makeHeroCard("War Machine", "Simulated Target Practice", 3, u, 2, Color.TECH, "Avengers", "DT", ev => {
    let done = false;
...
// GUN: 1
  c2: makeHeroCard("War Machine", "Military-Industrial Complex", 4, 0, 2, Color.TECH, "Avengers", "GFD4RT", ev => {
    addTurnTrigger('DEFEAT', ev => isVillain(ev.what), ev => addRecruitEvent(ev, 1));
  }),
// {HYPERSPEED 5}
// {POWER Ranged} You may KO a card from your discard pile.
// GUN: 1
  uc: makeHeroCard("War Machine", "Hypersonic Cannon", 5, u, 0, Color.RANGED, "Avengers", "GFAT", [ ev => hyperspeedEv(ev, 5), ev => superPowerLikelyEv(ev, Color.RANGED, () => selectCardOptEv(ev, "Choose a card to KO", playerState.discard.deck, c => KOEv(ev, c))) ]),
// Whenever you defeat a Villain or Mastermind this turn, draw a card and rescue a Bystander.
// GUN: 1
  ra: makeHeroCard("War Machine", "Overwhelming Firepower", 8, u, 5, Color.TECH, "Avengers", "GT", ev => {
...
// {SHIELDLEVEL 3} When you draw a new hand of cards at the end of this turn, draw an extra card.
  c1: makeHeroCard("Agent Phil Coulson", "Impeccable Planning", 3, u, 2, Color.COVERT, "S.H.I.E.L.D.", "DT", ev => shieldLevelPower(3) && addEndDrawMod(1)),
...
// {POWER Covert} You may send it {UNDERCOVER}.
  c2: makeHeroCard("Agent Phil Coulson", "Build the Strike Team", 4, u, 2, Color.COVERT, "S.H.I.E.L.D.", "D4T", ev => {
    revealDeckEv(ev, gameState.officer, 1, cards => cards.each(c => {
      superPowerEv(ev, Color.COVERT, () => sendUndercoverEv(ev, c), () => chooseOneEv(ev, "Choose one", ["Gain", () => gainEv(ev, c)], ["Put on the bottom", () => moveCardEv(ev, c, gameState.officer, true)]));
    }));
  }),
// Choose one:
// - Send a S.H.I.E.L.D. Hero from your hand {UNDERCOVER}.
// - Or you get +1 Attack for each 2 <b>S.H.I.E.L.D. Levels</b> you have.
  uc: makeHeroCard("Agent Phil Coulson", "Approve Orbital Strike", 6, u, 0, Color.TECH, "S.H.I.E.L.D.", "DAT", ev => {
...
// GUN: 1
  ra: makeHeroCard("Agent Phil Coulson", "Fake But Inspiring Death", 8, u, 4, Color.COVERT, "S.H.I.E.L.D.", "G4AT", ev => shieldLevelPower(8) && addAttackEvent(ev, 4), {
...
// {POWER Ranged} You may send the Hero you discarded {UNDERCOVER}.
  c1: makeHeroCard("Quake", "Going Underground", 3, 3, u, Color.RANGED, "S.H.I.E.L.D.", "T", ev => superPowerLikelyEv(ev, Color.RANGED, () => chooseMayEv(ev, "Send the discarded Hero undercover", () => {
...
// GUN: 1
  c2: makeHeroCard("Quake", "Aftershock", 4, u, 2, Color.RANGED, "S.H.I.E.L.D.", "GFD4A", ev => shieldLevelPower(2) && addAttackEvent(ev, 2)),
...
// {SHIELDLEVEL 4} You get +4 Attack
  uc: makeHeroCard("Quake", "Tectonic Wave", 6, u, 2, Color.COVERT, "S.H.I.E.L.D.", "D4AT", [
...
// Then, for each <b>S.H.I.E.L.D. Level</b> you have up to 5, choose a Hero from the HQ. Put all those Heroes on the bottom of the Hero Deck and you get their total printed Attack.
  ra: makeHeroCard("Quake", "Roil the Earth", 7, u, 0, Color.RANGED, "S.H.I.E.L.D.", "AT", [ ev => chooseMayEv(ev, "Send a S.H.I.E.L.D. Officer undercover", () => {
    gameState.officer.withTop(c => sendUndercoverEv(ev, c));
  }), ev => {
...
// GUN: 1
  c1: makeHeroCard("Deathlok", "Authorize Lethal Force", 2, u, 0, Color.TECH, "S.H.I.E.L.D.", "GFDA", [ ev => drawEv(ev), ev => shieldLevelPower(1) && addAttackEvent(ev, 1) ]),
// {POWER Tech} You may send a S.H.I.E.L.D. Hero {UNDERCOVER} from your discard pile or the KO pile.
  c2: makeHeroCard("Deathlok", "Reanimate Into Service", 4, u, 2, Color.TECH, "S.H.I.E.L.D.", "D4T", ev => 
...
// GUN: 1
  uc: makeHeroCard("Deathlok", "Headlok", 5, 3, 0, Color.STRENGTH, "S.H.I.E.L.D.", "GFAT", ev =>
    shieldLevelPower(3) ?
      addAttackEvent(ev, 3) :
...
// GUN: 1
  ra: makeHeroCard("Deathlok", "Behind Enemy Lines", 8, 0, 5, Color.COVERT, "S.H.I.E.L.D.", "GRT", [ ev => {
    selectCardOptEv(ev, "Choose a Hero to send undercover", playerState.discard.limit(isHero).limit('S.H.I.E.L.D.'), c => sendUndercoverEv(ev, c))
...
// GUN: 1
  c1: makeHeroCard("Mockingbird", "Take Cover", 3, 2, u, Color.INSTINCT, "S.H.I.E.L.D.", "GDT", ev => {
    lookAtDeckEv(ev, 1, cards => {
...
// {SHIELDLEVEL 2} Draw a card.
  c2: makeHeroCard("Mockingbird", "Battle Staves", 4, u, 2, Color.INSTINCT, "S.H.I.E.L.D.", "FD4", ev => shieldLevelPower(2) && drawEv(ev)),
// Choose one:
// - Send a card from the S.H.I.E.L.D. Officer Stack {UNDERCOVER}.
// - Or you get +1 Attack for each 2 <b>S.H.I.E.L.D. Levels</b> you have.
// GUN: 1
  uc: makeHeroCard("Mockingbird", "Spymaster", 5, u, 1, Color.COVERT, "S.H.I.E.L.D.", "GDAT", ev => {
    const attackAmount = Math.floor(shieldLevel()/2);
    chooseOneEv(ev, "Choose one",
...
// Then you get +1 Recruit and +1 Attack for each 2 <b>S.H.I.E.L.D. Levels</b> you have.
  ra: makeHeroCard("Mockingbird", "Infinity Formula", 7, 0, 0, Color.TECH, "S.H.I.E.L.D.", "DRAT", [
    ev => drawEv(ev),
...
// If you are {WORTHY}, you get +2 Attack.
  c1: makeHeroCard("Thor", "Test of Virtue", 3, 2, 0, Color.RANGED, "Heroes of Asgard", "FDA", ev => worthyPower() && addAttackEvent(ev, 2)),
// You get +1 Attack for each other card you played this turn that makes you {WORTHY}.
  c2: makeHeroCard("Thor", "Divine Lightning", 5, u, 3, Color.RANGED, "Heroes of Asgard", "FAT", ev => {
...
// {THROWN ARTIFACT} When you throw this, you get +3 Attack, then you get +1 Attack for each [Ranged] Hero you played this turn.
  uc: makeHeroCard("Thor", "Mjolnir", 4, u, u, Color.STRENGTH, "Heroes of Asgard", "4T", ev => {
    addAttackEvent(ev, 3);
    addAttackEvent(ev, superPowerCount(Color.RANGED));
...
// {TEAMPOWER Heroes of Asgard} Each player who is {WORTHY} draws a card. Each Villain that isn't worth at least 5VP gets -1 Attack this turn.
  ra: makeHeroCard("Thor", "Royal Decree", 8, u, 5, Color.RANGED, "Heroes of Asgard", "T", ev => {
    superPowerEv(ev, "Heroes of Asgard", () => {
...
// Then, if you are {WORTHY}, draw a card.
  c1: makeHeroCard("Beta Ray Bill", "Hope of the Korbinites", 1, 2, u, Color.STRENGTH, "Heroes of Asgard", "FDT", ev => {
    worthyPower() && drawEv(ev);
  }, { playCost: 1, playCostType: 'DISCARD' }),
// You may discard a card. If you do, draw a card.
  c2: makeHeroCard("Beta Ray Bill", "Bio-Engineered Cyborg", 5, u, 3, Color.TECH, "Heroes of Asgard", "FT", ev => {
    selectCardOptEv(ev, "Discard a card", playerState.hand.deck, c => { discardEv(ev, c); drawEv(ev); });
  }),
...
// {THROWN ARTIFACT} To throw this, you must discard a card from your hand. Then you get +2 Attack for each card you discarded from your hand this turn.
  uc: makeHeroCard("Beta Ray Bill", "Stormbreaker", 4, u, u, Color.RANGED, "Heroes of Asgard", "D4T", ev => {
...
// GUN: 1
  ra: makeHeroCard("Beta Ray Bill", "The Warship Skuttlebutt", 8, u, 4, Color.TECH, "Heroes of Asgard", "G4T", ev => {
...
// {THROWN ARTIFACT} When you throw this, you get {SEWERS CONQUEROR 2}.
  c1: makeHeroCard("Valkyrie", "Dragonfang", 3, u, u, Color.STRENGTH, "Heroes of Asgard", "FDT", ev => heroConquerorEv(ev, 'SEWERS', 2), { ...thrownArtifact }),
...
// When an Ambush ability is played, before it takes effect, you may discard this card. If you do, draw two extra cards at the end of this turn.
  c2: makeHeroCard("Valkyrie", "Flying Stallion", 4, u, 2, Color.INSTINCT, "Heroes of Asgard", "D4AT", ev => heroConquerorEv(ev, 'ROOFTOPS', 1), { trigger: {
    event: 'CARDEFFECT',
...
// {TEAMPOWER Heroes of Asgard} The first time you defeat a Villain this turn, you may KO one of your cards or a card from your discard pile.
  uc: makeHeroCard("Valkyrie", "Usher to Valhalla", 6, u, 2, Color.COVERT, "Heroes of Asgard", "DAT", [
    ev => heroConquerorEv(ev, 'BRIDGE', 1),
    ev => superPowerEv(ev, "Heroes of Asgard", () => addTurnTrigger('DEFEAT',
...
// [Instinct] : You get +1 Attack for every 4 Heroes in the KO pile.
  ra: makeHeroCard("Valkyrie", "Ride of the Valkyries", 7, u, 4, Color.INSTINCT, "Heroes of Asgard", "4AT", [
...
// {THROWN ARTIFACT} When you throw this you get +1 Recruit and +1 Attack.
  c1: makeHeroCard("Lady Sif", "Dimensional Blade", 2, u, u, Color.INSTINCT, "Heroes of Asgard", "FDT", ev => {
    addRecruitEvent(ev, 1);
    addAttackEvent(ev, 1);
  }, { ...thrownArtifact }),
// If you control any Artifacts, you get +2 Attack.
  c2: makeHeroCard("Lady Sif", "Weapons Master", 5, u, 2, Color.INSTINCT, "Heroes of Asgard", "FDA", ev => playerState.artifact.size && addAttackEvent(ev, 2)),
...
// During any player's turn, if a player would gain a Wound, you may throw this to prevent that Wound and draw two cards instead.
  uc: makeHeroCard("Lady Sif", "Winged Helm", 3, u, u, Color.STRENGTH, "Heroes of Asgard", "T", ev => addAttackEvent(ev, 1), {
    ...thrownArtifact,
    trigger: {
      event: "GAIN",
...
// {THROWN ARTIFACT} When you throw this, you get +4 Attack and you may KO a card from your hand or discard pile.
  ra: makeHeroCard("Lady Sif", "Golden Apples of Idunn", 7, u, u, Color.COVERT, "Heroes of Asgard", "4T", ev => {
    addAttackEvent(ev, 4);
...
// You may move a Villain to an adjacent city space. If another Villain is already there, swap them.
// {POWER Covert} Draw a card.
  c1: makeHeroCard("The Warriors Three", "Fandral the Dashing", 3, u, 2, Color.INSTINCT, "Heroes of Asgard", "FDT", [
    ev => {
      selectCardOptEv(ev, "Choose a Villain to move", cityVillains(), v => {
        selectCardEv(ev, "Choose a new city space", cityAdjacent(v.location), dest => swapCardsEv(ev, v.location, dest));
      });
    },
    ev => superPowerEv(ev, Color.COVERT, () => drawEv(ev))
  ]),
// {POWER Strength} You may KO a card from your hand or discard pile.
  c2: makeHeroCard("The Warriors Three", "Hogun the Grim", 4, 2, u, Color.COVERT, "Heroes of Asgard", "FD4T", ev => superPowerEv(ev, Color.STRENGTH, () => KOHandOrDiscardEv(ev, undefined))),
// {BRIDGE CONQUEROR 1}
// {POWER Instinct} Instead, {BRIDGE CONQUEROR 3}
  uc: makeHeroCard("The Warriors Three", "Volstagg the Valiant", 6, u, 3, Color.STRENGTH, "Heroes of Asgard", "FA", ev => superPowerCondEv(ev, Color.INSTINCT, n => heroConquerorEv(ev, 'BRIDGE', n ? 3 : 1))),
...
// {TEAMPOWER Heroes of Asgard} {STREETS CONQUEROR 3}
  ra: makeHeroCard("The Warriors Three", "Three Stand as One", 8, u, 4, Color.STRENGTH, "Heroes of Asgard", "4AT", [
    ev => turnState.cardsPlayed.limit(isNonGrayHero).uniqueCount(c => c.cardName) >= 3 && addAttackEvent(ev, 3),
    ev => superPowerEv(ev, "Heroes of Asgard", () => heroConquerorEv(ev, 'STREETS', 3))
  ]),
},
]);
...
// {SUNLIGHT} Draw a card.
  c1: makeHeroCard("Sunspot", "Absorb Radiation", 2, 1, u, Color.RANGED, "X-Men", "DT", [
...
// {SUNLIGHT} You may put a card from your hand on the bottom of you deck. If you do, you get +2 Attack.
  c2: makeHeroCard("Sunspot", "Solar-Powered", 4, u, 2, Color.STRENGTH, "X-Men", "FD4AT", ev => {
...
// {SUNLIGHT} You get +1 Attack for each other X-Men card you played this turn.
  uc: makeHeroCard("Sunspot", "Thermokinetic Fury", 6, u, 4, Color.RANGED, "X-Men", "4AT", ev => sunlightPower() && addAttackEvent(ev, superPowerCount("X-Men")), {
...
// {SUNLIGHT} You get +1 Attack for each Hero in the HQ with an even-numbered cost.
  ra: makeHeroCard("Sunspot", "Empyreal Force", 8, u, 3, Color.STRENGTH, "X-Men", "AT", [
...
// {MOONLIGHT} Draw a card.
  c1: makeHeroCard("Wolfsbane", "Wolf Out", 3, 2, u, Color.INSTINCT, "X-Men", "DT", [
...
// {MOONLIGHT} Look at the top two cards of your deck. Discard any number of them and put the rest back in any order.
  c2: makeHeroCard("Wolfsbane", "Night Vision", 3, u, 2, Color.STRENGTH, "X-Men", "DT",
    ev => moonlightPower() &&
...
// {MOONLIGHT} Look at the top card of your deck. KO it or put it back.
  uc: makeHeroCard("Wolfsbane", "Howl at the Moon", 5, u, 3, Color.COVERT, "X-Men", "FT",
    ev => moonlightPower() &&
...
// GUN: 1
  ra: makeHeroCard("Wolfsbane", "Nocturnal Savagery", 7, u, 4, Color.INSTINCT, "X-Men", "G4AT", [
...
// When a card effect causes you to discard this card, set it aside. At the end of this turn, add it to your hand as an extra card.
  c1: makeHeroCard("Mirage", "Empathic Link", 3, 2, u, Color.INSTINCT, "X-Men", "DT", u, { trigger: {
    event: 'DISCARD',
    match: (ev, source) => ev.what === source && ev.parent.getSource() instanceof Card,
    replace: ev => {
...
// {MOONLIGHT} You may discard a card. If you do, draw a card.
  c2: makeHeroCard("Mirage", "Dreams Made Real", 3, u, 2, Color.RANGED, "X-Men", "FDT", ev => {
...
// You may have a {WAKING NIGHTMARE}. You get +Attack equal to the cost of the card you discarded this way.
  uc: makeHeroCard("Mirage", "Nightmare Wolves", 6, u, 1, Color.COVERT, "X-Men", "AT", ev => wakingNightmareOptEv(ev, c => addAttackEvent(ev, c.cost))),
...
// {MOONLIGHT} You may have a {WAKING NIGHTMARE}.
  ra: makeHeroCard("Mirage", "Haunted By the Demon Bear", 7, u, 4, Color.COVERT, "X-Men", "D4AT", [
...
// Look at the top two cards of your deck. Draw one and discard the other.
  c1: makeHeroCard("Warlock", "Earthling Choices", 2, u, u, Color.TECH, "X-Men", "DT", ev => lookAtDeckEv(ev, 2, cards => {
...
// {POWER Tech} Instead, you get both.
  c2: makeHeroCard("Warlock", "Analyze Planetary Rotation", 3, 0, 0, Color.TECH, "X-Men", "DRAT", [
    ev => superPowerLikelyEv(ev, Color.TECH, () => { addRecruitEvent(ev, 2); addAttackEvent(ev, 2); }, () => { sunlightPower() && addRecruitEvent(ev, 2); moonlightPower() && addAttackEvent(ev, 2); }),
  ]),
// {POWER Tech} The first time you defeat a Villain this turn, you may KO one of your cards or a card from your discard pile.
  uc: makeHeroCard("Warlock", "Techno-Organic Adaptation", 6, u, 3, Color.COVERT, "X-Men", "T",
...
// {TEAMPOWER X-Men, X-Men, X-Men, X-Men} Instead, you get both.
  ra: makeHeroCard("Warlock", "Nanite Shapeshifter", 7, 0, 0, Color.TECH, "X-Men", "RAT", [
    ev => superPowerEv(ev, ["X-Men", "X-Men", "X-Men", "X-Men"], () => {
      drawEv(ev, 3); addRecruitEvent(ev, 3); addAttackEvent(ev, 3);
    }, () => {
      sunlightPower() && drawEv(ev, 3);
      moonlightPower() && (addRecruitEvent(ev, 3), addAttackEvent(ev, 3));
    }),
  ]),
},
{
...
// {POWER Covert} Choose a Villain. You get +1 Attack for each Villain adjacent to it.
  c1: makeHeroCard("Karma", "Sow Rivalry", 3, u, 2, Color.COVERT, "X-Men", "FDAT", ev => superPowerEv(ev, Color.COVERT, () => selectCardEv(ev, "Choose a Villain", villains(), c => {
...
// Guess a color. Then reveal the top card of the Hero Deck and put it back on the top or bottom of that deck. If you guessed right, you get +2 Attack.
  c2: makeHeroCard("Karma", "Temporary Possession", 4, u, 2, Color.COVERT, "X-Men", "D4AT", ev => chooseColorEv(ev, color => {
...
// Reveal the top card of the Hero Deck. You may recruit it this turn. If you do, you may KO one of your cards or a card from your discard pile.
  uc: makeHeroCard("Karma", "Karmic Balance", 6, 4, u, Color.RANGED, "X-Men", "4T", ev => revealHeroDeckEv(ev, 1, cards => cards.each(c => {
    addTurnAction(recruitCardActionEv(ev, c)); // TODO reveal until end of turn
...
// {TEAMPOWER X-Men} Choose a Villain in the city. You get +Attack equal to its VP, usable only against other Villains or the Mastermind.
  ra: makeHeroCard("Karma", "Control Like a Puppet", 8, u, 5, Color.RANGED, "X-Men", "AT", ev => superPowerEv(ev, "X-Men", () => selectCardEv(ev, "Choose a Villain", cityVillains(), c => {
...
// {POWER Ranged} Instead, same effect with {DANGERSENSE 2}
  c1: makeHeroCard("Captain Mar-Vell", "Cosmic Awareness", 2, u, 1, Color.RANGED, "Avengers", "DT", [
    ev => addTurnTrigger('ADDATTACK', ev => ev.parent.type === 'DANGERSENSE', { replace: ev => gainShardEv(ev, ev.parent.amount) }),
    ev => superPowerCondEv(ev, Color.RANGED, n => dangerSenseEv(ev, n ? 2 : 1)),
  ]),
// If you gained any Shards this turn, draw a card.
  c2: makeHeroCard("Captain Mar-Vell", "Kree Genetics", 3, 2, u, Color.STRENGTH, "Avengers", "FDT", ev => {
...
// {TEAMPOWER Avengers} Reveal the top card of your deck. If it costs 1 or more, gain a Shard. If it costs 0, KO it.
  uc: makeHeroCard("Captain Mar-Vell", "Channel the Nega-Bands", 6, u, 2, Color.TECH, "Avengers", "DT", ev => {
    superPowerEv(ev, "Avengers", () => revealPlayerDeckEv(ev, 1, cards => {
...
// If you gained any Shards this turn before playing this card, {DANGERSENSE 7} instead.
  ra: makeHeroCard("Captain Mar-Vell", "Protector of the Universe", 7, u, 3, Color.COVERT, "Avengers", "4AT", ev => {
...
// {POWER Covert} Whenever you recruit a Hero from the HQ this turn, gain a Shard.
  c1: makeHeroCard("Quasar", "Manipulate Gravitons", 3, 2, u, Color.COVERT, "Avengers", "DT", ev => {
...
// {BURN A SHARD}: You get +3 Attack
  c2: makeHeroCard("Quasar", "Cosmic Champion", 4, u, 2, Color.RANGED, "Avengers", "FD4A", ev => {
    setBurnShardEv(ev, 1, ev => addAttackEvent(ev, 3));
  }),
// Gain a Shard.
// {BURN 2 SHARDS}: You man KO a card from your hand or discard pile.
  uc: makeHeroCard("Quasar", "The Quantum Bands", 5, u, 1, Color.COVERT, "Avengers", "DT", [
    ev => gainShardEv(ev),
...
// {BURN 4 SHARDS}: You get +7 Attack
  ra: makeHeroCard("Quasar", "The Star Brand", 7, u, 4, Color.STRENGTH, "Avengers", "4AT", [
...
// {BURN 2 SHARDS}: Halve the cost of a Hero in the HQ this turn. (Round the cost up.)
  c1: makeHeroCard("Adam Warlock", "Transmute Matter", 3, u, u, Color.COVERT, "Avengers", "DT", [
    ev => gainShardEv(ev),
...
// When you draw a new hand of cards at the end of this turn, draw two extra cards.
  c2: makeHeroCard("Adam Warlock", "Regenerative Cocoon", 4, u, u, Color.STRENGTH, "Avengers", "4T", ev => addEndDrawMod(2), { playCost: 1, playCostType: 'DISCARD' }),
// Gain 2 Shards
// {POWER Covert} {BURN 4 SHARDS}: Defeat a Villain.
  uc: makeHeroCard("Adam Warlock", "Soulblast", 5, u, u, Color.COVERT, "Avengers", "FD4", [
    ev => gainShardEv(ev, 2),
...
// {TEAMPOWER Avengers, Avengers} {BURN 8 SHARDS}: Defeat the Mastermind once. Then reveal the top card of the Villain Deck. If it's a Master Strike, then Adam Warlock is corrupted by power. At the start of next turn, add the Magus Mastermind to the game with one random Tactic. (If he has never been in this game.)
  ra: makeHeroCard("Adam Warlock", "Manifest the Soul Gem", 8, u, u, Color.RANGED, "Avengers", "4T", [
    ev => gainShardEv(ev, 4),
    ev => superPowerEv(ev, ["Avengers", "Avengers"], () => setBurnShardEv(ev, 8, ev => {
...
// When you draw a new hand of cards at the end of this turn, if you didn't fight anything this turn, draw an extra card.
  c1: makeHeroCard("Moondragon", "Peaceful Meditation", 3, 2, u, Color.COVERT, "Avengers", "DT", ev => addTurnTrigger('CLEANUP', undefined, { before: ev => {
    pastEvents('FIGHT').size === 0 && addEndDrawMod(1);
  }})),
// {DANGERSENSE 2}
// {POWER Instinct} If this revealed any Scheme Twists, gain a Shard.
  c2: makeHeroCard("Moondragon", "Psionic Warning", 4, u, 1, Color.INSTINCT, "Avengers", "D4AT", 
    ev => dangerSenseEv(ev, 2, cards => superPowerLikelyEv(ev, Color.INSTINCT, () => cards.has(isTwist) && gainShardEv(ev)))),
// {DANGERSENSE 4}
// {TEAMPOWER Avengers} If this revealed at least two Master Strikes, you may shuffle the Villain Deck.
  uc: makeHeroCard("Moondragon", "Psychokinetic Blast", 6, u, 1, Color.RANGED, "Avengers", "4AT",
    ev => dangerSenseEv(ev, 4, cards => superPowerLikelyEv(ev, "Avengers", () => cards.count(isStrike) >= 2 && chooseMayEv(ev, "Shuffle the Villain Deck", () => gameState.villaindeck.shuffle())))),
// {DANGERSENSE 1}
// If this revealed a Scheme Twist, you get +3 Attack and you may shuffle the Villain Deck.
  ra: makeHeroCard("Moondragon", "Lunar Dragon Form", 8, u, 5, Color.STRENGTH, "Avengers", "AT", ev => dangerSenseEv(ev, 1, cards => { if (cards.has(isTwist)) {
    addAttackEvent(ev, 3);
...
// {POWER Tech} You get +1 Recruit or +1 Attack.
  c1: makeHeroCard("Nova", "Draw From the Worldmind", 2, 0, 0, Color.TECH, "Avengers", "FDRA", [
    ev => drawEv(ev),
...
// {POWER Ranged} Instead, do both.
  c2: makeHeroCard("Nova", "Electromagnetic Wave", 3, 0, u, Color.RANGED, "Avengers", "FDRT", ev => {
    superPowerEv(ev, Color.RANGED, () => {
...
// If there were no Villains in the city, draw two cards instead.
  uc: makeHeroCard("Nova", "Declare Galactic Threat", 6, u, u, Color.TECH, "Avengers", "T", ev => {
...
// Choose one: Draw three cards or a Mastermind gains {COSMIC THREAT}[Ranged] this turn. (It loses any previous Cosmic Threat abilities and penalties it had.)
  ra: makeHeroCard("Nova", "Mobilize the Nova Corps", 8, u, u, Color.RANGED, "Avengers", "T", ev => {
...
// GUN: 1
  c1: makeHeroCard("Yondu", "Whistling Arrow", 2, u, u, Color.RANGED, "Guardians of the Galaxy", "GDT", [
    ev => gainShardEv(ev),
    ev => superPowerEv(ev, Color.RANGED, () => setBurnShardEv(ev,
...
// {POWER Covert} If this revealed any Master Strikes, draw a card.
  c2: makeHeroCard("Yondu", "Interstellar Hunter", 3, u, 1, Color.COVERT, "Guardians of the Galaxy", "DAT", 
    ev => dangerSenseEv(ev, 2, cards => superPowerEv(ev, Color.COVERT, () => cards.has(isStrike) && drawEv(ev)))),
// {DANGERSENSE 3}
// {TEAMPOWER Guardians of the Galaxy} You may do the Fight effect of a Henchman Villain revealed this way. (Don't defeat it.)
  uc: makeHeroCard("Yondu", "Anticipate Their Movements", 5, u, 1, Color.INSTINCT, "Guardians of the Galaxy", "AT", 
...
// {TEAMPOWER Guardians of the Galaxy, Guardians of the Galaxy, Guardians of the Galaxy} Do both.
  ra: makeHeroCard("Yondu", "Space Pirate", 7, u, u, Color.TECH, "Guardians of the Galaxy", "T", ev => {
...
// {POWER Instinct} Draw a card.
  c1: makeHeroCard("Phyla-Vell", "Channel Cosmic Power", 2, u, u, Color.INSTINCT, "Guardians of the Galaxy", "FD", [
    ev => gainShardEv(ev),
    ev => superPowerEv(ev, Color.INSTINCT, () => drawEv(ev)),
  ]),
// If you have at least 4 Shards, you get +2 Attack.
  c2: makeHeroCard("Phyla-Vell", "Quantum Sword", 4, u, 2, Color.INSTINCT, "Guardians of the Galaxy", "FD4A",
...
// If any player would gain a Wound, you may discard this card and gain 2 Shards instead.
  uc: makeHeroCard("Phyla-Vell", "Martyr", 3, u, 2, Color.STRENGTH, "Guardians of the Galaxy", "DT", [], { trigger:
...
// Then, if you have at least 8 Shards, you get +3 Attack.
  ra: makeHeroCard("Phyla-Vell", "Avatar of Oblivion", 8, u, 3, Color.INSTINCT, "Guardians of the Galaxy", "DAT", [
...
// GUN: 1
  c2: makeHeroCard("Ronan the Accuser", "Rally Kree Warriors", 4, 2, u, Color.STRENGTH, u, "GFD4T", [
    ev => addTurnTrigger('RESCUE', ev => isBystander(ev.what), ev => gainShardEv(ev)),
    ev => superPowerEv(ev, Color.STRENGTH, () => rescueEv(ev)),
  ]),
// {CONTEST OF CHAMPIONS}[Tech]. Each player that wins rescues a Bystander. If the Mastermind wins, it captures a Bystander.
  uc: makeHeroCard("Ronan the Accuser", "Accuse Enemies of the Empire", 6, u, 4, Color.STRENGTH, u, "4T", ev => {
...
// {CONTEST OF CHAMPIONS}[Strength]. Each other player that loses must lose a Shard. Each player that wins gains 2 Shards. If the Mastermind wins, a Villain gains 2 Shards.
  ra: makeHeroCard("Ronan the Accuser", "Seek the Infinity Gems", 8, u, 4, Color.TECH, u, "D4T", ev => {
...
// Whenever you take any number of Shards from a Villain, Mastermind, or other player this turn, you may KO one of your cards or a card from your discard pile.
  c1: makeHeroCard("Nebula", "Ruthless Cyborg", 3, 2, u, Color.TECH, "Guardians of the Galaxy", "DT", ev => {
...
// GUN: 1
  c2: makeHeroCard("Nebula", "Galactic Rogue", 5, u, 3, Color.INSTINCT, "Guardians of the Galaxy", "GFT", [ ev => {
...
// {POWER Tech} Choose another player. Unless that player reveals a [Covert] Hero, take one of their Shards or "rescue" a Bystander from their Victory Pile.
  uc: makeHeroCard("Nebula", "Illusion Device", 4, u, 2, Color.TECH, "Guardians of the Galaxy", "D4T", ev => superPowerEv(ev, Color.TECH, () => chooseOtherPlayerEv(ev, p => {
...
// Whenever you take any number of Shards from a Villain, Mastermind, or other player this turn, you get +3 Recruit.
  ra: makeHeroCard("Nebula", "Daring Raid", 7, 0, 5, Color.INSTINCT, "Guardians of the Galaxy", "RT", ev => {
    addTurnTrigger('MOVECARD', ev =>
      ev.to === playerState.shard && (ev.from.attachedTo instanceof Card && isEnemy(ev.from.attachedTo) ||
        gameState.players.has(p => p !== playerState && ev.from === p.shard)),
...
// {POWER Ranged} Gain the {THRONES FAVOR}. If you already have it, you may spend it to get +2 Recruit.
  c1: makeHeroCard("Black Bolt", "Break the Silence", 3, 2, u, Color.RANGED, "Inhumans", "DRT",
...
// {TEAMPOWER Inhumans} Gain the {THRONES FAVOR}. If you already have it, you may spend it to reveal the top two cards of your deck. Put each of those cards with no rules text into your hand and put the rest back in any order.
  uc: makeHeroCard("Black Bolt", "Declaration of War", 4, u, 2, Color.TECH, "Inhumans", "D4T", ev => superPowerEv(ev, "Inhumans", () => thronesFavorGainOrMaySpendEv(ev, () => {
...
// Put the rest back in any order.
  ra: makeHeroCard("Black Bolt", "The King's Speech", 8, u, 5, Color.RANGED, "Inhumans", "T", ev => thronesFavorGainOrMaySpendEv(ev, () => {
...
// Gain the {THRONES FAVOR}. If you already have it, you may spend it to get +2 Attack.
  c1: makeHeroCard("Medusa", "Queen of the Inhumans", 2, u, 1, Color.STRENGTH, "Inhumans", "DAT", ev => thronesFavorGainOrMaySpendEv(ev, ev => addAttackEvent(ev, 2)), {
...
// {POWER Instinct} Gain the {THRONES FAVOR}. If you already have it, you may spend it to draw a card.
  c2: makeHeroCard("Medusa", "Splitting Hairs", 3, u, 2, Color.INSTINCT, "Inhumans", "DT", ev => superPowerEv(ev, Color.INSTINCT, () => thronesFavorGainOrMaySpendEv(ev, ev => drawEv(ev))), {
...
// {TEAMPOWER Inhumans} Gain the {THRONES FAVOR}. If you already have it, you may spend it to KO one of your cards.
  uc: makeHeroCard("Medusa", "Royal Command", 5, u, 3, Color.INSTINCT, "Inhumans", "T", ev => superPowerEv(ev, "Inhumans", () => thronesFavorGainOrMaySpendEv(ev, ev => selectCardAndKOEv(ev, revealable()))), {
    whenRecruited: thronesFavorGainEv
  }),
...
// Gain the {THRONES FAVOR}. If you already have it, you may spend it to draw two cards.
  ra: makeHeroCard("Medusa", "Headstrong", 7, u, 4, Color.INSTINCT, "Inhumans", "4T", ev => thronesFavorGainOrMaySpendEv(ev, ev => drawEv(ev, 2)), {
...
// {POWER Strength Instinct Covert Ranged} You get +3 Attack
  c1: makeHeroCard("Crystal", "Earth, Air, Fire, and Water", 3, u, 2, Color.RANGED, "Inhumans", "FDA", ev => superPowerLikelyEv(ev, [Color.STRENGTH, Color.INSTINCT, Color.COVERT, Color.RANGED], () => addAttackEvent(ev, 3))),
// Choose [Strength], [Instinct], [Covert], or [Ranged]. This card is only that Hero Class this turn.
// Draw a card.
  c2: makeHeroCard("Crystal", "Master the Four Elements", 4, 1, u, Color.INSTINCT, "Inhumans", "F4T", [
...
// Gain the {THRONES FAVOR}. If you already have it, you may spend it make this card [Strength], [Instinct], [Covert], and [Ranged] this turn.
  uc: makeHeroCard("Crystal", "Elemental Princess", 6, u, 3, Color.COVERT, "Inhumans", "T", ev => {
...
// Reveal the top four cards of your deck. Put a [Strength] Hero, a [Instinct] Hero, a [Covert] Hero, and a [Ranged] Hero from among them into your hand. Put the rest back in any order.
  ra: makeHeroCard("Crystal", "Weave Four Into One", 8, u, 4, Color.STRENGTH, "Inhumans", "4T", ev => {
...
// {POWER Covert} When you draw a new hand of cards at the end of this turn, draw an extra card.
  c1: makeHeroCard("Karnak", "Brilliant Strategist", 2, u, 1, Color.COVERT, "Inhumans", "DT", ev => superPowerEv(ev, Color.COVERT, () => addEndDrawMod(1)), { whenRecruited: ev => addAttackEvent(ev, 1) }),
...
// Choose a Villain Group. You get +1 Recruit for each Villain in your Victory Pile from that Group.
  c2: makeHeroCard("Karnak", "Find Fatal Flaw", 4, 0, u, Color.INSTINCT, "Inhumans", "D4RT", ev => {
...
// Choose a Villain Group. You get +1 Attack for each Villain in your Victory Pile from that Group.
  uc: makeHeroCard("Karnak", "Shatter the Weak Point", 5, u, 0, Color.STRENGTH, "Inhumans", "AT", ev => {
    const groups = playerState.victory.limit(c => c.printedVillainGroup !== undefined).unique(c => c.printedVillainGroup).map(g => ({l:g, v:g}));
...
// Whenever you play a card this turn, including this one, you may first use that card's "When Recruited" ability.
  ra: makeHeroCard("Karnak", "Seek the Center", 7, u, u, Color.COVERT, "Inhumans", "4T", ev => {
...
// {POWER Covert} You may {TELEPORT} another card from your hand.
  c1: makeHeroCard("Gorgon", "Lockjaw, Inhuman's Best Friend", 3, 2, u, Color.COVERT, "Inhumans", "DT", ev => {
...
// {POWER Strength} {STREETS ABOMINATION}
  c2: makeHeroCard("Gorgon", "Stomping Shockwave", 5, u, 2, Color.STRENGTH, "Inhumans", "DA", ev => superPowerEv(ev, Color.STRENGTH, () => heroAbominationEv(ev, 'STREETS')), {
    whenRecruited: ev => heroAbominationEv(ev, 'SEWERS'),
  }),
// {WHEN RECRUITED} You may KO one of your cards with no Attack icon.
// {HIGHEST ABOMINATION}
  uc: makeHeroCard("Gorgon", "Trample Underhoof", 6, u, 1, Color.STRENGTH, "Inhumans", "AT", ev => heroHighestAbominationEv(ev), {
...
// GUN: 1
  ra: makeHeroCard("Gorgon", "Lead the Inhuman Elite", 8, u, 4, Color.STRENGTH, "Inhumans", "G4AT", ev => superPowerEv(ev, "Inhumans", () => heroAbominationEv(ev, 'ROOFTOPS')), {
...
// {FOCUS 3} You get +2 Attack.
  c1: makeHeroCard("Fantastic Four United", "Thing", 4, 2, 0, Color.STRENGTH, "Fantastic Four", "FD4RA", [ ev => superPowerLikelyEv(ev, "Fantastic Four", () => addRecruitEvent(ev, 1)), ev => setFocusEv(ev, 3, ev => addAttackEvent(ev, 2)) ]),
// {FOCUS 2} KO up to two Wounds from your hand and/or discard pile.
// {FOCUS 6} You get +6 Attack and gain a Wound.
  c2: makeHeroCard("Fantastic Four United", "Human Torch", 4, 2, 0, Color.RANGED, "Fantastic Four", "D4AT", [
...
// {FOCUS 4} Rescue a Bystander, then you may KO a card from your hand or discard pile.
  uc: makeHeroCard("Fantastic Four United", "Invisible Woman", 4, 2, u, Color.COVERT, "Fantastic Four", "D4RT", [
...
// GUN: 1
  ra: makeHeroCard("Fantastic Four United", "Mr. Fantastic", 7, 2, 0, Color.TECH, "Fantastic Four", "GDAT", [
    ev => drawEv(ev, 2),
...
// {POWER Instinct} {OUTOFTIME}
  c1: makeHeroCard("Psi-Lord", "Avert Future Tragedy", 3, 2, 0, Color.INSTINCT, "Fantastic Four", "DAT", [
    ...
    ev => superPowerEv(ev, Color.INSTINCT, () => outOfTimeEv(ev))
  ]),
...
// {POWER Covert} {OUTOFTIME}
  c2: makeHeroCard("Psi-Lord", "Interdimensional Rescue", 4, u, 2, Color.COVERT, "Fantastic Four", "D4AT", [
...
// {POWER Instinct Covert} {OUTOFTIME}
  uc: makeHeroCard("Psi-Lord", "Slip the Timestream", 6, 3, 0, Color.COVERT, "Fantastic Four", "AT", [
    ev => setFocusEv(ev, 1, ev => revealVillainDeckEv(ev, 1, r => r.limit(isVillain).each(c => {
      addAttackEvent(ev, 1);
      addTurnSet('isFightable', card => c === gameState.villaindeck.top && card === c, () => true);
    }))),
    ev => superPowerEv(ev, [Color.INSTINCT, Color.COVERT], () => outOfTimeEv(ev))
  ]),
...
// {TEAMPOWER Fantastic Four, Fantastic Four} {OUTOFTIME}
  ra: makeHeroCard("Psi-Lord", "Reshape Reality", 7, 3, 3, Color.INSTINCT, "Fantastic Four", "4AT", [
    ...
    ev => superPowerEv(ev, ["Fantastic Four", "Fantastic Four"], () => outOfTimeEv(ev))
  ]),
},
{
  name: "Brainstorm",
...
// {POWER Tech} {OUTOFTIME}
  c1: makeHeroCard("Brainstorm", "Time Loop Experiments", 2, 1, u, Color.TECH, "Fantastic Four", "FDT", [
    ev => drawEv(ev),
    ev => pickTopDeckEv(ev),
    ev => superPowerEv(ev, Color.TECH, () => outOfTimeEv(ev))
  ]),
// Reveal the top card of your deck. If it costs 2 or more, draw it. Otherwise, discard it or put it back.
// {POWER Ranged} {OUTOFTIME}
// GUN: 1
  c2: makeHeroCard("Brainstorm", "Borrow from the Future", 3, u, 1, Color.RANGED, "Fantastic Four", "GDT", [
    ...
    ev => superPowerEv(ev, Color.RANGED, () => outOfTimeEv(ev))
  ]),
// {TEAMPOWER Fantastic Four} You may look at the top two cards of your deck. If you do, KO one of them and put the other back.
  uc: makeHeroCard("Brainstorm", "Reprogram Doombot Legions", 6, u, 3, Color.TECH, "Fantastic Four", "T",
...
// (Take another turn; or draw three extra cards at end of turn; or you may recruit a [Tech] or [Ranged] Hero for free; or all other players draw a card or discard a card.)
  ra: makeHeroCard("Brainstorm", "Protégé of Dr. Doom", 8, u, 4, Color.TECH, "Fantastic Four", "4AT",
    ev => {
...
// {FOCUS 2} Draw a card, then you may move a Villain to an adjacent city space. If another Villain is already there, swap them.
  c1: makeHeroCard("Heralds of Galactus", "Silver Surfer", 4, 2, u, Color.RANGED, u, "D4T", ev =>
    setFocusEv(ev, 2, ev => {
      drawEv(ev);
...
// {POWER Ranged} {BRIDGE CONQUEROR 2}
  c2: makeHeroCard("Heralds of Galactus", "Firelord", 3, u, 2, Color.RANGED, u, "FDAT", [
    ev => turnState.destroyedConqueror = true,
    ev => superPowerEv(ev, Color.RANGED, () => heroConquerorEv(ev, 'BRIDGE', 2))
  ]),
...
// {FOCUS 11} Search the Hero Deck, HQ, or your deck or discard pile for "Galactus Hungers" and put it on top of your deck. Shuffle any deck you searched.
  uc: makeHeroCard("Heralds of Galactus", "Stardust", 6, 4, 0, Color.COVERT, u, "4AT", [
...
// If you have played another Herald of Galactus this turn, destroy the leftmost city space, defeat any Villain there, and then you get +2 Attack for each destroyed city space. If this destroys the last city space, Galactus consumes the Earth. You Win, Evil Wins, and all other players lose.
  ra: makeHeroCard("Heralds of Galactus", "Galactus Hungers", 10, u, 8, Color.RANGED, u, "DAT",
...
// {FOCUSA 2} When you draw a new hand of cards at the end of this turn, draw an extra card.
  c1: makeHeroCard("Super-Skrull", "Stretching Credibility", 3, u, 2, Color.INSTINCT, u, "FDT", ev => setFocusWithAttackEv(ev, 2, ev => addEndDrawMod(1))),
// {POWER Strength} {SEWERS CONQUEROR 1}.
// {FOCUSA 3} You get +2 Recruit.
  c2: makeHeroCard("Super-Skrull", "Rock Solid", 4, 0, 2, Color.STRENGTH, u, "FD4RA", [ ev => superPowerEv(ev, Color.STRENGTH, () => heroConquerorEv(ev, 'SEWERS', 1)), ev => setFocusWithAttackEv(ev, 3, ev => addRecruitEvent(ev, 2)) ]),
// {BANK CONQUEROR 1}
// {FOCUSA 3} You may KO a card from your hand or discard pile.
  uc: makeHeroCard("Super-Skrull", "Transparent Motives", 5, u, 2, Color.COVERT, u, "FDAT", [ ev => heroConquerorEv(ev, 'BANK', 1), ev => setFocusWithAttackEv(ev, 3, ev => KOHandOrDiscardEv(ev)) ]),
// {BRIDGE CONQUEROR 1}
// {STREETS CONQUEROR 1}
// You may gain a Wound. If you do, you get {ROOFTOPS CONQUEROR 4}.
  ra: makeHeroCard("Super-Skrull", "Put to the Torch", 7, u, 4, Color.RANGED, u, "4AT", [ ev => heroConquerorEv(ev, 'BRIDGE', 1), ev => heroConquerorEv(ev, 'STREETS', 1),
...
// {POWER Instinct} {CLONE}
  c1: makeHeroCard("Multiple Man", "Me, Myself, and I", 4, 2, u, Color.INSTINCT, "X-Factor", "FD4", [ ev => tacticalFormation('444') && drawEv(ev), ev => superPowerEv(ev, Color.INSTINCT, () => cloneHeroEv(ev)) ]),
...
// {POWER Tech} {CLONE}
  c2: makeHeroCard("Multiple Man", "Finding Myself", 4, u, 1, Color.TECH, "X-Factor", "4T", [
    ev => investigateEv(ev, c => revealable().has(c2 => c2.cardName === c.cardName)),
    ev => superPowerEv(ev, Color.TECH, () => cloneHeroEv(ev)) ]),
// You get +1 Attack for each card name that you played at least twice this turn.
// {POWER Tech} {CLONE}
  c3: makeHeroCard("Multiple Man", "Perfect Match", 4, u, 1, Color.TECH, "X-Factor", "4AT", [
...
// {TEAMPOWER X-Factor} {CLONE}
  ra: makeHeroCard("Multiple Man", "Reabsorb Duplicates", 4, u, 2, Color.INSTINCT, "X-Factor", "D4T", [ ev => tacticalFormation('44') && KOHandOrDiscardEv(ev, undefined), ev => superPowerEv(ev, "X-Factor", () => cloneHeroEv(ev)) ]),
},
{
  name: "Shatterstar",
  team: "X-Force",
...
// {POWER Instinct} You get another +2 Recruit usable only to recruit Heroes that cost 5 or more.
  c1: makeHeroCard("Shatterstar", "Strive for Greatness", 3, 2, u, Color.INSTINCT, "X-Force", "DRT",
...
// {WHEN RECRUITED} [Instinct]: {CLONE}
// {POWER Instinct} Draw a card.
  c2: makeHeroCard("Shatterstar", "Gladiator's Blades", 5, u, 2, Color.INSTINCT, "X-Force", "FD", ev => superPowerEv(ev, Color.INSTINCT, () => drawEv(ev)),
    { whenRecruited: ev => superPowerEv(ev, Color.INSTINCT, () => cloneHeroEv(ev)) }),
// {WHEN RECRUITED} [Ranged]: {CLONE}
// {TACTICAL FORMATION 55}: You get +1 Attack.
  c3: makeHeroCard("Shatterstar", "Bioelectric Surge", 5, u, 2, Color.RANGED, "X-Force", "DA", ev => tacticalFormation('55') && addAttackEvent(ev, 1),
    { whenRecruited: ev => superPowerEv(ev, Color.RANGED, () => cloneHeroEv(ev)) }),
...
// {POWER Tech} {INVESTIGATE} the Sidekick Stack for a card and put it in your discard pile.
  c1: makeHeroCard("Stepford Cuckoos", "Find Mutants with Cerebro", 2, u, 1, Color.TECH, "X-Men", "DT",
...
// <b>Tactical Formation 33: Investigate</b> for a card with an Attack icon.
  c2: makeHeroCard("Stepford Cuckoos", "Shared Thoughts", 2, u, 1, Color.COVERT, "X-Men", "DAT", [
...
// {TACTICAL FORMATION 33}: Reveal the top card of the Villain Deck. If it's a Master Strike you get +1 Attack and you may shuffle the Villain Deck.
  c3: makeHeroCard("Stepford Cuckoos", "Telepathic Warning", 3, u, 2, Color.RANGED, "X-Men", "DAT", [
    ev => tacticalFormation('22') && addAttackEvent(ev, 1),
    ev => {
      let hasStrike = false;
...
// {TACTICAL FORMATION 223}: Reveal the top card of the Villain Deck. If it's a Villain, you get +2 Attack and you may fight it this turn. If you fight it, put a card from the Bystander stack on top of the Villain Deck.
  ra: makeHeroCard("Stepford Cuckoos", "Mind Wipe", 3, u, 2, Color.RANGED, "X-Men", "DAT",
    ev => {
...
// {INVESTIGATE} for a card that costs 3.
  c1: makeHeroCard("M", "Uncover Family Secrets", 3, 2, u, Color.COVERT, "X-Factor", "D",
    ev => investigateEv(ev, c => c.cost === 3), { whenRecruited: ev => superPowerEv(ev, Color.COVERT, () => cloneHeroEv(ev)) }),
...
// If you have a Wound in your hand or discard pile, KO it and you get +1 Attack. Otherwise, gain a Wound.
  c2: makeHeroCard("M", "Penance Form", 3, u, 2, Color.STRENGTH, "X-Factor", "DAT",
    ev => handOrDiscard().has(isWound) ? (KOHandOrDiscardEv(ev, isWound), addAttackEvent(ev, 1)) : gainWoundEv(ev),
    { whenRecruited: ev => superPowerEv(ev, Color.STRENGTH, () => cloneHeroEv(ev)) }),
// {WHEN RECRUITED} [Strength]: {CLONE}
// Draw a card.
// {TACTICAL FORMATION 333}: You get +2 Attack.
  c3: makeHeroCard("M", "Three Sisters Combined", 3, u, 0, Color.STRENGTH, "X-Factor", "DAT", [
...
// {TACTICAL FORMATION 3333}: You get +3 Attack.
  ra: makeHeroCard("M", "Interweaving Powers", 3, u, 2, Color.COVERT, "X-Factor", "DA",
    ev => tacticalFormation('3333') && addAttackEvent(ev, 3), { whenRecruited: ev => superPowerEv(ev, "X-Factor", () => cloneHeroEv(ev)) }),
},
{
  name: "Strong Guy",
  team: "X-Factor",
// {INVESTIGATE} for a card that's [Strength] and/or X-Factor.
  c1: makeHeroCard("Strong Guy", "X-Factor Investigation", 4, 2, u, Color.STRENGTH, "X-Factor", "FD4", ev => investigateEv(ev, c => isTeam("X-Factor")(c) || isColor(Color.STRENGTH)(c))),
// If any player would gain a Wound, you may discard this card instead. If you do, draw two cards.
  c2: makeHeroCard("Strong Guy", "Absorb Kinetic Energy", 5, u, 3, Color.STRENGTH, "X-Factor", "T", [], { trigger:
    youMayDiscardThisInsteadEv("GAIN", ev => isWound(ev.what), "draw two cards", ev => drawEv(ev, 2, owner(ev.source)))
  }),
// {TACTICAL FORMATION 445}: You get +3 Attack.
  uc: makeHeroCard("Strong Guy", "Go Big", 4, u, 2, Color.STRENGTH, "X-Factor", "FD4A", ev => tacticalFormation('445') && addAttackEvent(ev, 3)),
...
// </ul>
  ra: makeHeroCard("Strong Guy", "Treasure Hunt", 8, u, 3, Color.STRENGTH, "X-Factor", "4T", ev => {
...
// Choose a number 1 or more. {INVESTIGATE} for a card of that cost.
  c1: makeHeroCard("Warpath", "Grim Tracker", 2, u, 1, Color.INSTINCT, "X-Force", "FDT", ev => {
    chooseCostEv(ev, cost => investigateEv(ev, c => c.cost === cost), 1);
  }),
// When you draw a new hand of cards at the end of this turn, draw two extra cards.
  c2: makeHeroCard("Warpath", "Endless Endurance", 5, u, u, Color.STRENGTH, "X-Force", "T", ev => addEndDrawMod(2)),
// Reveal the top card of your deck. If it costs 0, you may KO it.
// {TACTICAL FORMATION 225}: You get +3 Attack.
  uc: makeHeroCard("Warpath", "Dangerous Maneuver", 2, u, 0, Color.COVERT, "X-Force", "DAT", [
...
// Choose a number 1 or more. {INVESTIGATE} for a card of that cost.
  ra: makeHeroCard("Warpath", "Superhuman Senses", 7, u, 3, Color.INSTINCT, "X-Force", "AT", [ ev => {
...
// Choose a Hero Class. {INVESTIGATE} for a card of that Hero Class.
  c1: makeHeroCard("Siryn", "Echolocation", 2, u, 1, Color.COVERT, "X-Factor", "FDT", ev => chooseClassEv(ev, color => investigateEv(ev, color))),
// {POWER Covert} {SHATTER} each Hero currently in the HQ whose printed cost is 2, 4, 6, and/or 8.
  c2: makeHeroCard("Siryn", "Hypnotic Call", 4, u, 2, Color.COVERT, "X-Factor", "D4T",
...
// <b>Tactical Formation 246: Shatter</b> all Villains.
  uc: makeHeroCard("Siryn", "Three-Octave Arpeggio", 6, u, 4, Color.RANGED, "X-Factor", "FD4",
...
// {SHATTER} the Mastermind. KO up to two cards from your hand and/or discard pile.
  ra: makeHeroCard("Siryn", "Splintering Shriek", 8, u, u, Color.COVERT, "X-Factor", "T", [
...
// {POWER Ranged} {SHATTER} a Villain in the Sewers.
  c1: makeHeroCard("Rictor", "Underground Cave-In", 3, u, 2, Color.RANGED, "X-Factor", "FD", ev => superPowerEv(ev, Color.RANGED, () => shatterSelectEv(ev, villainIn('SEWERS')))),
...
// {POWER Ranged} {INVESTIGATE} for a card that costs 0, KO it or discard it.
  uc: makeHeroCard("Rictor", "Trace the Fault Lines", 4, 2, u, Color.RANGED, "X-Factor", "FD4T",
...
// {SHATTER} the Mastermind or {SHATTER} all Heroes currently in the HQ.
  ra: makeHeroCard("Rictor", "Massive Earthquake", 7, u, u, Color.RANGED, "X-Factor", "T", ev => {
...
// {RITUAL ARTIFACT} If you drew a card, you may discard Wand of Watoomb to get +3 Attack.
  c1: makeHeroCard("Doctor Strange", "Wand of Watoomb", 3, u, u, Color.RANGED, "Avengers", "T", ev => addAttackEvent(ev, 3), ritualArifact(() => cardsDrawn() > 0)),
// If you control an Artifact, draw a card.
  c2: makeHeroCard("Doctor Strange", "Keeper of the Sanctum", 4, u, 2, Color.INSTINCT, "Avengers", "FD4", ev => {
...
// {RITUAL ARTIFACT} If you fought a Villain, you may discard Book Of Cagliostro to get +Recruit equal to that enemy’s VP.
  uc: makeHeroCard("Doctor Strange", "Book Of Cagliostro", 2, u, u, Color.INSTINCT, "Avengers", "DT", ev => {
...
// {RITUAL ARTIFACT} If you played another Artifact or three other cards of the same Hero Class, you may discard the Eye of Agamotto to get +7 Attack.
  ra: makeHeroCard("Doctor Strange", "The Eye of Agamotto", 8, u, u, Color.RANGED, "Avengers", "T", ev => addAttackEvent(ev, 7), ritualArifact(what => 
...
},
{
  ...
  team: "Marvel Knights",
// Draw a card. Then put a card from your hand on top of your deck.
  c1: makeHeroCard("Clea", "Prepare Dark Magic", 3, u, 2, Color.RANGED, "Marvel Knights", "FDT", [
    ev => drawEv(ev),
    ev => pickTopDeckEv(ev),
  ]),
// You may make a {DEMONIC BARGAIN} to get +2 Recruit.
  c2: makeHeroCard("Clea", "Demonic Descendant", 4, 2, u, Color.COVERT, "Marvel Knights", "FD4R", ev => {
...
// {POWER Ranged} You may choose a player to make a {DEMONIC BARGAIN} to KO up to one Hero of their choice from their hand or discard pile.
  uc: makeHeroCard("Clea", "Bind the Dark Dimension", 6, u, 3, Color.RANGED, "Marvel Knights", "T", ev => {
...
// {RITUAL ARTIFACT} If any cards were “revealed”, “looked at”, or “discarded” from any deck, you may discard the Purple Gem to get +6 Attack. (Just drawing or playing a card from a deck doesn’t count.)
  ra: makeHeroCard("Clea", "The Purple Gem", 7, u, u, Color.COVERT, "Marvel Knights", "T", ev => addAttackEvent(ev, 6),
...
// You may discard an Artifact you control or three cards from your hand. If you do, KO a card from your hand or discard pile.
  c1: makeHeroCard("Doctor Voodoo", "Commune with the Spirit World", 3, 2, u, Color.COVERT, "Avengers", "DT", ev => {
    const options: [string, () => void][] = [];
...
// {RITUAL ARTIFACT} If you have at least three Hero Classes, you may discard Medallion of Many Loas to get +1 Attack for each Hero Class you have, including this one.
  c2: makeHeroCard("Doctor Voodoo", "Medallion of Many Loas", 4, u, u, Color.TECH, "Avengers", "F4T", ev => addAttackEvent(ev, numClasses()), ritualArifact(() => numClasses() >= 3)),
// {RITUAL ARTIFACT} If you recruited a Hero, you may discard Staff of Legba to get +Attack equal to that Hero’s cost.
  uc: makeHeroCard("Doctor Voodoo", "Staff of Legba", 5, u, u, Color.STRENGTH, "Avengers", "T", ev => {
...
// The first time that one of your Heroes or a Hero from your deck or discard pile is KO’d this turn, you get +4 Recruit or +4 Attack.
  ra: makeHeroCard("Doctor Voodoo", "Possessed by Brother’s Spirit", 7, 0, 4, Color.INSTINCT, "Avengers", "4RAT", ev => {
    let done = false;
...
// You may have a Villain from the city enter the <b>Astral Plane</b>.
  c1: makeHeroCard("The Ancient One", "Astral Confrontation", 3, 2, u, Color.COVERT, u, "FDT", ev => {
...
// {POWER Covert} You get +3 Recruit.
  uc: makeHeroCard("The Ancient One", "War of the Mind", 6, 3, u, Color.COVERT, u, "RT", [ ev => {
  ...
  }, ev => superPowerLikelyEv(ev, Color.COVERT, () => addRecruitEvent(ev, 3)) ]),
// {RITUAL ARTIFACT} If you fought a Villain or Mastermind, you may set aside the Orb of Agamotto to reveal the top four cards of your deck. KO up to one of them, put two of them in your hand, and put the rest back on top in any order. Then discard the Orb of Agamotto.
  ra: makeHeroCard("The Ancient One", "The Orb of Agamotto", 8, u, u, Color.INSTINCT, u, "T", ev => revealPlayerDeckEv(ev, 4, cards => {
...
},
{
  ...
  team: "(Unaffiliated)",
// You may KO a Wound from your hand or discard pile. If you do, draw a card.
  c1: makeHeroCard("The Vishanti", "Oshtur", 3, 2, u, Color.STRENGTH, u, "FDT", ev => KOHandOrDiscardEv(ev, isWound, () => drawEv(ev))),
// You may make a {DEMONIC BARGAIN} to get +2 Attack.
  c2: makeHeroCard("The Vishanti", "Hoggoth", 5, u, 2, Color.INSTINCT, u, "FDA", ev => {
...
// {POWER Ranged} You may choose a player to make a {DEMONIC BARGAIN} to draw two extra cards at the end of this turn.
  uc: makeHeroCard("The Vishanti", "Agamotto", 4, u, 2, Color.RANGED, u, "D4T", [ ev => {
...
// {RITUAL ARTIFACT} If any player gained a Wound, you may set aside the Book of the Vishanti to KO up to one Wound from any player’s discard pile, then draw three cards. Then discard the Book of the Vishanti. You can use this during any player’s turn.
  ra: makeHeroCard("The Vishanti", "The Book of the Vishanti", 7, u, u, Color.COVERT, u, "T", ev => {
...
// <b>Triggered Artifact</b> — The first time you play an Artifact each turn <i>(including this one)</i>, you get +1 Recruit.
  c1: makeHeroCard("Star-Lord", "Starship Sensors", 2, u, u, Color.TECH, "Guardians of the Galaxy", "DT", ev => addRecruitEvent(ev, 1),
...
// GUN: 1
  c2: makeHeroCard("Star-Lord", "Borrowed Nova Blaster", 3, u, u, Color.RANGED, "Guardians of the Galaxy", "GT", ev => addAttackEvent(ev, 1),
  triggeredArifact('PLAY', ev => isArtifact(ev.what) && !pastEvents('PLAY').has(ev => isArtifact(ev.what)), true)),
// <b>Triggered Artifact</b> — The first time you play an Artifact each turn <i>(including this one)</i>, draw a card.
// GUN: 1
  c3: makeHeroCard("Star-Lord", "Expandable Helmet", 5, u, u, Color.TECH, "Guardians of the Galaxy", "GT", ev => drawEv(ev),
  triggeredArifact('PLAY', ev => isArtifact(ev.what) && !pastEvents('PLAY').has(ev => isArtifact(ev.what)), true)),
  uc: makeDividedHeroCard(
// DIVIDED: Give
// DIVHERO: Star-Lord
// You may discard an Artifact you control to get +1 Recruit.
    makeHeroCard("Star-Lord", "Give", 4, 2, u, Color.COVERT, "Guardians of the Galaxy", "D4RT", ev => {
...
// {TEAMPOWER Guardians of the Galaxy} Reveal the top card of your deck. If it's an Artifact, draw it.
    makeHeroCard("Yondu", "Take", 4, u, 2, Color.RANGED, "Guardians of the Galaxy", "D4T", ev => superPowerEv(ev, "Guardians of the Galaxy", () => revealPlayerDeckEv(ev, 1, cards => cards.has(isArtifact) && cards.each(c => drawCardEv(ev, c))))),
  ),
// You may discard an Artifact you control to get +1 Attack.
// GUN: 1
  u2: makeHeroCard("Star-Lord", "Don't Need That Stuff", 6, u, 3, Color.STRENGTH, "Guardians of the Galaxy", "GFAT", ev => {
...
// GUN: 1
  ra: makeHeroCard("Star-Lord", "Hadron Enforcer", 8, u, u, Color.RANGED, "Guardians of the Galaxy", "GT", ev => addAttackEvent(ev, 3),
  triggeredArifact('PLAY', ev => isArtifact(ev.what) && !pastEvents('PLAY').has(ev => isArtifact(ev.what)), true)),
},
{
  name: "Gamora",
...
// To play this, you must put a card from your hand on the bottom of your deck.
// Draw two cards.
  c2: makeHeroCard("Gamora", "Resourceful Fugitive", 4, u, u, Color.COVERT, "Guardians of the Galaxy", "4T", ev => drawEv(ev, 2), { playCost: 1, playCostType: 'BOTTOMDECK'}),
// <b>Triggered Artifact</b> — Whenever you draw a card during your turn, you get +1 Attack.
  c3: makeHeroCard("Gamora", "Retractable Sword", 5, u, u, Color.INSTINCT, "Guardians of the Galaxy", "T",
    // TODO not in CLEANUP
...
// DIVHERO: Gamora
// {POWER Covert} Draw a card.
    makeHeroCard("Gamora", "Forgive", 2, 1, u, Color.COVERT, "Guardians of the Galaxy", "D", ev => superPowerEv(ev, Color.COVERT, () => drawEv(ev))),
// DIVIDED: Resent
// DIVHERO: Nebula
// {POWER Instinct} You get +1 Attack.
    makeHeroCard("Nebula", "Resent", 2, u, 1, Color.INSTINCT, "Guardians of the Galaxy", "DA", ev => superPowerLikelyEv(ev, Color.INSTINCT, () => addAttackEvent(ev, 1))),
  ),
// If you drew at least two cards this turn, you may KO a card from your hand or discard pile.
// GUN: 1
  u2: makeHeroCard("Gamora", "Stolen Necroblaster", 6, u, 3, Color.RANGED, "Guardians of the Galaxy", "GT", ev => pastEvents('DRAW').count(ev => ev.who === playerState) >= 2 && selectCardOptEv(ev, "Choose a card to KO", handOrDiscard(), c => KOEv(ev, c))),
// If you drew at least two cards this turn, you get +2 Attack.
  ra: makeHeroCard("Gamora", "Guardians Escape", 7, u, 5, Color.TECH, "Guardians of the Galaxy", "FDAT", ev => pastEvents('DRAW').count(ev => ev.who === playerState) >= 2 && addAttackEvent(ev, 2)),
},
{
  name: "Rocket & Groot",
  team: "Guardians of the Galaxy",
...
// {POWER Tech} You may KO a card from your hand or discard pile.
  c3: makeDividedHeroCard(
    makeHeroCard("Rocket", "Don't Press This Button", 4, u, 2, Color.RANGED, "Guardians of the Galaxy", "D4A", ev => superPowerLikelyEv(ev, Color.RANGED, () => addAttackEvent(ev, 1))),
    makeHeroCard("Baby Groot", "Press the Button", 4, 1, u, Color.TECH, "Guardians of the Galaxy", "4T", ev => superPowerEv(ev, Color.TECH, () => KOHandOrDiscardEv(ev, undefined))),
  ),
// <b>Triggered Artifact</b> — Whenever you use <b>Excessive Violence</b>, draw a card.
  uc: makeHeroCard("Rocket & Groot", "Gravity Mines", 4, u, u, Color.TECH, "Guardians of the Galaxy", "F4T", ev => drawEv(ev),
...
// DIVHERO: Groot
  u2: makeDividedHeroCard(
    ...
    makeHeroCard("Rocket", "Tricky", 5, 2, u, Color.TECH, "Guardians of the Galaxy", "DRT", ev => revealableSplit().uniqueCount(c => c.cardName) >= 5 && addRecruitEvent(ev, 2)),
...
// <i>(Each Divided Card has two different card names.)</i>
  // TODO multiplayer reveal hand
  ra: makeHeroCard("Rocket & Groot", "We Are Groot", 7, u, 0, Color.STRENGTH, "Guardians of the Galaxy", "AT", ev => addAttackEvent(ev, splitDivided(playerState.hand.deck).uniqueCount(c => c.cardName))),
},
{
  name: "Drax",
  team: "Guardians of the Galaxy",
// {VIOLENCE} Look at the top two cards of your deck. Discard any number of them and put the rest back in any order.
  c1: makeHeroCard("Drax", "Nothing Goes Over My Head", 3, u, 2, Color.INSTINCT, "Guardians of the Galaxy", "DT", [], { excessiveViolence: ev =>
    revealPlayerDeckEv(ev, 2, cards => selectObjectsAnyEv(ev, "Choose cards to discard", cards, c => discardEv(ev, c)))
   }),
// {VIOLENCE} You get +2 Recruit.
  c2: makeHeroCard("Drax", "Prison Riot", 5, 0, 3, Color.STRENGTH, "Guardians of the Galaxy", "FDR", [], { excessiveViolence: ev => addRecruitEvent(ev, 2) }),
...
// If there are no Villains in the city, you get +1 Recruit.
  c3: makeDividedHeroCard(
    makeHeroCard("Drax", "I Am Invisible", 4, u, 2, Color.INSTINCT, "Guardians of the Galaxy", "D4T", [], { excessiveViolence: ev =>
      revealPlayerDeckEv(ev, 1, cards => cards.limit(Color.STRENGTH | Color.INSTINCT).each(c => drawCardEv(ev, c)))
     }),
    makeHeroCard("Irani Rael", "Xandar Is Invincible", 4, 2, u, Color.TECH, u, "D4RT", ev =>
...
// <b>Triggered Artifact</b> — Whenever you play another [Strength] or [Instinct] card, you get +1 Attack.
  uc: makeHeroCard("Drax", "Dual Knives", 4, u, u, Color.STRENGTH, "Guardians of the Galaxy", "F4T", ev => addAttackEvent(ev, 1),
...
// {POWER Instinct} You get +1 Recruit.
  u2: makeDividedHeroCard(
    makeHeroCard("Drax", "Remove His Spine", 6, u, 3, Color.STRENGTH, "Guardians of the Galaxy", "T", [], { excessiveViolence: ev =>
      revealPlayerDeckEv(ev, 1, cards => selectCardOptEv(ev, "Choose a card to KO", cards, c => KOEv(ev, c)))
     }),
    makeHeroCard("Rhomann Dey", "Also Illegal", 6, 3, u, Color.INSTINCT, u, "R", ev => superPowerLikelyEv(ev, Color.INSTINCT, () => addRecruitEvent(ev, 1))),
  ),
// Double the Attack you have.
// {VIOLENCE} You may KO a Villain from your Victory Pile to do its Fight effect.
  ra: makeHeroCard("Drax", "Revenge For My Family", 8, u, u, Color.STRENGTH, "Guardians of the Galaxy", "T", ev => doubleAttackEv(ev), { excessiveViolence: ev =>
...
// {KINDNESS} Put the Hero you recruited this way on the top of your deck.
  c1: makeHeroCard("Mantis", "Empathic Bond", 3, 2, u, Color.RANGED, "Guardians of the Galaxy", "FDT", [], { excessiveKindness: ev => moveCardEv(ev, ev.what, playerState.deck) }),
// DIVIDED: Selfless
...
// Another player discards a card.
  c2: makeDividedHeroCard(
    makeHeroCard("Mantis", "Selfless", 4, 2, u, Color.INSTINCT, "Guardians of the Galaxy", "D4", [
      ev => superPowerEv(ev, Color.INSTINCT, () => drawEv(ev)),
      ev => chooseOtherPlayerEv(ev, p => drawEv(ev, 1, p))
     ]),
    makeHeroCard("Ego", "Selfish", 4, u, 2, Color.RANGED, u, "D4", [
      ev => superPowerEv(ev, Color.RANGED, () => drawEv(ev)),
      ev => chooseOtherPlayerEv(ev, p => pickDiscardEv(ev, 1, p))
    ]),
  ),
// {KINDNESS} You get +2 Attack.
  c3: makeHeroCard("Mantis", "Inspire Courage", 5, 3, 0, Color.INSTINCT, "Guardians of the Galaxy", "FDA", [], { excessiveKindness: ev => addAttackEvent(ev, 2) }),
...
// {KINDNESS} You get +Attack equal to the total of all the printed Recruit and Attack of the Hero you recruited this way.
  u2: makeHeroCard("Mantis", "Emotional Wave", 6, 3, 0, Color.RANGED, "Guardians of the Galaxy", "AT", [], { excessiveKindness: ev => addAttackEvent(ev, (ev.what.printedAttack || 0) + (ev.what.printedRecruit || 0)) }),
// {KINDNESS} You get +Attack equal to the cost of the Hero you recruited this way.
  ra: makeHeroCard("Mantis", "Discover the Dead", 7, u, 2, Color.INSTINCT, "Guardians of the Galaxy", "FT", [], { excessiveKindness: ev => addAttackEvent(ev, ev.what.cost) }),
},
]);
...
// Gain the {THRONES FAVOR}. If you already have it, you may spend it to get +2 Recruit.
  c1: makeHeroCard("King Black Panther", "Unseen Protector", 2, 1, u, Color.INSTINCT | Color.COVERT, "Heroes of Wakanda", "DRT",
...
// {POWER Instinct} Gain the {THRONES FAVOR}. If you already have it, you may spend it to get +2 Attack.
  c2: makeHeroCard("King Black Panther", "Vibranium Claws", 4, u, 2, Color.INSTINCT | Color.TECH, "Heroes of Wakanda", "D4AT",
...
// {POWER Covert} Gain the {THRONES FAVOR}. If you already have it, you may look at the top card of your deck. Draw or KO it.
  uc: makeHeroCard("King Black Panther", "Heart-Shaped Herb", 5, u, 3, Color.STRENGTH | Color.COVERT, "Heroes of Wakanda", "T",
...
// {TEAMPOWER Heroes of Wakanda} Gain the {THRONES FAVOR}. If you already have it, you may spend it to get +1 Recruit and +1 Attack for each Hero Class you have.
  ra: makeHeroCard("King Black Panther", "Unite the Tribes of Wakanda", 8, 0, 5, Color.STRENGTH | Color.RANGED, "Heroes of Wakanda", "RAT", ev => {
...
// {POWER Covert} You get <b>Empowered</b> by [Covert].
  c1: makeHeroCard("Queen Storm of Wakanda", "Hurricane Winds", 3, 2, 0, Color.COVERT, "Heroes of Wakanda", "DAT", [ ev => {
    selectCardOptEv(ev, "Choose a Villain to move", cityVillains(), v => {
      selectCardEv(ev, "Choose a new city space", cityAdjacent(v.location), dest => swapCardsEv(ev, v.location, dest));
    });
  }, ev => superPowerEv(ev, Color.COVERT, () => empowerEv(ev, Color.COVERT)) ]),
// [Ranged] <b>Ambush</b>: You get <b>Empowered</b> by [Ranged].
// ---
// {POWER Ranged} You get <b>Empowered</b> by [Ranged].
  c2: makeHeroCard("Queen Storm of Wakanda", "Torrential Downpour", 4, u, 2, Color.RANGED, "Heroes of Wakanda", "FD4AT", ev => superPowerEv(ev, Color.RANGED, () => empowerEv(ev, Color.RANGED)),
...
// {POWER Covert Ranged} Gain the {THRONES FAVOR}. If you already had it, you may spend it to Wound the Mastermind twice.
  uc: makeHeroCard("Queen Storm of Wakanda", "Forked Lightning", 6, u, 3, Color.COVERT | Color.RANGED, "Heroes of Wakanda", "T", [
...
// {TEAMPOWER Heroes of Wakanda} Gain the {THRONES FAVOR}. If you already had it, you may spend it to get <b>Empowered</b> by [Covert], then get <b>Empowered</b> by [Ranged].
  ra: makeHeroCard("Queen Storm of Wakanda", "Thunderous Tempest", 8, u, 5, Color.RANGED, "Heroes of Wakanda", "AT", [
    ...
    ev => superPowerEv(ev, "Heroes of Wakanda", () => thronesFavorGainOrMaySpendEv(ev, () => {
...
// {POWER Instinct} You may draw a card and get +1 Attack. If you do, gain a Wound.
  c1: makeHeroCard("General Okoye", "To My Last Breath", 3, u, 2, Color.INSTINCT, "Heroes of Wakanda", "DAT",
...
// {POWER Strength} Instead, you may KO a S.H.I.E.L.D. Officer or Wound from your hand or discard pile to get +2 Attack.
  c2: makeHeroCard("General Okoye", "Lead the Dora Milaje", 4, u, 2, Color.STRENGTH | Color.INSTINCT, "Heroes of Wakanda", "D4AT", [
...
// Once per turn, when a player gains a Wound, you may reveal this card to return that Wound to the Wound Stack, draw a card, and Wound a Villain.
  uc: makeHeroCard("General Okoye", "Sovereign Bodyguard", 5, u, 3, Color.STRENGTH, "Heroes of Wakanda", "T", ev => [], { trigger:
...
// GUN: 1
  ra: makeHeroCard("General Okoye", "Direct the Agents of Wakanda", 7, u, 4, Color.COVERT, "Heroes of Wakanda", "GD4AT",
...
// Draw a card.
// {POWER Tech} You get <b>Empowered</b> by [Tech].
  c1: makeHeroCard("Princess Shuri", "Vibranium Experiments", 2, u, 0, Color.TECH, "Heroes of Wakanda", "DAT", [
    ev => drawEv(ev),
    ev => superPowerEv(ev, Color.TECH, () => empowerEv(ev, Color.TECH))
  ], heroAmbush(Color.TECH, ev => drawEv(ev))),
// You get <b>Empowered</b> by the color of your choice, getting Recruit instead of Attack.
  c2: makeHeroCard("Princess Shuri", "Kimoyo Beads", 4, 0, u, Color.TECH | Color.RANGED, "Heroes of Wakanda", "F4RT", ev => chooseColorEv(ev, c => empowerRecruitEv(ev, c))),
// You may put a card from the HQ on the bottom of the Hero Deck.
// {POWER Tech} You get <b>Empowered</b> by the color of your choice.
  uc: makeHeroCard("Princess Shuri", "Shock Net", 6, u, 3, Color.RANGED, "Heroes of Wakanda", "AT", [ ev => {
...
// {TEAMPOWER Heroes of Wakanda} This turn, each card entering the HQ also has "<b>Ambush</b>: If you have any cards that share a color with this, you get +2 Attack."
  ra: makeHeroCard("Princess Shuri", "Become the Next Black Panther", 7, 3, 3, Color.INSTINCT, "Heroes of Wakanda", "DAT",
...
// {POWER Tech} Wound a Villain.
  c1: makeHeroCard("White Wolf", "Cloaking Tech Ambush", 4, u, 2, Color.TECH, "Heroes of Wakanda", "FD4", ev => superPowerLikelyEv(ev, Color.TECH, () => selectCardOptEv(ev, "Choose a Villain to Wound", villains(), c => woundEnemyEv(ev, c))),
...
// {POWER Covert} If any Villain or Mastermind has any Wounds, you get +2 Recruit.
  c2: makeHeroCard("White Wolf", "Secret Assignment", 3, 2, u, Color.COVERT, "Heroes of Wakanda", "DRT",
...
// {TEAMPOWER Heroes of Wakanda} If any Villain or Mastermind has any Wounds, you may KO a card from your hand or discard pile.
  uc: makeHeroCard("White Wolf", "Command the Hatut Zeraze", 5, u, 3, Color.COVERT | Color.TECH, "Heroes of Wakanda", "T",
...
// If a Master Strike would occur, you may reveal this card to KO that Strike and Wound the Mastermind instead.
  ra: makeHeroCard("White Wolf", "Reflective Vibranium Armor", 7, u, 4, Color.TECH, "Heroes of Wakanda", "4T", [], {
...
// When you {DODGE} with or play this card, you may also {DODGE} with another card from your hand.
  c1: makeHeroCard("Black Widow", "Evasive Acrobatics", 3, 2, u, Color.INSTINCT, "S.H.I.E.L.D.", "FDT", ev => {
...
// {DODGE}
// {DARK MEMORIES}
  c2: makeHeroCard("Black Widow", "Widow's Bite", 4, u, 1, Color.TECH, "S.H.I.E.L.D.", "F4A", ev => darkMemoriesEv(ev), { cardActions: [ dodge ] }),
// {DODGE}
// If you drew any cards this turn, you may send one of your other Heroes {UNDERCOVER}.
  uc: makeHeroCard("Black Widow", "Weave A Web of Spies", 5, u, 2, Color.COVERT, "S.H.I.E.L.D.", "DT", ev => {
...
// You get +3 Attack if you have at least 4 Bystanders and/or Undercover Heroes in your Victory Pile.
  ra: makeHeroCard("Black Widow", "Infiltrate the Conspiracy", 7, u, 4, Color.RANGED, "S.H.I.E.L.D.", "4AT", [
...
// GUN: 1
  c2: makeHeroCard("Yelena Belova", "Unveil Identity", 3, 2, u, Color.INSTINCT, "S.H.I.E.L.D.", "GFDT", ev => superPowerEv(ev, Color.INSTINCT, () => unleashFromUndercoverEv(ev))),
// {DODGE}
...
// When you play this card, send it {UNDERCOVER}.
  uc: makeHeroCard("Yelena Belova", "Twilight Ops", 6, u, 3, Color.TECH, "S.H.I.E.L.D.", "T", ev => sendUndercoverEv(ev), {
    cardActions: [ dodge ],
    trigger: {
      event: "DODGE",
      match: (ev, source) => ev.what === source,
...
// You may send a Hero from your discard pile {UNDERCOVER}.
  ra: makeHeroCard("Yelena Belova", "Destroy the Red Room", 8, u, 4, Color.TECH, "S.H.I.E.L.D.", "4T", [
...
// ---
// {POWER Covert} Draw a card.
  c1: makeHeroCard("Red Guardian", "Sleeper Agent", 3, 2, u, Color.COVERT, u, "DT", ev => superPowerEv(ev, Color.COVERT, () => drawEv(ev)), {
...
// ---
// {POWER Covert} You get +2 Attack.
  c2: makeHeroCard("Red Guardian", "Magnetic Shield", 4, u, 2, Color.COVERT, u, "D4AT", ev => superPowerLikelyEv(ev, Color.COVERT, () => addAttackEvent(ev, 2)), {
    whenRecruited: whenRecruitedSendUndercover,
    trigger: {
      event: "RECRUIT",
...
// {POWER Covert} You may send one of your other Heroes {UNDERCOVER}.
  uc: makeHeroCard("Red Guardian", "Death Was Only A Ruse", 6, u, 3, Color.STRENGTH, u, "T",
...
// {POWER Covert} You get +2 Attack for each other [Covert] Hero you played this turn.
  ra: makeHeroCard("Red Guardian", "Champion of the Winter Guard", 8, u, 4, Color.COVERT, u, "D4AT", ev => superPowerLikelyEv(ev, Color.COVERT, n => addAttackEvent(ev, 2 * n)), {
    whenRecruited: whenRecruitedSendUndercover,
    triggers: [{
      event: "TWIST",
...
// Reveal the top two cards of your deck. Draw one of them that cost 0 and discard the rest.
  c1: makeHeroCard("White Tiger", "Amulets of the Tiger God", 4, 2, u, Color.STRENGTH, "Marvel Knights", "FD4T", ev => {
    revealPlayerDeckEv(ev, 2, cards => {
...
// Once this turn, you may fight the top card of the Bystander Stack as if it were a 3 Attack "Hand Ninjas" Henchman Villain with "<b>Fight</b>: You get +1 Recruit. Rescue this as a Bystander."
  c2: makeHeroCard("White Tiger", "Dark Influence of the Hand", 3, u, 0, Color.RANGED, "Marvel Knights", "AT", [ ev => darkMemoriesEv(ev), ev => {
    let done = false;
...
// Whenever you defeat a Henchman this turn, you may KO one of your cards.
  uc: makeHeroCard("White Tiger", "Camouflaged Huntress", 5, u, 3, Color.COVERT, "Marvel Knights", "FT", ev => {
...
// {DARK MEMORIES}, drawing that many cards instead of gaining Attack.
  ra: makeHeroCard("White Tiger", "Shadowed Resurrection", 8, u, 3, Color.INSTINCT, "Marvel Knights", "T", ev => drawEv(ev, darkMemoriesAmount())),
},
{
...
// {DARK MEMORIES}
  c1: makeDividedHeroCard(
    ...
    makeHeroCard("Winter Soldier", "Atone", 3, u, 0, Color.STRENGTH, "Avengers", "A", ev => darkMemoriesEv(ev)),
  ),
// DIVIDED: Relocate
// DIVHERO: Falcon
// {DODGE}
...
// {POWER Tech} Draw a card.
  c2: makeDividedHeroCard(
    makeHeroCard("Falcon", "Relocate", 4, u, 2, Color.INSTINCT, "Avengers", "D4A", ev => superPowerLikelyEv(ev, Color.INSTINCT, () => addAttackEvent(ev, 1)), { cardActions: [ dodge ] }),
    makeHeroCard("Winter Soldier", "Reload", 4, u, 2, Color.TECH, "Avengers", "D4", ev => superPowerEv(ev, Color.TECH, () => drawEv(ev))),
  ),
// DIVIDED: New Wings
// DIVHERO: Falcon
...
// Draw two cards.
  uc: makeDividedHeroCard(
    makeHeroCard("Falcon", "New Wings", 5, u, 0, Color.TECH, "Avengers", "4AT", ev => pastEvents('DISCARD').has(e => e.who === playerState) && addAttackEvent(ev, 4)),
    makeHeroCard("Winter Soldier", "New Plan", 5, u, u, Color.COVERT, "Avengers", "", ev => drawEv(ev, 2)),
  ),
// You get +1 Attack for each Hero Class you have.
// {TEAMPOWER Avengers} {DARK MEMORIES}
  ra: makeHeroCard("Falcon & Winter Soldier", "Captain America's Legacy", 7, u, 2, Color.STRENGTH, "Avengers", "DAT", [ ev => addAttackEvent(ev, numClasses()), ev => superPowerEv(ev, "Avengers", () => darkMemoriesEv(ev)) ]),
},
]);
...
// [Tech] {SACRIFICE}: You get +3 Recruit. You may KO a card from your hand or discard pile.
  c1: makeHeroCard("Wanda & Vision", "We Have to Destroy It", 1, 1, u, Color.TECH, "Avengers", "RT", ev => {
...
// Reveal the top card of your deck. If it has an odd-numbered cost, draw it. (0 is even.)
  c2: makeHeroCard("Wanda & Vision", "Witchcraft", 3, u, 2, Color.COVERT, "Avengers", "DT", ev => drawIfEv(ev, isCostOdd)),
// DIVIDED: Hold On
// DIVHERO: Wanda
// {POWER Covert} You get +2 Attack.
// DIVIDED: Let Go
...
// [Ranged] {SACRIFICE}: Draw 3 cards. You may KO a card from your hand or discard pile.
  c3: makeDividedHeroCard(
    makeHeroCard("Wanda", "Hold On", 3, u, 1, Color.COVERT, "Avengers", "DA", ev => superPowerLikelyEv(ev, Color.COVERT, () => addAttackEvent(ev, 2))),
    makeHeroCard("Vision", "Let Go", 3, 2, u, Color.RANGED, "Avengers", "DT", ev => sacrificeEv(ev, Color.RANGED, ev => {
      drawEv(ev, 3);
...
// If a Master Strike was completed this turn, you get +2 Recruit.
  uc: makeDividedHeroCard(
    makeHeroCard("Wanda", "Rage", 5, u, 2, Color.COVERT, "Avengers", "DAT", ev => pastEvents('MOVECARD').has(ev => ev.to === gameState.ko && isHero(ev.what)) && addAttackEvent(ev, 2)),
    makeHeroCard("Vision", "Grief", 5, 2, u, Color.TECH, "Avengers", "DRT", ev => pastEvents('STRIKE').size && addRecruitEvent(ev, 2), { cardActions: [ phasingActionEv ] }),
  ),
// DIVIDED: Magic
// DIVHERO: Wanda
// You get +1 Attack for each other Hero with an odd-numbered cost you played this turn.
...
// {POWER Tech} You get +2 Attack.
  u2: makeDividedHeroCard(
    makeHeroCard("Wanda", "Magic", 5, u, 1, Color.RANGED, "Avengers", "AT", ev => addAttackEvent(ev, pastEvents('PLAY').count(e => e.what !== ev.source && isCostOdd(e.what)))),
    makeHeroCard("Vision", "Science", 5, u, 2, Color.TECH, "Avengers", "DA", ev => superPowerLikelyEv(ev, Color.TECH, () => addAttackEvent(ev, 2)), { cardActions: [ phasingActionEv ] }),
  ),
// {PHASING}
// {POWER Ranged} Reveal the top five cards of the Hero Deck. You may put one of them with an odd-numbered cost into your hand. You may KO one of them. Put the rest back in any order.
  ra: makeHeroCard("Wanda & Vision", "Odd Couple", 7, u, 4, Color.COVERT | Color.RANGED, "Avengers", "4T", ev => superPowerEv(ev, Color.RANGED, () => revealHeroDeckEv(ev, 5, cards => {
...
},
{
  ...
  team: "Avengers",
// {POWER Covert} Draw a card.
  c1: makeHeroCard("Black Panther", "Wakanda Forever", 2, u, 1, Color.COVERT | Color.TECH, "Avengers", "FD", ev => superPowerEv(ev, Color.COVERT, () => drawEv(ev))),
// If you have all five Hero Classes, you get +3 Attack.
  c2: makeHeroCard("Black Panther", "Avengers Reassembled", 3, u, 2, Color.INSTINCT | Color.COVERT, "Avengers", "FDAT", ev => numClasses() === 5 && addAttackEvent(ev, 3)),
// [Instinct] {SACRIFICE}: KO up to two cards from your hand and/or discard pile.
  c3: makeHeroCard("Black Panther", "Great Many Lives Lost", 4, 2, u, Color.STRENGTH | Color.INSTINCT, "Avengers", "FD4T", ev => sacrificeEv(ev, Color.INSTINCT, () => {
...
// {POWER Strength} You may have this card make all Attack instead of Recruit.
  uc: makeHeroCard("Black Panther", "Council of War", 5, 3, 0, Color.STRENGTH | Color.COVERT, "Avengers", "RAT", ev => {
...
// {POWER Tech} You may KO that card.
  u2: makeHeroCard("Black Panther", "Vibranium Nanites", 6, u, 3, Color.TECH | Color.RANGED, "Avengers", "T", ev => revealPlayerDeckEv(ev, 1, cards => {
    superPowerCondLikelyEv(ev, Color.TECH, n => selectCardOptEv(ev, "Choose a card to KO", n ? cards : [], c => KOEv(ev, c), () => {
...
// You get +2 Attack for each Hero Class you have.
  ra: makeHeroCard("Black Panther", "Fateful Return", 8, u, 0, Color.INSTINCT | Color.TECH, "Avengers", "DA", ev => addAttackEvent(ev, 2 * numClasses())),
},
{
  name: "Doctor Strange",
  team: "Avengers",
...
// {POWER Ranged} You get +2 Recruit.
  c1: makeHeroCard("Doctor Strange", "Open Portals", 2, 1, u, Color.RANGED, "Avengers", "FDR", ev => superPowerLikelyEv(ev, Color.RANGED, () => addRecruitEvent(ev, 2)), { cardActions: [ phasingActionEv ] }),
// {POWER Instinct} Reveal the top card of the Villain Deck. If it's a Villain, you get +2 Attack.
  c2: makeHeroCard("Doctor Strange", "Defend This Dimension", 3, u, 2, Color.INSTINCT, "Avengers", "FDAT", ev => superPowerEv(ev, Color.INSTINCT, () => revealVillainDeckEv(ev, 1, cards => {
...
// Choose a Hero Class. Reveal the top card of your deck. If it's the Hero Class you named, draw it.
  c3: makeHeroCard("Doctor Strange", "Sift Futures", 4, u, 2, Color.INSTINCT | Color.RANGED, "Avengers", "D4T", ev => {
...
// [Ranged] {SACRIFICE}: Take another turn after this one. Don't play a card from the Villain Deck at the start of that turn.
  uc: makeHeroCard("Doctor Strange", "Invoke the Time Stone", 5, 2, u, Color.RANGED, "Avengers", "DT", ev => {
...
// {POWER Instinct} Reveal the top card of the Villain Deck. If it's a Master Strike, KO that Strike, you get +3 Attack, and put a card from the Bystander Deck on top of the Villain Deck.
  u2: makeHeroCard("Doctor Strange", "Bind Evil", 6, u, 4, Color.INSTINCT, "Avengers", "4AT", ev => superPowerEv(ev, Color.INSTINCT, () => revealVillainDeckEv(ev, 1, cards => {
...
// [Instinct] {SACRIFICE}: Guess the name of the top card of the Villain Deck, then reveal it. If you guessed right, draw six cards.
  ra: makeHeroCard("Doctor Strange", "1 In 14,000,065", 7, u, 5, Color.INSTINCT, "Avengers", "4T", ev => sacrificeEv(ev, Color.INSTINCT, () => {
...
// [Strength] {SACRIFICE}: You get +3 Attack. You may KO card from your hand or discard pile.
  c1: makeHeroCard("Bruce Banner", "Burst of Rage", 1, u, 1, Color.STRENGTH, "Avengers", "AT", ev => sacrificeEv(ev, Color.STRENGTH, () => {
    addAttackEvent(ev, 3);
    selectCardOptEv(ev, "Choose a card to KO", handOrDiscard(), c => KOEv(ev, c));
  })),
// {POWER Tech Strength} You get +2 Attack.
  c2: makeHeroCard("Bruce Banner", "Brains and Brawn", 3, u, 2, Color.STRENGTH | Color.TECH, "Avengers", "FDA", ev => superPowerLikelyEv(ev, [Color.TECH, Color.STRENGTH], () => addAttackEvent(ev, 2))),
// You may KO a Wound from you hand or discard pile. If you do, you get +2 Recruit.
  c3: makeHeroCard("Bruce Banner", "Hulkbuster Armor", 4, 2, u, Color.TECH, "Avengers", "FD4RT", ev => {
...
// {POWER Strength} You may gain a Wound. If you do, KO up to two other cards from your hand and/or discard pile.
  uc: makeHeroCard("Bruce Banner", "Hulk Gets Smashed", 5, u, 2, Color.STRENGTH, "Avengers", "DT", ev => superPowerEv(ev, Color.STRENGTH, () => gameState.wounds.withTop(c => chooseMayEv(ev, "Gain a wound", () => {
    gainEv(ev, c);
...
// {POWER Tech} You get +1 Attack for each Henchman in your Victory Pile.
  u2: makeHeroCard("Bruce Banner", "Crush Puny Weaklings", 6, u, 3, Color.TECH, "Avengers", "FAT", ev => superPowerLikelyEv(ev, Color.TECH, () => addAttackEvent(ev, playerState.victory.count(isHenchman)))),
...
// Shuffle the rest into a new deck.
  ra: makeHeroCard("Bruce Banner", "Reverse The Snap", 7, u, 5, Color.TECH, "Avengers", "T", ev => sacrificeEv(ev, Color.TECH, () => {
...
// {ENDGAME} This card makes Attack instead of Recruit.
  c1: makeHeroCard("Captain Marvel", "Infused By the Tesseract", 3, 1, 0, Color.RANGED, "Avengers", "FAT", [
...
// {ENDGAME} This card makes all Attack instead of Recruit.
  c2: makeHeroCard("Captain Marvel", "Return From the Stars", 4, 2, 0, Color.STRENGTH, "Avengers", "FD4RAT", ev => {
    superPowerCondLikelyEv(ev, Color.STRENGTH, n => {
      const amount = ev.source.printedRecruit + (n ? 2 : 0);
...
// If it was already the Endgame, you get +2 Attack.
  c3: makeHeroCard("Captain Marvel", "Turning Point", 5, u, 2, Color.STRENGTH | Color.RANGED, "Avengers", "DAT", ev => {
...
// If you had already drawn any cards this turn, draw two cards instead.
  uc: makeHeroCard("Captain Marvel", "Dawning Hope", 2, u, u, Color.RANGED, "Avengers", "DT", ev => drawEv(ev, pastEvents('DRAW').has(e => e.who === playerState) ? 2 : 1)),
// {POWER Ranged} You get +2 Attack.
  u2: makeHeroCard("Captain Marvel", "Moment of Destiny", 6, u, 4, Color.STRENGTH, "Avengers", "FD4A", ev => superPowerLikelyEv(ev, Color.RANGED, () => addAttackEvent(ev, 2))),
...
// {ENDGAME} Instead, you get +2 Attack for each.
  ra: makeHeroCard("Captain Marvel", "Time to End It", 8, u, 5, Color.RANGED, "Avengers", "DAT",
...
// {PATROL Sewers}: If it's empty, you get +1 Recruit.
  c1: makeHeroCard("Blade, Daywalker", "Where Monsters Lurk", 4, 2, u, Color.STRENGTH, "Marvel Knights", "D4RT", [
    ev => patrolCity('ROOFTOPS', () => drawEv(ev)),
    ev => patrolCity('SEWERS', () => addRecruitEvent(ev, 1)) ]),
// You may move a Villain to another city space. If another Villain is already there, swap them.
// {MOONLIGHT} You get +1 Attack.
  c2: makeHeroCard("Blade, Daywalker", "Ride By Moonlight", 5, u, 3, Color.TECH, "Marvel Knights", "AT", [
    ev => {
      selectCardOptEv(ev, "Choose a Villain to move", cityVillains(), v => {
        selectCardEv(ev, "Choose a new city space", cityAdjacent(v.location), dest => swapCardsEv(ev, v.location, dest));
      });
...
// {PATROL Sewers}: If it's empty, reveal the bottom card of your deck. You may KO it.
  uc: makeHeroCard("Blade, Daywalker", "Hunt High and Low", 3, u, 2, Color.INSTINCT, "Marvel Knights", "DT", [
...
// {MOONLIGHT} {BLOOD FRENZY}
  ra: makeHeroCard("Blade, Daywalker", "Creature of Dawn and Dask", 7, u, 4, Color.STRENGTH, "Marvel Knights", "D4AT", [
...
// {POWER Instinct} Instead, you get both.
  c1: makeHeroCard("Elsa Bloodstone", "Axe of the Slayer", 3, 0, 0, Color.INSTINCT, "Marvel Knights", "DRAT",
    ev => patrolCity('STREETS', () => {
      addRecruitEvent(ev, 2);
      superPowerLikelyEv(ev, Color.INSTINCT, () => addAttackEvent(ev, 2));
    }, () => {
      addAttackEvent(ev, 2);
      superPowerLikelyEv(ev, Color.INSTINCT, () => addRecruitEvent(ev, 2));
    })),
// {PATROL Streets}: If it's empty, you get +1 Attack.
// {POWER Tech} You get +1 Attack.
// GUN: 1
  c2: makeHeroCard("Elsa Bloodstone", "Silver Bullets", 4, u, 2, Color.TECH, "Marvel Knights", "GFD4AT", [ ev => patrolCity('STREETS', () => addAttackEvent(ev, 1)), ev => superPowerLikelyEv(ev, Color.TECH, () => addAttackEvent(ev, 1)) ]),
...
// {POWER Tech} If a Bystander is KO'd this way, you may also rescue that Bystander instead of putting it in the KO pile.
  uc: makeHeroCard("Elsa Bloodstone", "Stalk the Night Stalkers", 6, u, 3, Color.TECH, "Marvel Knights", "T",
...
// GUN: 1
  ra: makeHeroCard("Elsa Bloodstone", "Vengeance of the Bloodstone Gem", 8, 0, 4, Color.INSTINCT, "Marvel Knights", "G4RAT", [
    ...
    ev => superPowerEv(ev, ["Marvel Knights", "Marvel Knights"], () => bloodFrenzyEv(ev)) ]),
},
{
  name: "Morbius",
  team: "Marvel Knights",
// {MOONLIGHT} {BLOOD FRENZY}, gaining Recrcuit instead of Attack.
  c1: makeHeroCard("Morbius", "Mesmerize", 3, 2, u, Color.COVERT, "Marvel Knights", "FDR", ev => moonlightPower() && bloodFrenzyRecruitEv(ev)),
...
// TRANSFORMED by a blood transfusion from bats, Morbius the Living Vampire now has all vampiric strengths and only one desperate, thirsting weakness.
  c2: makeHeroCard("Morbius", "Insatiable Craving", 5, u, 2, Color.COVERT, "Marvel Knights", "DA", ev => superPowerEv(ev, Color.COVERT, () => bloodFrenzyEv(ev))),
...
// {MOONLIGHT} You may KO a Wound from your hand or discard pile. If you do, you get +2 Attack.
  uc: makeHeroCard("Morbius", "Scalded By Sunlight", 4, u, 2, Color.STRENGTH, "Marvel Knights", "D4AT", [
...
// {POWER Covert} {BLOOD FRENZY}, drawing that many cards instead of gaining Attack.
  ra: makeHeroCard("Morbius", "It's Morbin' Time!", 7, u, 3, Color.COVERT, "Marvel Knights", "T", ev => superPowerEv(ev, Color.COVERT, () => drawEv(ev, bloodFrenzyAmount()))),
},
{
...
// {MOONLIGHT} Draw a card.
  c1: makeHeroCard("Werewolf by Night", "Starlit Path", 2, u, 1, Color.INSTINCT, "Marvel Knights", "FDA", [
...
// {MOONLIGHT} Whenever you defeat a Villain or Mastermind this turn, you may KO one of your Heroes.
  c2: makeHeroCard("Werewolf by Night", "Snarling Fangs", 3, u, 2, Color.STRENGTH, "Marvel Knights", "DT", [
    ev => sunlightPower() && selectCardOptEv(ev, "Choose a Hero to put on the bottom of the Hero Deck", hqHeroes(), c => moveCardEv(ev, c, gameState.herodeck, true)),
...
// {MOONLIGHT} {BLOOD FRENZY}
// {POWER Instinct} Instead, you get both.
  uc: makeHeroCard("Werewolf by Night", "Release the Beast", 5, 0, 0, Color.INSTINCT, "Marvel Knights", "RAT",
    ev => superPowerEv(ev, Color.INSTINCT, () => {
      addRecruitEvent(ev, 3); bloodFrenzyEv(ev);
    }, () => {
      sunlightPower() && addRecruitEvent(ev, 3); moonlightPower() && bloodFrenzyEv(ev);
    })),
...
// {POWER Instinct} You get +2 Attack.
  ra: makeHeroCard("Werewolf by Night", "Track the Captives", 7, u, 5, Color.INSTINCT, "Marvel Knights", "DAT", [
    ...
    ev => superPowerLikelyEv(ev, Color.INSTINCT, () => addAttackEvent(ev, 2)) ]),
},
{
...
// {SUNLIGHT} You get +1 Attack.
// {POWER Ranged} You get +1 Attack.
  c2: makeHeroCard("Wong, Master of the Mystic Arts", "Searing Shards of Sunlight", 4, u, 2, Color.RANGED, "Marvel Knights", "FD4A", [ ev => sunlightPower() && addAttackEvent(ev, 1), ev => superPowerLikelyEv(ev, Color.RANGED, () => addAttackEvent(ev, 1)) ]),
// {PATROL Bridge}: If it's empty, draw two cards. If it's not, you get +5 Attack usable only to fight Villains on the Bridge.
  uc: makeHeroCard("Wong, Master of the Mystic Arts", "Seal the Rift", 5, u, 0, Color.COVERT, "Marvel Knights", "AT",
...
// {SUNLIGHT} You get +2 Attack.
  ra: makeHeroCard("Wong, Master of the Mystic Arts", "Face Your Demons", 8, u, 6, Color.RANGED, "Marvel Knights", "D4AT", [
    ev => {
      let done = false;
      const cond: (c: Card) => boolean = c => !done && c === gameState.bystanders.top
...
// GUN: 1
  c1: makeHeroCard("Apocalyptic Black Widow", "Humanity's Final Hope", 3, 2, u, Color.TECH, "Guardians of the Multiverse", "GFD4RT",
    ev => playerState.victory.count(isBystander) >= 4 && addRecruitEvent(ev, 2)),
// Draw a card.
// You may have a Villain capture a Bystander.
// GUN: 1
  c2: makeHeroCard("Apocalyptic Black Widow", "Plant Hidden Asset", 4, 1, u, Color.COVERT, "Guardians of the Multiverse", "GF4T", [
    ev => drawEv(ev),
    ev => selectCardOptEv(ev, "Choose a Villain to capture a Bystander", villains(), v => captureEv(ev, v))
  ]),
// {POWER Tech} You get +2 Attack.
  c3: makeHeroCard("Apocalyptic Black Widow", "Precision Strike", 5, u, 3, Color.TECH, "Guardians of the Multiverse", "FDA", ev => superPowerLikelyEv(ev, Color.TECH, () => addAttackEvent(ev, 2))),
// Draw a card.
// {POWER Covert} {LIBERATE 3}
// GUN: 1
  uc: makeHeroCard("Apocalyptic Black Widow", "Relentless", 2, u, 0, Color.COVERT, "Guardians of the Multiverse", "GFDA", [ ev => drawEv(ev), ev => superPowerEv(ev, Color.COVERT, () => liberateEv(ev, 3)) ]),
// {WHAT IF} {LIBERATE 4}
  u2: makeHeroCard("Apocalyptic Black Widow", "The Last Avenger", 6, u, 3, Color.TECH, "Guardians of the Multiverse", "F4A", ev => whatIfEv(ev, () => liberateEv(ev, 4))),
// <b>Liberate</b> equal to the number of Bystanders in your Victory Pile.
// GUN: 1
  ra: makeHeroCard("Apocalyptic Black Widow", "Time to Save the Multiverse", 8, u, 4, Color.COVERT, "Guardians of the Multiverse", "GF4AT",
...
// {WHAT IF} You get +2 Recruit and +2 Attack.
  c1: makeHeroCard("Captain Carter", "Super Soldier Serum", 2, 0, 0, Color.STRENGTH, "Guardians of the Multiverse", "FDRA", ev => whatIfEv(ev, () => {
    addRecruitEvent(ev, 2);
    addAttackEvent(ev, 2);
  })),
// You get +1 Recruit for each different printed Recruit number among all your Heroes.
// <i>(1+ is the same printed number as 1.)</i>
  c2: makeHeroCard("Captain Carter", "Wartime Logistics", 3, 1, u, Color.INSTINCT, "Guardians of the Multiverse", "RT", ev => {
...
// <i>(1+ is the same printed number as 1.)</i>
  c3: makeHeroCard("Captain Carter", "Coordinated Assault", 4, u, 1, Color.TECH, "Guardians of the Multiverse", "4AT", ev => {
...
// Once per turn, when a player gains a Wound, you may reveal this card to return that Wound to the Wound Stack. If you do, the player whose turn it is gets {LIBERATE 3}.
  uc: makeHeroCard("Captain Carter", "The Shield of Britain", 5, u, 3, Color.TECH, "Guardians of the Multiverse", "T", [], { trigger:
...
// To play this, you must put another card from your hand on top of your deck.
  u2: makeHeroCard("Captain Carter", "Give Them All We've Got", 6, u, 5, Color.STRENGTH, "Guardians of the Multiverse", "FT", [], { playCost: 1, playCostType: "TOPDECK" }),
// You get +1 Recruit for each different printed Recruit number among all your Heroes.
// You get +1 Attack for each different printed Attack number among all your Heroes.
// <i>(1+ is the same printed number as 1.)</i>
  ra: makeHeroCard("Captain Carter", "Icon of Hope", 8, 2, 4, Color.STRENGTH, "Guardians of the Multiverse", "D4RAT", [
...
// [Instinct] {SOULBIND} You get +Recruit equal to that Villain's printed VP.
  c1: makeHeroCard("Doctor Strange Supreme", "Seize Infernal Power", 3, 2, u, Color.INSTINCT, "Guardians of the Multiverse", "FDRT", ev => {
    soulbindEv(ev, Color.INSTINCT, c => addRecruitEvent(ev, c.vp));
  }),
// [Ranged] {SOULBIND} You get +Attack equal to that Villain's printed VP.
  c2: makeHeroCard("Doctor Strange Supreme", "Summon Demon Minions", 4, u, 2, Color.RANGED, "Guardians of the Multiverse", "FD4AT", ev => {
...
// {WHAT IF} You get +2 Attack and you may KO a Wound from your hand or from any player's discard pile.
  c3: makeHeroCard("Doctor Strange Supreme", "Wards of the Vishanti", 5, u, 3, Color.RANGED, "Guardians of the Multiverse", "DAT", ev => whatIfEv(ev, () => {
    addAttackEvent(ev, 2);
...
// [Instinct] {SOULBIND a Bystander or Villain} You get +2 Attack. If it's a Special Bystander, you may do its Rescue effect.
  uc: makeHeroCard("Doctor Strange Supreme", "To Save Christine", 2, u, 0, Color.INSTINCT, "Guardians of the Multiverse", "DAT", [ ev => drawEv(ev), ev => {
...
// Reveal the top three cards of your deck. Draw one of them, KO one, and put one back.
  u2: makeHeroCard("Doctor Strange Supreme", "Break the Absolute Point in Time", 6, u, u, Color.INSTINCT, "Guardians of the Multiverse", "FT", ev => {
...
// Draw a card.
// {POWER Covert} You get +2 Recruit.
  c1: makeHeroCard("Gamora, Destroyer of Thanos", "Assassin's Stealth", 2, 0, u, Color.COVERT, "Guardians of the Multiverse", "FDR", [ ev => drawEv(ev), ev => superPowerLikelyEv(ev, Color.COVERT, () => addRecruitEvent(ev, 2)) ]),
// Draw two cards. Then put a card from your hand on top of your deck.
  c2: makeHeroCard("Gamora, Destroyer of Thanos", "Tactical Insight", 3, u, 1, Color.COVERT, "Guardians of the Multiverse", "FT", [
    ev => drawEv(ev, 2),
...
// You get +1 Attack for each card you drew this turn.
  c3: makeHeroCard("Gamora, Destroyer of Thanos", "Wield the Blade of Thanos", 4, u, 1, Color.INSTINCT, "Guardians of the Multiverse", "F4AT", ev => {
...
// [Instinct] {SOULBIND} KO a card from your hand or discard pile.
  u2: makeHeroCard("Gamora, Destroyer of Thanos", "Destroy an Infinity Stone", 6, u, 3, Color.INSTINCT, "Guardians of the Multiverse", "FT", ev => {
...
// Guardians of the Multiverse {SOULBIND six Villains} You get <b>+&infin;</b> Attack, usable only for a single fight.
  ra: makeHeroCard("Gamora, Destroyer of Thanos", "The Infinity Crusher", 8, u, 5, Color.TECH, "Guardians of the Multiverse", "FAT", ev => {
...
// You get +1 Recruit for each different Villain Group in your Victory Pile.
  c1: makeHeroCard("Killmonger, Spec Ops", "Hunt New Prey", 2, 1, u, Color.STRENGTH | Color.TECH, "Guardians of the Multiverse", "FDRT", ev => {
...
// {POWER Tech Strength} You get +3 Attack.
  c2: makeHeroCard("Killmonger, Spec Ops", "No Matter the Price", 4, u, 2, Color.TECH, "Guardians of the Multiverse", "FD4A", ev => superPowerLikelyEv(ev, [Color.TECH, Color.STRENGTH], () => addAttackEvent(ev, 3))),
// {POWER Strength} You get +1 Attack for each different Villain Group in your Victory Pile.
  c3: makeHeroCard("Killmonger, Spec Ops", "Violence Leaves Scars", 5, u, 3, Color.STRENGTH, "Guardians of the Multiverse", "FAT", ev => {
...
// {WHAT IF} {LIBERATE 3}
  uc: makeHeroCard("Killmonger, Spec Ops", "Hostage Rescue", 3, u, 2, Color.STRENGTH, "Guardians of the Multiverse", "FDA", ev => whatIfEv(ev, () => liberateEv(ev, 3))),
// Each Villain worth 3 VP or more captures a Bystander.
// {POWER Tech} {LIBERATE 2}
  u2: makeHeroCard("Killmonger, Spec Ops", "Plot a Betrayal", 6, u, 4, Color.TECH, "Guardians of the Multiverse", "FD4AT", [ ev => {
    villains().limit(c => c.vp >= 3).each(c => captureEv(ev, c));
  }, ev => superPowerEv(ev, Color.TECH, () => liberateEv(ev, 2)) ]),
...
// {POWER Strength} {LIBERATE 2} for each Mastermind Tactic in your Victory Pile.
  ra: makeHeroCard("Killmonger, Spec Ops", "I'm the King, Baby!", 7, u, 4, Color.STRENGTH, "Guardians of the Multiverse", "D4AT", [
...
},
{
  ...
  team: "Guardians of the Multiverse",
// To play this, you must put another card from your hand on top of your deck.
  c1: makeHeroCard("Party Thor", "Forecast Says Thunder", 2, 3, u, Color.RANGED, "Guardians of the Multiverse", "FDT", [], { playCost: 1, playCostType: "TOPDECK" }),
// Whenever you recruit a Hero that costs 5 or more this turn, you get +3 Attack.
  c2: makeHeroCard("Party Thor", "Worthy Challenge", 3, u, 2, Color.STRENGTH, "Guardians of the Multiverse", "FDAT", ev => {
...
// Whenever you recruit a Hero that costs 5 or more this turn, reveal the top card of your deck and you may KO it.
  c3: makeHeroCard("Party Thor", "Destructive Feast", 5, 3, u, Color.STRENGTH, "Guardians of the Multiverse", "T", ev => {
...
// {POWER Ranged} {XDRAMPAGE Party}. If any players gained a Wound this way, you get +3 Attack.
  uc: makeHeroCard("Party Thor", "Asgardian Rager", 5, u, 3, Color.RANGED, "Guardians of the Multiverse", "AT", ev => {
    let wounded = false;
    superPowerEv(ev, Color.RANGED, () => xdRampageEv(ev, "Party", () => wounded = true));
    cont(ev, () => wounded && addAttackEvent(ev, 3));
  }),
// {WHAT IF} You get +Attack equal to the cost of the Hero you revealed this way.
  u2: makeHeroCard("Party Thor", "Only Son", 6, u, 3, Color.STRENGTH, "Guardians of the Multiverse", "FAT", ev => whatIfEv(ev, c => addAttackEvent(ev, c.cost))),
// Whenever you recruit a Hero that costs 5 or more this turn, you get +Attack equal to that Hero's cost.
  ra: makeHeroCard("Party Thor", "Worthy of the Lightning", 7, 5, 0, Color.RANGED, "Guardians of the Multiverse", "AT", ev => {
...
// GUN: 1
  c1: makeHeroCard("Star-Lord T’Challa", "Fight or Flight", 2, u, 0, Color.STRENGTH | Color.COVERT, "Guardians of the Multiverse", "GDAT", [ ev => {
    chooseOneEv(ev, "Choose a class to get Empowered by", ["Strength", () => empowerEv(ev, Color.STRENGTH)], ["Covert", () => empowerEv(ev, Color.COVERT)]);
  }, ev => superPowerEv(ev, [Color.STRENGTH, Color.COVERT], () => drawEv(ev)) ]),
// {WHAT IF} You get +3 Recruit.
  c2: makeHeroCard("Star-Lord T’Challa", "Interstellar Adventures", 3, 2, u, Color.COVERT | Color.TECH, "Guardians of the Multiverse", "FDR", ev => whatIfEv(ev, () => addRecruitEvent(ev, 3))),
// Look at the top two cards of your deck. Discard any number of them and put the rest back in any order.
// GUN: 1
  c3: makeHeroCard("Star-Lord T’Challa", "Plan the Heist", 4, u, 2, Color.INSTINCT | Color.COVERT, "Guardians of the Multiverse", "GD4T", ev => {
    revealPlayerDeckEv(ev, 2, cards => selectObjectsAnyEv(ev, "Choose cards to discard", cards, c => discardEv(ev, c)));
  }),
// {WHAT IF} You may KO a card from your hand or discard pile.
  uc: makeHeroCard("Star-Lord T’Challa", "Unexpected Exit", 5, u, 3, Color.STRENGTH | Color.INSTINCT, "Guardians of the Multiverse", "FT", ev => whatIfEv(ev, () => KOHandOrDiscardEv(ev, undefined))),
// {WHAT IF} You get <b>Empowered</b> by the Hero Classes of the card you revealed this way.
// GUN: 1
  u2: makeHeroCard("Star-Lord T’Challa", "Cross the Multiverse", 6, u, 4, Color.STRENGTH | Color.RANGED, "Guardians of the Multiverse", "G4AT", ev => whatIfEv(ev, c => empowerEv(ev, c.color))),
// Choose any number of Heroes in the HQ. Put them on the bottom of the Hero Deck.
// You get <b>Empowered</b> by multicolored cards.
  ra: makeHeroCard("Star-Lord T’Challa", "Colliding Dreams", 7, u, 4, Color.TECH | Color.RANGED, "Guardians of the Multiverse", "4AT", [ ev => {
...
// Draw a card. Then put a card from your hand on top of your deck.
// {POWER Covert} You get +1 Recruit.
  c1: makeHeroCard("Uatu, The Watcher", "Diverging Timestreams", 2, 1, u, Color.COVERT, "Guardians of the Multiverse", "FDRT", [
    ev => drawEv(ev),
    ev => selectCardEv(ev, "Choose a card to topdeck", playerState.hand.deck, c => moveCardEv(ev, c, playerState.deck)),
    ev => superPowerLikelyEv(ev, Color.COVERT, () => addRecruitEvent(ev, 1)) ]),
// {WHAT IF} You may KO a card from your hand or discard pile.
  c2: makeHeroCard("Uatu, The Watcher", "Another Dimension Crumbles", 3, 2, u, Color.COVERT, "Guardians of the Multiverse", "FDT", ev => whatIfEv(ev, () => KOHandOrDiscardEv(ev, undefined))),
// {WHAT IF} You get +2 Attack.
  c3: makeHeroCard("Uatu, The Watcher", "Break the Oath", 4, u, 2, Color.RANGED, "Guardians of the Multiverse", "FD4A", ev => whatIfEv(ev, () => addAttackEvent(ev, 2))),
// {POWER Covert} Choose a Hero Name. You are <b>Empowered</b> by that Hero Name.
  uc: makeHeroCard("Uatu, The Watcher", "Anoint a Champion", 5, u, 2, Color.COVERT, "Guardians of the Multiverse", "FDAT", ev => {
...
// [Ranged] {SOULBIND} You get +2 Attack and you may do that Villain's Fight effect.
  u2: makeHeroCard("Uatu, The Watcher", "History Repeats", 6, u, 3, Color.RANGED, "Guardians of the Multiverse", "FDAT", ev => {
...
// {WHAT IF} Choose a Team. (e.g. Guardians of the Multiverse, X-Men, Avengers) You are <b>Empowered</b> by that Team.
  ra: makeHeroCard("Uatu, The Watcher", "Convoke the Guardians", 7, u, 5, Color.RANGED, "Guardians of the Multiverse", "AT", ev => whatIfEv(ev, () => {
...
// {ANTICS} You get +2 Attack.
  c1: makeHeroCard("Ant Army", "Antagonize", 2, u, 1, Color.INSTINCT, u, "FDA", ev => anticsEv(ev, () => addAttackEvent(ev, 2)), { sizeChanging: Color.INSTINCT }),
// {SIZECHANGING TECH}
// {ANTICS} Draw a card.
  c2: makeHeroCard("Ant Army", "Anticipate", 4, 2, u, Color.TECH, u, "FD4", ev => anticsEv(ev, () => drawEv(ev)), { sizeChanging: Color.TECH }),
// {HEIST} Draw a card.
  c3: makeHeroCard("Ant Army", "Up the Ante", 1, u, 1, Color.INSTINCT, u, "F", [], { heist: ev => drawEv(ev) }),
// {USIZECHANGING TECH 3}
// {POWER Tech} You get +3 Attack.
  uc: makeHeroCard("Ant Army", "Anti-Tank Weapons", 6, u, 2, Color.TECH, u, "FDA", ev => superPowerLikelyEv(ev, Color.TECH, () => addAttackEvent(ev, 3)), { uSizeChanging: { color: Color.TECH, amount: 3 } }),
// {USIZECHANGING TECH 3}
// {ANTICS} You get +2 Recruit and +2 Attack.
  u2: makeHeroCard("Ant Army", "Antiproton Experiments", 5, 1, 1, Color.TECH, u, "FDRA", ev => anticsEv(ev, () => {
    addRecruitEvent(ev, 2);
    addAttackEvent(ev, 2);
  }), { uSizeChanging: { color: Color.TECH, amount: 3 } }),
// {USIZECHANGING TECH 5}
...
// {HEIST} You get +2 Attack. If the card revealed from the Villain Deck is a Scheme Twist, you get another +2 Attack and you may shuffle that deck.
  ra: makeHeroCard("Ant Army", "Revolutionary Anthem", 9, u, 4, Color.TECH, u, "D4AT", ev => anticsEv(ev, () => addAttackEvent(ev, 2)), { uSizeChanging: { color: Color.TECH, amount: 5 }, heist: ev => {
    addAttackEvent(ev, 2);
    if (isTwist(ev.what)) {
      addAttackEvent(ev, 2);
      chooseMayEv(ev, "Shuffle the Villain Deck", () => gameState.villaindeck.shuffle());
...
// {ANTICS} You get +2 Recruit.
  c1: makeHeroCard("Ant-Man", "Hitch a Ride", 2, 1, u, Color.COVERT, "Avengers", "FDR", ev => anticsEv(ev, () => addRecruitEvent(ev, 2)), { sizeChanging: Color.COVERT }),
// {SIZECHANGING STRENGTH}
// Reveal the top card of your deck. If it's [Strength] or has <b>Size-Changing</b>, draw it.
  c2: makeHeroCard("Ant-Man", "Look Out for the Little Guy!", 3, u, 1, Color.STRENGTH, "Avengers", "T", ev => drawIfEv(ev, c => isColor(Color.STRENGTH)(c) || !!c.sizeChanging || !!c.uSizeChanging), { sizeChanging: Color.STRENGTH }),
// {SIZECHANGING COVERT}
// {POWER Covert} All Villains and the Mastermind get -1 Attack this turn.
  c3: makeHeroCard("Ant-Man", "Shrink Away", 4, u, 2, Color.COVERT, "Avengers", "FD4T", ev => superPowerEv(ev, Color.COVERT, () => addTurnMod('defense', isEnemy, -1)), { sizeChanging: Color.COVERT }),
// {USIZECHANGING STRENGTH 3}
// {ANTICS} You may KO a card from your hand or discard pile.
  uc: makeHeroCard("Ant-Man", "Bug Swarm", 5, 2, u, Color.STRENGTH, "Avengers", "FDT", ev => anticsEv(ev, () => KOHandOrDiscardEv(ev, undefined)), { uSizeChanging: { color: Color.STRENGTH, amount: 3 } }),
...
// You get +1 Attack for each card you played this turn that's [Strength] and/or has <b>Size-Changing</b>.
  ra: makeHeroCard("Ant-Man", "Giant-Man", 9, u, 6, Color.STRENGTH, "Avengers", "AT", ev => {
...
// {POWER Strength} You may defeat a Villain worth 2 VP or less.
  c1: makeHeroCard("Cassie Lang", "Colossal Stomp", 5, u, 2, Color.STRENGTH, "Avengers", "FDT", ev => superPowerLikelyEv(ev, Color.STRENGTH, () => selectCardOptEv(ev, 
...
// Choose a player. If that player reveals a card that costs 5 or more, that player draws a card.
  c2: makeHeroCard("Cassie Lang", "Giant Hug", 4, 2, u, Color.STRENGTH, "Avengers", "D4T", ev => {
...
// To play this, you must discard a card. Then, if you have a Villain in your Victory Pile worth 2 VP or less, draw a card.
  c3: makeHeroCard("Cassie Lang", "Start Small", 2, 2, u, Color.TECH, "Avengers", "DT", ev => {
...
// {POWER Strength} You may do the Fight effect of a Villain in your Victory Pile worth 2 VP or less.
  uc: makeHeroCard("Cassie Lang", "Learn from the Past", 6, u, 3, Color.STRENGTH, "Avengers", "DT", ev => superPowerLikelyEv(ev, Color.STRENGTH, () => selectCardOptEv(ev,
...
// {POWER Tech} Reveal the top card of the Villain Deck. If it's a Bystander, rescue it. If it's a Villain worth 2 VP or less, you may fight it this turn. If you rescue or defeat that card, don't play a card from the Villain Deck next turn.
  u2: makeHeroCard("Cassie Lang", "Quantum Beacon", 5, u, 3, Color.TECH, "Avengers", "DT", ev => superPowerEv(ev, Color.TECH, () => revealVillainDeckEv(ev, 1, cards => cards.each(c => {
    if (isBystander(c)) {
      rescueEv(ev, c);
...
// You get +1 Attack for each Villain worth 2 VP or less in your Victory Pile.
  ra: makeHeroCard("Cassie Lang", "Inspire Revolution", 9, u, 5, Color.STRENGTH, "Avengers", "DAT", ev => addAttackEvent(ev,
...
// When you draw a new hand this turn, draw an extra card.
  c1: makeHeroCard("Freedom Fighters", "Mystics", 3, 1, u, Color.RANGED, u, "FT", ev => addEndDrawMod(1)),
// {STREETS CONQUEROR 1}
// Draw a card.
  c2: makeHeroCard("Freedom Fighters", "Steel Warrior", 4, u, 1, Color.INSTINCT, u, "F4A", [ ev => heroConquerorEv(ev, 'STREETS', 1), ev => drawEv(ev) ]),
// {BRIDGE CONQUEROR 1}
// {POWER Ranged} You get +2 Attack.
  c3: makeHeroCard("Freedom Fighters", "Xolum", 5, u, 2, Color.RANGED, u, "FDA", [ ev => heroConquerorEv(ev, 'BRIDGE', 1), ev => superPowerLikelyEv(ev, Color.RANGED, () => addAttackEvent(ev, 2)) ]),
// {POWER Ranged} Choose Recruit or Attack. Then {EXPLORE} You get the printed value of the icon you chose on the Found Hero.
  uc: makeHeroCard("Freedom Fighters", "Quaz", 6, 2, 2, Color.RANGED, u, "DRAT", ev => superPowerEv(ev, Color.RANGED, () => chooseOptionEv(ev, "Choose an icon", [{l:"Recruit",v:hasRecruitIcon},{l:"Attack",v:hasAttackIcon}], f =>
...
// {POWER Instinct} You may KO the card you drew this way.
  u2: makeHeroCard("Freedom Fighters", "Veb", 2, u, 1, Color.INSTINCT, u, "D4T", ev => {
...
// {POWER Instinct} You may choose a player to gain the Found Hero.
  ra: makeHeroCard("Freedom Fighters", "Freedom Forever", 7, u, 5, Color.INSTINCT, u, "T", ev => exploreEv(ev, c => {
...
// {POWER Ranged} {EXPLORE} You get +Attack equal to the Found Hero's printed Attack.
  c1: makeHeroCard("Janet Van Dyne", "Prepare for War", 4, u, 2, Color.RANGED, u, "FD4AT", ev => superPowerEv(ev, Color.RANGED, () => exploreEv(ev, c => c.printedAttack && addAttackEvent(ev, c.printedAttack)))),
// {POWER Covert}  {EXPLORE} You get +Recruit equal to the Found Hero's printed Recruit.
  c2: makeHeroCard("Janet Van Dyne", "Search for Peace", 3, 2, u, Color.COVERT, u, "FDRT", ev => superPowerEv(ev, Color.COVERT, () => exploreEv(ev, c => c.printedRecruit && addRecruitEvent(ev, c.printedRecruit)))),
// {SIZECHANGING COVERT}
// {POWER Covert} {EXPLORE} Then you get +1 Attack for each time you explored this turn.
  c3: makeHeroCard("Janet Van Dyne", "Wasp of Another Generation", 5, u, 2, Color.COVERT, u, "FDAT", ev => superPowerEv(ev, Color.COVERT, () => exploreEv(ev, () => {
...
// When you play this, put it on top of the Hero Deck or KO it.
  uc: makeHeroCard("Janet Van Dyne", "Quantum Contradiction", 6, 4, 4, Color.RANGED, u, "F4T", ev => {
...
// {POWER Covert Covert} You get +2 Attack.
  u2: makeHeroCard("Janet Van Dyne", "Subatomic Size", 2, u, 0, Color.COVERT, u, "DA", [ ev => drawEv(ev), ev => superPowerLikelyEv(ev, [Color.COVERT, Color.COVERT], () => addAttackEvent(ev, 2)) ], { uSizeChanging: { color: Color.COVERT, amount: 2 } }),
// {EXPLORE}
// {POWER Covert} You get +Recruit equal to the Found Hero's printed Recruit and +Attack equal to its printed Attack.
  ra: makeHeroCard("Janet Van Dyne", "Finally Found You", 8, 4, 4, Color.COVERT, u, "4RAT", ev => superPowerEv(ev, Color.COVERT, () => exploreEv(ev, c => {
...
// You may move a Villain to an adjacent city space. If another Villain is already there, swap them.
// {POWER Instinct} You get +2 Attack.
  c1: makeHeroCard("Jentorra", "Hit and Run", 3, 2, 0, Color.INSTINCT, u, "DAT", [ ev => {
    selectCardOptEv(ev, "Choose a Villain to move", cityVillains(), v => {
      selectCardEv(ev, "Choose a new city space", cityAdjacent(v.location), dest => swapCardsEv(ev, v.location, dest));
    });
  }, ev => superPowerLikelyEv(ev, Color.INSTINCT, () => addAttackEvent(ev, 2)) ]),
...
// If there are no Villains on the Rooftops, draw a card.
  c2: makeHeroCard("Jentorra", "Take the High Ground", 2, u, 1, Color.STRENGTH, u, "DT", [ ev => heroConquerorEv(ev, 'BRIDGE', 1), ev => {
    withCity('ROOFTOPS', d => isCityEmpty(d) && drawEv(ev));
  } ]),
// {POWER Strength} {SEWERS CONQUEROR 2}
  c3: makeHeroCard("Jentorra", "Unite the Oppressed", 4, u, 2, Color.STRENGTH, u, "FD4A", ev => superPowerEv(ev, Color.STRENGTH, () => heroConquerorEv(ev, 'SEWERS', 2))),
// {POWER Instinct} {EXPLORE} If the Found Hero is [Instinct] or has no team icon, you get +2 Recruit.
  uc: makeHeroCard("Jentorra", "Find Your Courage", 5, 3, u, Color.INSTINCT, u, "FDRT", ev => superPowerEv(ev, Color.INSTINCT, () => exploreEv(ev, c => {
    (isColor(Color.INSTINCT)(c) || !c.team) && addRecruitEvent(ev, 2);
  }))),
// {POWER Strength} {EXPLORE} You get +Attack equal to the Found Hero's cost.
  u2: makeHeroCard("Jentorra", "Lead Powerful Allies", 6, u, 2, Color.STRENGTH, u, "FDAT", ev => superPowerEv(ev, Color.STRENGTH, () => exploreEv(ev, c => {
...
// You get +1 Attack for each Villain worth 4 VP or more and each Mastermind Tactic in your Victory Pile.
  ra: makeHeroCard("Jentorra", "Conquer the Conqueror", 7, u, 5, Color.INSTINCT, u, "4AT", [ ev => heroConquerorEv(ev, 'BRIDGE', 1), ev => {
...
// {HEIST} You get +2 Recruit.
  c1: makeHeroCard("Scott Lang, Cat Burglar", "Petty Larceny", 1, 1, u, Color.COVERT, "Crime Syndicate", "FDR", [], { heist: ev => addRecruitEvent(ev, 2) }),
// {HEIST} You get +2 Attack.
  c2: makeHeroCard("Scott Lang, Cat Burglar", "Shocking Support", 4, u, 2, Color.RANGED, "Crime Syndicate", "FD4A", [], { heist: ev => addAttackEvent(ev, 2) }),
// {HEIST} You may move a Villain to an empty city space. If you do, KO one of your Heroes.
  c3: makeHeroCard("Scott Lang, Cat Burglar", "X-Con Security Van", 5, u, 2, Color.TECH, "Crime Syndicate", "DT", [], { heist: ev => {
...
// {HEIST} Rescue a Bystander.
  uc: makeHeroCard("Scott Lang, Cat Burglar", "Anything for Cassie", 2, 1, 1, Color.INSTINCT, "Crime Syndicate", "DT", ev => {
...
// {HEIST} You get +1 Attack for each different cost of card you have.
  u2: makeHeroCard("Scott Lang, Cat Burglar", "Putting a Crew Together", 6, u, 3, Color.STRENGTH, "Crime Syndicate", "FAT", [], { heist: ev => {
...
// {HEIST} You get +4 Attack. If the card revealed from the Villain Deck is a Master Strike, KO it and put a card from the Bystander Deck on top of the Villain Deck.
  ra: makeHeroCard("Scott Lang, Cat Burglar", "The Big Score", 8, u, 4, Color.COVERT, "Crime Syndicate", "4AT", [], { heist: ev => {
    addAttackEvent(ev, 4);
...
// {POWER Ranged} You get +1 Recruit and +1 Attack.
  c1: makeHeroCard("Wasp", "Flitting Sting", 3, 1, 1, Color.RANGED, "Avengers", "FRA", ev => superPowerEv(ev, Color.RANGED, () => (addRecruitEvent(ev, 1), addAttackEvent(ev, 1))), { sizeChanging: Color.RANGED }),
// {SIZECHANGING TECH}
// You get +1 Recruit for each other card you have with a "+" symbol in its Recruit icon.
  c2: makeHeroCard("Wasp", "Master Physicist", 4, 2, u, Color.TECH, "Avengers", "D4RT", ev => addRecruitEvent(ev, revealable().limit(isNot(ev.source)).count(hasFlag("R"))), { sizeChanging: Color.TECH }),
// {SIZECHANGING RANGED}
// You get +1 Attack for each other card you have with a "+" symbol in its Attack icon.
  c3: makeHeroCard("Wasp", "Positive Ions", 5, u, 2, Color.RANGED, "Avengers", "DAT", ev => addAttackEvent(ev, revealable().limit(isNot(ev.source)).count(hasFlag("A"))), { sizeChanging: Color.RANGED }),
// {SIZECHANGING RANGED}
// If this is the first card you played this turn, you get +1 Attack.
  uc: makeHeroCard("Wasp", "Follow My Lead", 2, u, 1, Color.RANGED, "Avengers", "DAT", ev => turnState.cardsPlayed.size === 0 && addAttackEvent(ev, 1), { sizeChanging: Color.RANGED }),
// {USIZECHANGING TECH 3}
// When you draw a new hand this turn, draw an extra card.
// {HEIST} You get +3 Attack.
  u2: makeHeroCard("Wasp", "Infiltrate", 6, u, 1, Color.TECH, "Avengers", "AT", ev => addEndDrawMod(1), { uSizeChanging: { color: Color.TECH, amount: 3 }, heist: ev => addAttackEvent(ev, 3) }),
// {USIZECHANGING RANGED 5}
// You get +1 Recruit for each other card you have with a "+" symbol in its Recruit icon.
// You get +1 Attack for each other card you have with a "+" symbol in its Attack icon.
  ra: makeHeroCard("Wasp", "Hope Returns", 9, 4, 4, Color.RANGED, "Avengers", "D4RAT", [ 
...
// {CYBER-MOD RANGED RANGED RANGED} Instead you +3 Attack.
  c1: makeHeroCard("Doctor Doom 2099", "Doomblast", 3, u, 2, Color.RANGED, u, "FDAT", ev => cyberModEv(ev, Color.RANGED, 1, n => addAttackEvent(ev, n >= 3 ? 3 : 1))),
// You may send this and a card from your hand or discard pile {UNDERCOVER}. If you do, you get +1 Recruit.
  c2: makeHeroCard("Doctor Doom 2099", "Subvert This New Future", 3, 2, u, Color.RANGED, u, "FDRT", ev => {
...
// {POWER Tech} You may look at the top three cards of your deck. If you do, send one of them {UNDERCOVER} and put the rest back in any order.
  uc: makeHeroCard("Doctor Doom 2099", "Flesh-Grafted Doombots", 6, u, 3, Color.TECH, u, "DT", ev => superPowerEv(ev, Color.TECH, () => revealPlayerDeckEv(ev, 3, cards => {
...
// {CYBER-MOD RANGED RANGED} If you haven't taken any extra turns this game, you may take another turn after this one. Don't play a card from the Villain Deck at the start of that turn.
  ra: makeHeroCard("Doctor Doom 2099", "Tear Through Time Itself", 8, u, 6, Color.RANGED, u, "DT", [
...
// {CYBER-MOD TECH TECH} Draw a card.
  c1: makeHeroCard("Ghost Rider 2099", "Cyber-Specter", 3, 2, u, Color.TECH, "Marvel Knights", "FDRT", [ ev => cyberModEv(ev, Color.TECH, 1, () => addRecruitEvent(ev, 1)), ev => cyberModEv(ev, Color.TECH, 2, () => drawEv(ev)) ]),
// You may send this and a card from the HQ {UNDERCOVER}. If you do, you get +2 Attack.
// {CYBER-MOD TECH TECH TECH} You get +2 Attack.
  c2: makeHeroCard("Ghost Rider 2099", "Hell Ride", 4, u, 2, Color.TECH, "Marvel Knights", "FD4AT", [ ev => {
...
// {TEAMPOWER Marvel Knights} You may KO a Henchman from your Victory Pile. If you do, you get +2 Attack and you may do that Henchman's Fight effect.
  uc: makeHeroCard("Ghost Rider 2099", "Death Beyond Death", 5, u, 3, Color.COVERT, "Marvel Knights", "DAT", ev => superPowerLikelyEv(ev, "Marvel Knights", () => selectCardOptEv(ev, "Choose a Henchman to KO", playerState.victory.limit(isHenchman), c => {
    KOEv(ev, c);
    addAttackEvent(ev, 2);
    pushEffects(ev, c, 'fight', c.fight);
  }))),
...
// {CYBER-MOD TECH} {FATED FUTURE} and you get +1 Attack for each [Tech] card in your Victory Pile.
  ra: makeHeroCard("Ghost Rider 2099", "Infernal Chainsaw", 7, u, 4, Color.TECH, "Marvel Knights", "D4AT", [ ev => {
...
// <b>Cyber-Mod 4 Wounds</b>: Instead you get +2 Attack.
  c1: makeHeroCard("Hulk 2099", "Rage Incarnate", 3, u, 2, Color.INSTINCT, "Marvel Knights", "FD4AT", ev => {
...
// {POWER Strength} You may send a Hero from your hand or discard pile {UNDERCOVER} instead.
  c2: makeHeroCard("Hulk 2099", "Push Pain Under the Surface", 4, 2, u, Color.STRENGTH, "Marvel Knights", "D4T", ev => superPowerCondLikelyEv(ev, Color.STRENGTH, n => {
    const options: Filter<Card> = n ? c => isWound(c) || isHero(c): isWound;
...
// {POWER Tech} {FATED FUTURE}
  uc: makeHeroCard("Hulk 2099", "Massive Gamma Detonation", 6, u, 5, Color.TECH, "Marvel Knights", "FDT", [ ev => {
  ...
  }, ev => superPowerEv(ev, Color.TECH, () => fatedFutureEv(ev)) ]),
...
// <b>Cyber-Mod Wound</b>: You get +1 Attack for each Wound in your Victory Pile.
  ra: makeHeroCard("Hulk 2099", "Cataclysmic Frenzy", 8, u, 4, Color.STRENGTH, "Marvel Knights", "D4AT", [ ev => {
...
// {POWER Instinct} Draw a card from the bottom of your deck.
  c1: makeHeroCard("Ravage 2099", "Down in the Dregs", 3, 2, u, Color.INSTINCT, "Marvel Knights", "FD", ev => superPowerEv(ev, Color.INSTINCT, () => drawBottomEv(ev))),
// {POWER Strength} You get +2 Attack and {FATED FUTURE}.
  c2: makeHeroCard("Ravage 2099", "Toxic Mutations", 5, u, 2, Color.STRENGTH, "Marvel Knights", "FDA", ev => {
    superPowerEv(ev, Color.STRENGTH, () => { addAttackEvent(ev, 2); fatedFutureEv(ev); });
  }),
// Reveal the top two cards of the Villain Deck and put them back in any order. {FATED FUTURE}
  uc: makeHeroCard("Ravage 2099", "Detect Vibrations", 6, u, 4, Color.COVERT, "Marvel Knights", "FD4T", [ ev => {
...
// {TEAMPOWER Marvel Knights} Then do the same thing with the bottom card of your deck.
  ra: makeHeroCard("Ravage 2099", "Overhorns and Underhorns", 8, u, 3, Color.INSTINCT, "Marvel Knights", "DAT", [ ev => {
    revealPlayerDeckEv(ev, 1, cards => {
      addAttackEvent(ev, cards.sum(c => c.cost));
      selectCardOptEv(ev, "Choose a card to discard", cards, c => discardEv(ev, c));
    });
  }, ev => superPowerEv(ev, "Marvel Knights", () => revealPlayerDeckBottomEv(ev, 1, cards => {
    addAttackEvent(ev, cards.sum(c => c.cost));
    selectCardOptEv(ev, "Choose a card to discard", cards, c => discardEv(ev, c));
  })) ]),
},
...
// {CYBER-MOD COVERT} Draw a card.
  c1: makeHeroCard("Spider-Man 2099", "Retractable Talons", 2, u, 1, Color.COVERT, "Spider Friends", "FDT", [ ev => {
...
// {POWER Strength} {FATED FUTURE}
  uc: makeHeroCard("Spider-Man 2099", "Spider-Silk Webbing", 5, 3, u, Color.STRENGTH, "Spider Friends", "FDT", [ ev => {
    turnState.nextHeroRecruit = 'DECK';
  }, ev => superPowerEv(ev, Color.STRENGTH, () => fatedFutureEv(ev)) ]),
...
// {TEAMPOWER Spider Friends} You may play a copy of the card you sent {UNDERCOVER} this way.
  ra: makeHeroCard("Spider-Man 2099", "Spider-Sense Telepathy", 7, u, 5, Color.INSTINCT, "Spider Friends", "DT", ev => {
    revealHeroDeckEv(ev, 3, cards => {
      selectCardOptEv(ev, "Choose a card to send Undercover", cards, c => {
        sendUndercoverEv(ev, c);
        superPowerEv(ev, "Spider Friends", () => playCopyEv(ev, c));
      });
    }, false);
  }),
},
...
// If you got at least 3 Recruit this way, draw a card.
  c2: makeHeroCard("Fantomex", "Three Brains", 2, 0, u, Color.TECH, "X-Force", "FDRT", ev => {
...
// When you draw a new hand this turn, draw an extra card, then put a card from your hand on top of your deck.
  uc: makeHeroCard("Fantomex", "Misdirection", 3, u, 0, Color.COVERT, "X-Force", "AT", [ ev => weaponXSequenceEv(ev), ev => {
    addEndDrawMod(1);
...
// {POWER Tech} You may KO one of your cards that has the same cost as any of your other cards.
  ra: makeHeroCard("Fantomex", "Weapon XIII", 4, u, 1, Color.TECH, "X-Force", "4AT", [ ev => weaponXSequenceEv(ev), ev => {
...
// {TEAMPOWER X-Force} {BERSERK}
  c1: makeHeroCard("Marrow", "Bone Shards", 3, u, 2, Color.RANGED, "X-Force", "FDA", ev => superPowerEv(ev, "X-Force", () => berserkEv(ev, 1))),
...
// {POWER Strength} {BERSERK}
  c2: makeHeroCard("Marrow", "Hyper-Adaptive Skeleton", 2, 1, 1, Color.STRENGTH, "X-Force", "DRAT", [ ev => turnState.recruitFromBerserk = true, ev => superPowerEv(ev, Color.STRENGTH, () => berserkEv(ev, 1)) ]),
// Draw two cards. Then put a card from your hand on top of your deck.
  uc: makeHeroCard("Marrow", "Osteogenesis", 6, 1, 2, Color.STRENGTH, "X-Force", "FDT", [ ev => drawEv(ev, 2), ev => selectCardEv(ev, "Choose a card to put on top of your deck", playerState.hand.deck, c => moveCardEv(ev, c, playerState.deck)) ]),
// {WEAPON X SEQUENCE}
// Reveal the top six cards of your deck. Discard all the ones that cost 0 and put the rest back in any order.
  ra: makeHeroCard("Marrow", "Metabolic Overdrive", 7, u, 3, Color.COVERT, "X-Force", "AT", [ ev => weaponXSequenceEv(ev), ev => {
...
// {POWER Instinct} You get +1 Attack.
  c1: makeHeroCard("Weapon H", "Evolving Abilities", 4, 0, 2, Color.INSTINCT, "Avengers", "D4RAT", ev => {
    chooseOneEv(ev, "Make", ["Recruit", () => {
      addRecruitEvent(ev, ev.source.printedAttack);
      superPowerLikelyEv(ev, Color.INSTINCT, () => addRecruitEvent(ev, 1));
    }], ["Attack", () => {
      addAttackEvent(ev, ev.source.printedAttack);
      superPowerLikelyEv(ev, Color.INSTINCT, () => addAttackEvent(ev, 1));
    }]);
  }, { customRecruitAndAttack: true }),
// Look at the top card of your deck.
// Discard it or put it back.
// {POWER Strength} {BERSERK}
  c2: makeHeroCard("Weapon H", "The Future of Warfare", 3, u, 2, Color.STRENGTH, "Avengers", "FDAT", [ ev => {
    revealPlayerDeckEv(ev, 1, cards => {
      selectCardOptEv(ev, "Choose a card to discard", cards, c => discardEv(ev, c));
    });
  }, ev => superPowerEv(ev, Color.STRENGTH, () => berserkEv(ev, 1)) ]),
// {BERSERK}
...
// {POWER Strength} Using the Wound Deck, {BERSERK}, {BERSERK}, {BERSERK}, {BERSERK}, {BERSERK}, {BERSERK}, putting those discarded Wounds on the bottom of the Wound Deck.
  ra: makeHeroCard("Weapon H", "Ultimate Killing Machine", 8, u, 4, Color.STRENGTH, "Avengers", "4AT", [
    ev => weaponXSequenceEv(ev),
    ev => superPowerEv(ev, Color.STRENGTH, () => berserkWoundsEv(ev, 6))
  ]),
},
{
...
// To play this, you must put another card from your hand on top of your deck.
// {WEAPON X SEQUENCE}
  c1: makeHeroCard("Weapon X (Wolverine)", "Infuse Skeleton with Adamantium", 5, u, 2, Color.TECH, "Marvel Knights", "FDAT", ev => weaponXSequenceEv(ev), { playCost: 1, playCostType: 'TOPDECK' }),
// {BERSERK}
// {POWER Instinct} You may KO a Wound from your hand or discard pile. If you do, {BERSERK} again.
  c2: makeHeroCard("Weapon X (Wolverine)", "Raging Regeneration", 4, u, 2, Color.INSTINCT, "Marvel Knights", "FD4AT", [ ev => berserkEv(ev, 1),
...
// You may gain a Wound. If you do, {BERSERK}, {BERSERK}.
  uc: makeHeroCard("Weapon X (Wolverine)", "Violent Conditioning", 3, u, 2, Color.INSTINCT, "Marvel Knights", "FDAT", ev => {
...
// If you gain a Wound this way, {BERSERK}.
  ra: makeHeroCard("Weapon X (Wolverine)", "Escape the Weapon X Lab", 6, u, 3, Color.INSTINCT, "Marvel Knights", "AT", [
    ev => weaponXSequenceEv(ev),
